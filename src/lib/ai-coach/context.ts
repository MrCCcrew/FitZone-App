  ...
  try {
    ...
    if ("questionnaire" in parsed) {
      return {
        ...
        currentEntity: ["trainers", "partners", "nutritionist", "goals", "classes"].includes(String(parsed.currentEntity)) ? parsed.currentEntity as CoachConversationContext["currentEntity"] : null,
        lastResolvedIntent: parsed.lastResolvedIntent,
        selectedGoal: typeof parsed.selectedGoal === "string" ? parsed.selectedGoal : null,
        ...
        lastDomain: ["memberships", "packages", "products", "classes", "offers", "account", "site"].includes(String(parsed.lastDomain)) ? parsed.lastDomain as CoachConversationContext["lastDomain"] : null,
        lastEntities: parsed.lastEntities && typeof parsed.lastEntities === "object" ? parsed.lastEntities : {},
        lastListMode: Boolean(parsed.lastListMode),
        lastSort: parsed.lastSort === "price_asc" ? "price_asc" : null,
        lastTemporalFilter: parsed.lastTemporalFilter && typeof parsed.lastTemporalFilter === "object" ? parsed.lastTemporalFilter : {},
        lastActionTarget: typeof parsed.lastActionTarget === "string" ? parsed.lastActionTarget : null,
