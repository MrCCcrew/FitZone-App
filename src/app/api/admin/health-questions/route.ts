...
export async function POST(req: Request) {
  ...
  try {
    ...
    console.error("[ADMIN_HEALTH_QUESTIONS_POST]", error);
    return NextResponse.json({ error: "تعذر حفظ السؤال." }, { status: 500 });
  }
}
...
export async function PATCH(req: Request) {
  ...
  try {
    ...
    console.error("[ADMIN_HEALTH_QUESTIONS_PATCH]", error);
...
export async function DELETE(req: Request) {
  ...
  try {
    ...
    console.error("[ADMIN_HEALTH_QUESTIONS_DELETE]", error);
    return NextResponse.json({ error: "تعذر حذف السؤال." }, { status: 500 });
  }
}
