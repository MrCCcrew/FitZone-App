export type CatalogSearchKind = "membership" | "product" | "class" | "goal" | "trainer";
...
const COMMON_WORDS = new Set(["ايه", "اي", "ما", "ماهي", "ماهو", "هل", "عندكم", "عندك", "في", "من", "عن", "على", "و", "او", "طب", "بس", "وريني", "اعرض", "كل", "وال", "بكام", "موجود", "الموجود", "متاح", "المتاح", "متاحه", "المتاحه", "الحالي", "حاليا", "دلوقتي", "عايز", "عايزه", "اريد", "اشوف", "شوف", "عايزة", "عاوز", "عاوزه", "افتح", "افتحلي", "الحاجات", "اللي", "بتتباع", "فيت", "زون", "fitzone", "والمدربات", "بالنسبه", "قوليلي", "مين", "ايه", "انواع", "الانواع", "التانيه", "التانية", "الاخرى"]);
const KIND_WORDS: Record<CatalogSearchKind, Set<string>> = {
  ...
  class: new Set(["مواعيد", "المواعيد", "ميعاد", "كلاس", "كلاسات", "الكلاسات", "الجدول", "جدول", "الحصص", "حصص", "الكلاس"]),
  goal: new Set(["الاهداف", "اهداف", "الهدف", "هدف", "goals", "goal", "اختار", "اختاري"]),
  trainer: new Set(["المدربات", "مدربات", "مدربة", "مدرب", "trainers", "trainer", "coach", "coaches", "افضل", "احسن", "رشح", "رشحي"]),
};
