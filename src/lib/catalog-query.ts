...
const COMMON_WORDS = new Set(["ايه", "اي", "ما", "ماهي", "ماهو", "هل", "عندكم", "عندك", "في", "من", "عن", "على", "و", "او", "طب", "بس", "وريني", "اعرض", "كل", "وال", "بكام", "موجود", "الموجود", "متاح", "المتاح", "متاحه", "المتاحه", "الحالي", "حاليا", "دلوقتي", "عايز", "عايزه", "اريد", "اشوف", "شوف", "عايزة", "عاوز", "عاوزه", "افتح", "افتحلي", "الحاجات", "اللي", "بتتباع", "فيت", "زون", "fitzone", "والمدربات", "بالنسبه", "قوليلي", "مين", "ايه"]);
