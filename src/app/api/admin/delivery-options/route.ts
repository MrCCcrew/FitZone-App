...
export async function POST(req: Request) {
  ...
  try {
    ...
    console.error("[ADMIN_DELIVERY_OPTIONS_POST]", error);
    return NextResponse.json({ error: "تعذر حفظ وسيلة التوصيل." }, { status: 500 });
  }
}
...
export async function PATCH(req: Request) {
  ...
  try {
    ...
    console.error("[ADMIN_DELIVERY_OPTIONS_PATCH]", error);
    return NextResponse.json({ error: "تعذر تحديث وسيلة التوصيل." }, { status: 500 });
  }
}
...
export async function DELETE(req: Request) {
  ...
  try {
    ...
    console.error("[ADMIN_DELIVERY_OPTIONS_DELETE]", error);
    return NextResponse.json({ error: "تعذر حذف وسيلة التوصيل." }, { status: 500 });
  }
}
