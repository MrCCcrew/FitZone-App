...
import {
  StoreGiftToast,
  dispatchGiftToast,
} from "@/components/store/StoreGiftToast";
...
const FitZoneTour = dynamic(
  () => import("@/components/onboarding/FitZoneTour"),
  { ssr: false },
);
...
const emptyCoachVisualState: CoachVisualState = {
  ...
  membershipResultIds: [],
  membershipSort: null,
  trainerFilter: { ids: [], specialty: null },
  classFilter: { ids: [], trialOnly: false, date: null },
...
function CoachAccessibilityAnnouncer({
  announcement,
}: {
  announcement: string;
}) {
...
const getAccessibleTextColor = (color: string) => {
  ...
  return normalized === "#c8a200" || normalized === "rgb(200,162,0)"
    ? C.goldText
    : color;
};
...
const css = `
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .schedule-scroll{overflow-x:auto;overflow-y:auto;max-height:min(520px,65dvh);max-width:100%;scrollbar-width:thin;scrollbar-color:rgba(245,197,66,.4) rgba(255,255,255,.06);scroll-padding-inline-start:var(--schedule-day-col,68px);}
  .schedule-scroll::-webkit-scrollbar{height:5px;width:5px;}
  ...
  .schedule-outer{border-radius:14px;overflow:hidden;border:1.5px solid rgba(255,255,255,.12);--schedule-col-min:130px;--schedule-day-col:68px;}
  .schedule-table{border-collapse:collapse;background:#0d0a0c;min-width:100%;}
  .schedule-table th,.schedule-table td{display:table-cell;vertical-align:top;}
  .schedule-cell{border-right:1px solid rgba(255,255,255,.08);border-top:1px solid rgba(255,255,255,.08);padding:10px 8px;text-align:center;}
  .schedule-cell.time{background:linear-gradient(180deg,#1d1619,#161114);font-weight:900;font-size:12px;color:#fff;letter-spacing:.2px;min-width:var(--schedule-col-min,130px);padding:12px 8px;vertical-align:middle;position:sticky;top:0;z-index:4;}
  .schedule-cell.time span{font-size:11px;color:#9d8a96;font-weight:700;display:block;margin-top:2px;}
  ...
  .schedule-cell.day-head{background:#161214;color:#9d8a96;font-weight:800;font-size:12px;position:sticky;top:0;right:0;z-index:7;width:var(--schedule-day-col,68px);min-width:var(--schedule-day-col,68px);max-width:var(--schedule-day-col,68px);box-shadow:-1.5px 0 0 rgba(255,255,255,.16);vertical-align:middle;}
  ...
  .schedule-slot-item{width:100%;border-radius:10px;padding:10px 8px;border:1.5px solid rgba(245,197,66,.2);background:rgba(245,197,66,.05);cursor:pointer;transition:background .15s,border-color .15s,box-shadow .15s;text-align:center;display:flex;flex-direction:column;align-items:center;gap:4px;min-height:62px;justify-content:center;}
  ...
  @media(max-width:480px){
    ...
    .schedule-scroll{scroll-snap-type:x mandatory;max-height:min(420px,62dvh);}
...
function getDefaultAccount(
  ...
  return (
    ...
    list[0] ?? { id: "fallback", label: fallbackLabel, url: fallbackUrl }
  );
}
...
const I = ({
  ...
  const d = {
    ...
    wallet:
      "M2 9.5V4a2 2 0 012-2h16a2 2 0 012 2v5.5 M2 9.5h20V20a2 2 0 01-2 2H4a2 2 0 01-2-2V9.5z M16 14a1 1 0 110 2 1 1 0 010-2",
    ...
    phone:
      "M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.88a19.79 19.79 0 01-3.07-8.67A2 2 0 012 1h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L6.09 8.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 16.92z",
    mail: "M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z M22 6l-10 7L2 6",
    facebook:
      "M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3.2l.8-4H14V7a1 1 0 011-1h3z",
    calendar:
    ...
    truck:
      "M5 17H3a2 2 0 01-2-2V5a2 2 0 012-2h11a2 2 0 012 2v3m0 0h4l3 3v4h-7m0-7v7 M7 17a2 2 0 100 4 2 2 0 000-4z M17 17a2 2 0 100 4 2 2 0 000-4z",
    repeat:
    ...
    whatsapp:
      "M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52",
    instagram:
      "M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37z M17.5 6.5h.01 M7 2h10a5 5 0 015 5v10a5 5 0 01-5 5H7a5 5 0 01-5-5V7a5 5 0 015-5z",
  ...
  return (
    ...
    >
      {d[n as keyof typeof d]?.split(" M").map((path, i) => (
...
const GymImg = ({
  ...
  const configs = {
    hero: {
      ...
      content: (
        <>
          ...
          <defs>
            <radialGradient id="heroGrad" cx="30%" cy="50%">
          ...
          <path
            d="M 112 87 Q 128 75 144 87 L 140 165 L 128 156 L 116 165 Z"
            fill="#E91E63"
            opacity=".7"
          />
          {/* FITZONE on wall */}
          ...
          {/* Red glow */}
          <radialGradient id="redGlow" cx="32%" cy="50%">
            <stop offset="0%" stopColor="#E91E63" stopOpacity=".08" />
    ...
    yoga: {
      content: (
        <>
          ...
          <path
            d="M 176 150 Q 200 135 224 150 L 216 210 L 200 204 L 184 210 Z"
            fill="#777"
          />
          <text
            x="50%"
    ...
    zumba: {
      content: (
        <>
          ...
          <path
            d="M 176 132 Q 192 120 208 126 Q 224 132 232 156 L 208 198 L 192 192 Z"
            fill="#777"
          />
          <text
            x="50%"
    ...
    pilates: {
      content: (
        <>
          ...
          <path
            d="M 176 129 L 224 129 L 216 195 L 200 186 L 184 195 Z"
            fill="#666"
          />
          <text
            x="50%"
    ...
    trainer1: {
      content: (
        <>
          <defs>
            <radialGradient id="t1g" cx="50%" cy="40%">
              <stop offset="0%" stopColor="#FFD6E8" />
              <stop offset="100%" stopColor="#FFF5F8" />
            </radialGradient>
          </defs>
          ...
          <path
            d="M 144 144 Q 200 126 256 144 L 248 240 L 200 228 L 152 240 Z"
            fill="#E91E63"
            opacity=".7"
          />
    ...
    trainer2: {
      content: (
        <>
          <defs>
            <radialGradient id="t2g" cx="50%" cy="40%">
    ...
    trainer3: {
      content: (
        <>
          <defs>
            <radialGradient id="t3g" cx="50%" cy="40%">
    ...
    product1: {
      content: (
        <>
          <defs>
            <linearGradient id="pr1" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="#FFD6E8" />
              <stop offset="100%" stopColor="#FFF5F8" />
            </linearGradient>
          </defs>
    ...
    product2: {
      content: (
        <>
          <defs>
            <linearGradient id="pr2" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="#E8F5E0" />
              <stop offset="100%" stopColor="#FFF5F8" />
            </linearGradient>
          </defs>
    ...
    product3: {
      content: (
        <>
          <defs>
            <linearGradient id="pr3" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <>
          ...
          {[
            ...
            >
              ...
              <animate
                attributeName="r"
                values={`${c.r};${Math.round(c.r * 1.2)};${c.r}`}
                dur={c.dur}
                begin={c.delay}
                repeatCount="indefinite"
                calcMode="spline"
              ...
              <animate
                ...
                values={`${c.op};${+(c.op * 1.6).toFixed(2)};${c.op}`}
                dur={c.dur}
                begin={c.delay}
                repeatCount="indefinite"
                calcMode="spline"
          ...
          {/* Glow */}
          <radialGradient id="atmG" cx="50%" cy="50%">
  ...
  return (
    <svg
      width={w}
      height={h}
      viewBox={`0 0 ${typeof w === "number" ? w : 400} ${h}`}
...
const HYDRATION_AUTH_DEBUG =
  process.env.NODE_ENV === "production" &&
  process.env.HYDRATION_AUTH_DEBUG === "true";
...
function readAuthDebugMarkers() {
  return Array.from(
    document.querySelectorAll<HTMLElement>("[data-auth-component]"),
  ).map((element) => ({
...
const Header = ({
  ...
  const firstAnnouncementRender = useRef({
    hydrationDisable: hydrationDisable ?? null,
    announcementRendered,
  });
  const authState = getAuthDebugState(summary);
  const renderPhase = getAuthDebugPhase(summary, diagnosticMounted);
  const headerConditionals = summary?.authenticated
    ? ["authenticated-nav", "user-widget"]
    : ["guest-nav", "user-widget"];
  useEffect(() => {
    if (!HYDRATION_AUTH_DEBUG) return;
    console.debug("[Hydration auth debug]", {
      component: "Header",
  ...
  useEffect(() => {
    if (!HYDRATION_AUTH_DEBUG) return;
    console.debug(
      "[Hydration isolation client]",
      firstAnnouncementRender.current,
    );
  }, []);
    ...
    fetch("/api/site-content?sections=announcements")
      ...
      .then((d) => {
        const items = Array.isArray(d.announcements)
          ? (d.announcements as { text: string; active: boolean }[])
              .filter((a) => a.active)
              .map((a) => a.text)
          : [];
  ...
  const navItems = [
    ...
    ...(SHOW_CLASSES_PAGE
      ? [{ id: "classes", label: t("الكلاسات", "Classes") }]
      : []),
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
          {currentPage !== "home" && (
            ...
            >
              <I
                n={lang === "ar" ? "chevronRight" : "chevronLeft"}
                s={24}
                c={C.gray}
              />
            </button>
        ...
        >
          {navItems.map((item) => (
            <button
              ...
              style={{
                background:
                  item.id === "shop" ? "rgba(236,72,153,0.12)" : "none",
                border:
                  item.id === "shop"
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          {storeEnabled && (
            <button
              ...
              aria-label={t("عربة التسوق", "Shopping cart")}
              style={{
                position: "relative",
                background: "none",
                border: "none",
          ...
          <button
            {...authDebugAttributes("user-menu", summary, diagnosticMounted, [
              summary?.authenticated ? "authenticated-nav" : "guest-nav",
              "user-widget",
            ])}
            data-tour="account"
            ...
            aria-label={
              summary?.authenticated
                ? summary.user?.name || t("حسابي", "My account")
            ...
            style={{
              ...
              alignItems: "center",
              gap: 8,
              background: summary?.authenticated
                ? "rgba(233,30,99,.12)"
                : "none",
          ...
          {navItems.map((item) => (
            <button
              ...
              style={{
                ...
                fontWeight: 600,
                cursor: "pointer",
                color: currentPage === item.id ? C.red : C.white,
                textAlign: "right",
                fontFamily: "'Cairo', sans-serif",
                borderBottom: `1px solid ${C.border}`,
              }}
...
const Footer = ({
    ...
    loadPublicApi()
      .then((data) => {
        if (data.contact && typeof data.contact === "object") {
          setContact((current) => ({
            ...current,
            ...(data.contact as Partial<PublicContact>),
          }));
        }
      })
      .catch(() => {});
  ...
  const socialLinks = [
    {
      key: "facebook",
      href: normalizeExternalUrl(contact.facebook),
      color: "#1877F2",
    },
    {
      key: "instagram",
      href: normalizeExternalUrl(contact.instagram),
      color: "#E1306C",
    },
    {
      key: "whatsapp",
      href: normalizeWhatsappLink(contact.whatsapp || "01001514535"),
      color: "#25D366",
    },
  ];
    ...
    >
      <div className="container">
          ...
          <div>
            ...
            >
              ...
              <div>
                ...
                <div
                  style={{ fontSize: 10, color: C.redDark, letterSpacing: 2 }}
                >
                  FITNESS CLUB
                </div>
              </div>
            ...
            {contact.whatsappChannelEnabled && contact.whatsappChannel && (
              <a
                ...
                style={{
                  ...
                  marginTop: 18,
                  background:
                    "linear-gradient(135deg,#1ebe6a 0%,#128C7E 60%,#0d6b60 100%)",
                  color: "#fff",
                  borderRadius: 16,
                  padding: "12px 20px",
                  ...
                  textDecoration: "none",
                  boxShadow:
                    "0 6px 22px rgba(37,211,102,.38), 0 2px 8px rgba(0,0,0,.18)",
                ...
                onMouseEnter={(e) => {
                  ...
                  (e.currentTarget as HTMLAnchorElement).style.boxShadow =
                    "0 10px 28px rgba(37,211,102,.48), 0 3px 10px rgba(0,0,0,.2)";
                }}
                onMouseLeave={(e) => {
                  (e.currentTarget as HTMLAnchorElement).style.transform =
                    "translateY(0)";
              ...
              >
                ...
                >
                  ...
                  >
                    {t(
                      "اضغطي للمتابعة على واتساب ✨",
                      "Tap to follow on WhatsApp ✨",
                    )}
                  </span>
                </span>
              </a>
        ...
        >
          ...
          >
            {t("وسائل الدفع المتاحة", "Accepted payment methods")}
          </p>
          <div
            style={{
              display: "flex",
          ...
          >
            {[
              {
                src: "/payment-logos/cash-on-delivery.svg",
              ...
              {
                src: "/payment-logos/primium.webp",
                alt: "Premium Card",
                bg: "#fff",
              },
              {
                src: "/payment-logos/u-valu-logo.webp",
                alt: "valU",
                bg: "#fff",
              },
              {
                src: "/payment-logos/sympl-menu2.png",
                alt: "Sympl",
                bg: "#fff",
              },
              {
                src: "/payment-logos/sohoooooola.png",
                alt: "Souhoola",
                bg: "#fff",
              },
            ]
            ...
            >
              ...
              <div style={{ display: "flex", gap: 4, alignItems: "center" }}>
                {[
                  {
                    src: "/payment-logos/vodafone-cash.svg",
                    alt: "Vodafone Cash",
                  },
                  { src: "/payment-logos/we-pay.svg", alt: "WE Pay" },
                  { src: "/payment-logos/etisalat-cash.svg", alt: "e& Cash" },
        ...
        >
          <p style={{ color: C.gray, fontSize: 12 }}>
            {t(
              "© 2026 FIT ZONE Fitness Club. جميع الحقوق محفوظة.",
              "© 2026 FIT ZONE Fitness Club. All rights reserved.",
            )}
          </p>
...
const AboutPage = () => {
  ...
  const [contactInfo, setContactInfo] =
    useState<PublicContact>(DEFAULT_CONTACT);
  const t = useT();
  const { lang } = useLang();
    ...
    fetch("/api/site-content?sections=about,contact", { cache: "no-store" })
      ...
      .then((payload) => {
        if (payload.about && typeof payload.about === "object") {
          setAbout({
            ...DEFAULT_ABOUT,
            ...(payload.about as Partial<AboutContent>),
          });
        }
        if (payload.contact && typeof payload.contact === "object") {
          setContactInfo((prev) => ({
            ...prev,
            ...(payload.contact as Partial<PublicContact>),
          }));
        }
      })
      .catch(() => {});
  ...
  return (
    <div>
      <section
        style={{
          background: `linear-gradient(135deg, #FFE0EC 0%, #FFF5F8 60%, ${C.bg} 100%)`,
          padding: "72px 0",
        }}
      >
        <div className="container">
          ...
          >
            <div
              style={{
                ...
                inset: 0,
                background:
                  "radial-gradient(circle at 12% 20%, rgba(233,30,99,.25), transparent 55%), radial-gradient(circle at 90% 10%, rgba(200,162,0,.2), transparent 45%)",
              }}
            />
            <div style={{ position: "relative" }}>
              ...
              <div style={{ marginTop: 28 }}>
                <h1
                  style={{
                    fontSize: viewportWidth() < 768 ? 30 : 40,
                    color: "#fff",
                    fontWeight: 900,
                    marginBottom: 12,
                  }}
                ...
                <p style={{ color: "#f4dbe5", fontSize: 15, lineHeight: 2 }}>
                  {lang === "en"
                    ? (about.descriptionEn ?? about.description)
                    : about.description}
                </p>
                <p
                  style={{
              ...
              >
                ...
                >
                  {t(
                    ...
                    "to get a perfect body — it is a lifestyle",
                  )}
                </div>
                <div
                  style={{
                ...
                >
                  {highlights.map((item) => (
                    ...
                    >
                      <span style={{ color: C.goldText, fontWeight: 900 }}>
                        •
                      </span>
                      <span>{item}</span>
                    </div>
              ...
              <div style={{ marginTop: 26, textAlign: "center" }}>
                ...
                <div style={{ color: "#f4dbe5", marginTop: 6, fontSize: 14 }}>
                  {t(
                    ...
                    "Give yourself the chance to be at your best",
                  )}
                </div>
                <div
                  style={{
                ...
                <div style={{ marginTop: 6, color: "#f4dbe5", fontSize: 13 }}>
                  {contactInfo.address ||
                    "مقابل أمام بنك القاهرة بجوار شام للسياحة فوق كازيون"}
                </div>
              </div>
            </div>
          </div>
...
const CLASS_TYPE_ALIASES: Record<string, string> = Object.entries(
  CLASS_TYPE_LABELS,
).reduce(
  (acc, [key, label]) => {
    acc[key] = key;
...
const PrivateBookingModal = ({
  ...
  const S = {
    ...
    chip: (active: boolean) => ({
      padding: "6px 14px",
      borderRadius: 20,
      border: `1.5px solid ${active ? C.red : "rgba(255,255,255,.18)"}`,
      background: active ? "rgba(233,30,99,.22)" : "transparent",
      color: active ? "#fff" : "#b0a0a8",
      fontSize: 13,
      cursor: "pointer",
    ...
    grid2: {
      display: "grid",
      gridTemplateColumns: _w < 500 ? "1fr" : "1fr 1fr",
      gap: 12,
    } as React.CSSProperties,
  };
  ...
  const JOB_OPTS = [
    [
      t("مكتبي", "Office/Desk"),
      t("حركة خفيفة", "Light movement"),
      t("مجهود بدني", "Physical labor"),
    ],
    ["مكتبي", "حركة خفيفة", "مجهود بدني"],
  ] as const;
  const GOAL_OPTS = [
    [
      t("خسارة وزن", "Weight loss"),
      t("بناء عضل", "Muscle gain"),
      t("شد الجسم", "Toning"),
      t("تحسين اللياقة", "Fitness"),
      t("تأهيل إصابة", "Injury rehab"),
    ],
    ["خسارة وزن", "بناء عضل", "شد الجسم", "تحسين اللياقة", "تأهيل إصابة"],
  ] as const;
  const MED_OPTS = [
    [
      t("ضغط", "Blood pressure"),
      t("سكر", "Diabetes"),
      t("مشاكل قلب", "Heart issues"),
      t("غدة درقية", "Thyroid"),
      t("كلى", "Kidneys"),
      t("أنيميا", "Anemia"),
      t("مشاكل مفاصل / عمود فقري", "Joint/spine issues"),
    ],
    [
      "ضغط",
      "سكر",
  ...
  const submit = async () => {
    ...
    if (!fullName.trim()) {
      setMsg({ text: t("الاسم مطلوب.", "Name is required."), ok: false });
      return;
    }
    if (!age.trim()) {
      setMsg({ text: t("السن مطلوب.", "Age is required."), ok: false });
      return;
    }
    if (!height.trim()) {
      setMsg({ text: t("الطول مطلوب.", "Height is required."), ok: false });
      return;
    }
    if (!weight.trim()) {
      setMsg({ text: t("الوزن مطلوب.", "Weight is required."), ok: false });
      return;
    }
    if (!phone.trim()) {
      setMsg({
        text: t("رقم الموبايل مطلوب.", "Mobile number is required."),
        ok: false,
      });
      return;
    }
    ...
    if (goals.length === 0) {
      setMsg({
        text: t("اختاري هدفاً واحداً على الأقل.", "Choose at least one goal."),
        ok: false,
      });
      return;
    }
    ...
    if (!hasInjuries) {
      setMsg({
        text: t(
          "حددي إذا كان عندك إصابات أو لا.",
          "Please indicate if you have any injuries.",
        ),
        ok: false,
      });
      return;
    ...
    if (!hasSurgeries) {
      setMsg({
        text: t(
          "حددي إذا عملتي عمليات جراحية أو لا.",
          "Please indicate if you've had any surgeries.",
        ),
        ok: false,
      });
      return;
    ...
    if (!gaveBirth) {
      setMsg({
        text: t(
          "حددي إذا سبق الولادة أو لا.",
          "Please indicate if you've given birth before.",
        ),
        ok: false,
      });
      return;
    }
    if (!hasHormonalIssues) {
      setMsg({
        text: t(
          "حددي إذا كان عندك مشاكل هرمونية أو لا.",
          "Please indicate if you have hormonal issues.",
        ),
        ok: false,
      });
      return;
    ...
    const formData = {
      ...
      womensHealth: {
        ...
        lastBirth,
        hasHormonalIssues,
        hormonalIssuesDetail: hormonalIssues,
      },
    ...
    try {
      ...
      if (!res.ok) {
        setMsg({
          text: data.error ?? t("حدث خطأ.", "An error occurred."),
          ok: false,
        });
        return;
      }
      setMsg({
        text: t(
          "✅ تم إرسال طلبك بنجاح! ستصلك إشعار فور موافقة المدربة.",
          "✅ Application sent! You'll be notified once the trainer responds.",
        ),
        ok: true,
      });
      ...
      setMsg({
        text: t("تعذر الاتصال بالخادم.", "Could not reach the server."),
        ok: false,
      });
    } finally {
      setSubmitting(false);
  ...
  return (
    <div
      style={{
        ...
        padding: _w < 640 ? "0" : "16px 10px",
      }}
    >
      <div
        style={{
          background: "#0e0812",
          borderRadius: _w < 640 ? "0 0 24px 24px" : 20,
          maxWidth: 560,
          width: "100%",
          margin: "0 auto",
          boxShadow: "0 24px 60px rgba(0,0,0,.7)",
          border: "1px solid rgba(255,255,255,.1)",
          padding: _w < 640 ? "16px 14px 28px" : 28,
          marginBottom: _w < 640 ? 24 : 0,
        }}
      >
        {/* Header */}
        <div
        ...
        >
          <div style={{ flex: 1, paddingInlineEnd: 12 }}>
            ...
            >
              {isPrivate
                ? t("طلب برايفيت 🎯", "Private Session 🎯")
                : t("طلب ميني برايفيت 👥", "Mini Private 👥")}
            </h2>
            <p style={{ color: C.red, fontSize: 12, margin: "4px 0 0" }}>
              {t("مع المدربة", "With")} {trainer.name}
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        >
          {isPrivate ? (
            <>
              ...
              {t(
                "12 حصة / شهر · من ساعة إلى ساعة ونصف · برنامج مخصص حسب حالتك 100%",
                "12 sessions/month · 60–90 min · 100% personalised program",
              )}
              <br />
              <strong style={{ color: C.goldText }}>
                {t(
                  "السعر: تحدده المدربة بعد مراجعة طلبك",
                  "Price: set by your trainer after reviewing your application",
                )}
              </strong>
            </>
          ) : (
            <>
              <strong style={{ color: "#fff" }}>
                👥 {t("ميني برايفيت", "Mini Private")} —
              </strong>{" "}
              {t(
                "12 حصة / شهر · ساعة كل مرة · مجموعة من 3 إلى 5 عملاء",
                "12 sessions/month · 60 min · group of 3–5 clients",
              )}
              <br />
        ...
        <p style={{ fontSize: 12, color: "#888", marginBottom: 20 }}>
          {t(
            "من فضلك أملئي البيانات بدقة عشان نقدر نعمل برنامج مناسب ليكي 100% 👌",
            "Please fill in accurately so we can build the perfect program for you 100% 👌",
          )}
        </p>
        ...
        <div style={S.section}>
          <div style={S.sectionTitle}>
            {t("القسم 1: البيانات الأساسية", "Section 1: Basic Info")}
          </div>
          <div style={S.grid2}>
            <div>
              <label style={S.label}>{t("الاسم *", "Name *")}</label>
              <input
                value={fullName}
                onChange={(e) => setFullName(e.target.value)}
                style={S.input}
                placeholder={t("اسمك الكامل", "Full name")}
              />
            </div>
            <div>
              <label style={S.label}>{t("السن *", "Age *")}</label>
              <input
                type="number"
                value={age}
                onChange={(e) => setAge(e.target.value)}
                style={S.input}
                placeholder={t("سنة", "years")}
              />
            </div>
            <div>
              <label style={S.label}>
                {t("الطول (سم) *", "Height (cm) *")}
              </label>
              <input
                type="number"
                value={height}
          ...
          <div style={{ marginTop: 12 }}>
            ...
            <div style={S.radio}>
              {JOB_OPTS[0].map((label, i) => (
                <button
                  key={i}
                  type="button"
                  onClick={() => toggle(jobType, setJobType, JOB_OPTS[1][i])}
                  style={S.chip(jobType.includes(JOB_OPTS[1][i]))}
                >
                  {label}
                </button>
              ))}
        ...
        <div style={S.section}>
          <div style={S.sectionTitle}>
            {t("القسم 2: الهدف *", "Section 2: Goals *")}
          </div>
          <div style={S.radio}>
            {GOAL_OPTS[0].map((label, i) => (
              <button
                key={i}
                type="button"
                onClick={() => toggle(goals, setGoals, GOAL_OPTS[1][i])}
                style={S.chip(goals.includes(GOAL_OPTS[1][i]))}
              >
                {label}
              </button>
            ))}
          ...
          <div style={{ marginTop: 10 }}>
            <input
              ...
              style={S.input}
              placeholder={t("هدف آخر (اكتبيه هنا)", "Other goal (write here)")}
            />
          </div>
        </div>
        ...
        <div style={S.section}>
          <div style={S.sectionTitle}>
            {t("القسم 3: الحالة الصحية", "Section 3: Medical Conditions")}
          </div>
          <div style={S.radio}>
            {MED_OPTS[0].map((label, i) => (
              <button
                key={i}
                type="button"
                onClick={() => {
                  const val = MED_OPTS[1][i];
                  setMedConditions((prev) =>
                    prev.includes("لا يوجد")
                      ? [val]
                      : prev.includes(val)
                        ? prev.filter((x) => x !== val)
                        : [...prev, val],
                ...
                style={S.chip(medConditions.includes(MED_OPTS[1][i]))}
              >
                {label}
              </button>
            ))}
            <button
              ...
              onClick={() =>
                setMedConditions((prev) =>
                  prev.includes("لا يوجد") ? [] : ["لا يوجد"],
                )
              }
              style={S.chip(medConditions.includes("لا يوجد"))}
            >
              {t("لا يوجد", "None")}
            </button>
          </div>
          <div style={{ marginTop: 12 }}>
            <label style={S.label}>
              {t("هل بتاخدي أدوية بانتظام؟", "Do you take regular medication?")}
            </label>
            <div style={S.radio}>
              {yn.map((v) => (
                <button
                  key={v}
                  type="button"
                  onClick={() => setTakesMeds(v)}
                  style={S.chip(takesMeds === v)}
                >
                  {v}
                </button>
              ))}
            </div>
            {(takesMeds === "نعم" || takesMeds === "Yes") && (
              <input
                value={medsDetail}
                onChange={(e) => setMedsDetail(e.target.value)}
                style={{ ...S.input, marginTop: 8 }}
                placeholder={t("اكتبي الأدوية...", "List your medications...")}
              />
            )}
          </div>
        </div>
        ...
        <div style={S.section}>
          <div style={S.sectionTitle}>
            {t("القسم 4: الإصابات *", "Section 4: Injuries *")}
          </div>
          <div style={{ marginBottom: 12 }}>
            <label style={S.label}>
              {t("هل عندك إصابات؟ *", "Do you have any injuries? *")}
            </label>
            <div style={S.radio}>
              {yn.map((v) => (
                <button
                  key={v}
                  type="button"
                  onClick={() => setHasInjuries(v)}
                  style={S.chip(hasInjuries === v)}
                >
                  {v}
                </button>
              ))}
            </div>
            {(hasInjuries === "نعم" || hasInjuries === "Yes") && (
              <textarea
                value={injuries}
          ...
          <div>
            <label style={S.label}>
              {t(
                "هل عملتي عمليات جراحية قبل كده؟ *",
            ...
            <div style={S.radio}>
              {yn.map((v) => (
                <button
                  key={v}
                  type="button"
                  onClick={() => setHasSurgeries(v)}
                  style={S.chip(hasSurgeries === v)}
                >
                  {v}
                </button>
              ))}
            </div>
            {(hasSurgeries === "نعم" || hasSurgeries === "Yes") && (
              <textarea
                value={surgeries}
        ...
        <div style={S.section}>
          <div style={S.sectionTitle}>
            {t("القسم 5: الخبرة الرياضية", "Section 5: Sports Experience")}
          </div>
          <label style={S.label}>
            {t("هل تمرنتي قبل كده؟", "Have you trained before?")}
          </label>
          <div style={S.radio}>
            {(
              [
              ...
              return (
                <button
                  key={i}
                  type="button"
                  onClick={() => setSportsExp(vals[i])}
                  style={S.chip(sportsExp === vals[i])}
                >
                  {v}
                </button>
              );
        ...
        <div style={S.section}>
          <div style={S.sectionTitle}>
            {t("القسم 6: نمط الحياة", "Section 6: Lifestyle")}
          </div>
          <div style={S.grid2}>
            <div>
              <label style={S.label}>
                {t("عدد ساعات النوم", "Sleep hours")}
              </label>
              <input
                type="number"
                value={sleepHours}
                ...
                style={S.input}
                placeholder={t("ساعات", "hrs")}
              />
            </div>
            <div>
              <label style={S.label}>
                {t("شرب المياه (لتر)", "Water intake (L)")}
              </label>
              <input
                type="number"
                value={waterLiters}
              ...
              {(
                ...
                return (
                  <button
                    key={i}
                    type="button"
                    onClick={() => setSleepQuality(vals[i])}
                    style={S.chip(sleepQuality === vals[i])}
                  >
                    {v}
                  </button>
                );
              ...
              {(
                ...
                return (
                  <button
                    key={i}
                    type="button"
                    onClick={() => setStressLevel(vals[i])}
                    style={S.chip(stressLevel === vals[i])}
                  >
                    {v}
                  </button>
                );
        ...
        <div style={S.section}>
          <div style={S.sectionTitle}>
            {t("القسم 7: التغذية", "Section 7: Nutrition")}
          </div>
          <div style={S.grid2}>
            <div>
              <label style={S.label}>
                {t("عدد الوجبات / يوم", "Meals per day")}
              </label>
              <input
                type="number"
                value={mealsCount}
                ...
                style={S.input}
                placeholder={t("وجبات", "meals")}
              />
            </div>
          </div>
          <div style={{ marginTop: 12 }}>
            <label style={S.label}>
              {t("هل بتتبعي نظام غذائي؟", "Do you follow a diet?")}
            </label>
            <div style={S.radio}>
              {yn.map((v) => (
                <button
                  key={v}
                  type="button"
                  onClick={() => setFollowsDiet(v)}
                  style={S.chip(followsDiet === v)}
                >
                  {v}
                </button>
              ))}
          ...
          <div style={{ marginTop: 12 }}>
            <label style={S.label}>
              {t("حساسية من أكل؟", "Food allergies?")}
            </label>
            <input
              value={foodAllergies}
          ...
          <div style={{ marginTop: 12 }}>
            <label style={S.label}>{t("مكملات غذائية؟", "Supplements?")}</label>
            <input
              value={supplements}
              onChange={(e) => setSupplements(e.target.value)}
              style={S.input}
              placeholder={t("بروتين، فيتامينات...", "protein, vitamins...")}
            />
          </div>
        </div>
        ...
        <div style={S.section}>
          <div style={S.sectionTitle}>
            {t("القسم 8: النشاط الحالي", "Section 8: Current Activity")}
          </div>
          <div style={S.grid2}>
            <div>
              <label style={S.label}>
                {t("عدد أيام التمرين / أسبوع", "Training days/week")}
              </label>
              <input
                type="number"
                value={trainingDays}
            ...
            <div>
              <label style={S.label}>
                {t("مدة التمرين", "Session duration")}
              </label>
              <input
                value={trainingDuration}
                onChange={(e) => setTrainingDuration(e.target.value)}
                style={S.input}
                placeholder={t("مثال: 45 دقيقة", "e.g. 45 min")}
              />
            </div>
          </div>
          <div style={{ marginTop: 12 }}>
            <label style={S.label}>
              {t("نوع التمرين", "Type of training")}
            </label>
            <input
              value={trainingType}
        ...
        <div style={S.section}>
          <div style={S.sectionTitle}>
            {t("القسم 9: الحمل والولادة *", "Section 9: Pregnancy & Birth *")}
          </div>
          <div style={{ marginBottom: 12 }}>
            <label style={S.label}>
              {t("هل فيه حمل؟ *", "Currently pregnant? *")}
            </label>
            <div style={S.radio}>
              {yn.map((v) => (
                <button
          ...
          <div style={{ marginBottom: 12 }}>
            <label style={S.label}>
              {t("هل سبق الولادة؟ *", "Any previous births? *")}
            </label>
            <div style={S.radio}>
              {yn.map((v) => (
                <button
                  key={v}
                  type="button"
                  onClick={() => setGaveBirth(v)}
                  style={S.chip(gaveBirth === v)}
                >
                  {v}
                </button>
              ))}
            </div>
            {(gaveBirth === "نعم" || gaveBirth === "Yes") && (
              <input
                value={lastBirth}
                onChange={(e) => setLastBirth(e.target.value)}
                style={{ ...S.input, marginTop: 8 }}
                placeholder={t(
                  "آخر ولادة من قد إيه؟",
          ...
          <div>
            <label style={S.label}>
              {t("هل عندك مشاكل هرمونية؟ *", "Do you have hormonal issues? *")}
            </label>
            <div style={S.radio}>
              {yn.map((v) => (
                <button
                  key={v}
                  type="button"
                  onClick={() => setHasHormonalIssues(v)}
                  style={S.chip(hasHormonalIssues === v)}
                >
                  {v}
                </button>
              ))}
            </div>
            {(hasHormonalIssues === "نعم" || hasHormonalIssues === "Yes") && (
              <input
                value={hormonalIssues}
                onChange={(e) => setHormonalIssues(e.target.value)}
                style={{ ...S.input, marginTop: 8 }}
                placeholder={t(
                  "تكيس مبايض، انقطاع دورة...",
        ...
        <div style={S.section}>
          <div style={S.sectionTitle}>
            {t("القسم 10: الالتزام", "Section 10: Commitment")}
          </div>
          <div style={{ marginBottom: 12 }}>
            <label style={S.label}>
              {t(
                "عايزة توصلي لهدفك في قد إيه؟",
            ...
            <input
              ...
              style={S.input}
              placeholder={t("مثال: 3 شهور", "e.g. 3 months")}
            />
          </div>
          <div style={{ marginBottom: 12 }}>
            <label style={S.label}>
              {t(
                "تقدري تلتزمي كام يوم أسبوعياً؟",
                "How many days/week can you commit?",
              )}
            </label>
            <input
              type="number"
          ...
          <div>
            <label style={S.label}>
              {t("مستعدة لنظام غذائي؟", "Ready to follow a diet plan?")}
            </label>
            <div style={S.radio}>
              {yn.map((v) => (
                <button
                  key={v}
                  type="button"
                  onClick={() => setDietReady(v)}
                  style={S.chip(dietReady === v)}
                >
                  {v}
                </button>
              ))}
        ...
        <div style={S.section}>
          <div style={S.sectionTitle}>
            {t("القسم 11: ملاحظات إضافية", "Section 11: Additional Notes")}
          </div>
          <textarea
            value={notes}
            ...
            style={S.textarea}
            placeholder={t(
              "أي معلومات إضافية تودين مشاركتها مع المدربة...",
              "Any extra information you'd like to share with your trainer...",
            )}
          />
        </div>
          ...
          <div
            style={{
              background: msg.ok
                ? "rgba(74,222,128,.12)"
                : "rgba(233,30,99,.12)",
              border: `1px solid ${msg.ok ? "#4ade80" : C.red}`,
              borderRadius: 10,
              padding: "12px 14px",
              marginBottom: 14,
              fontSize: 14,
              color: msg.ok ? "#4ade80" : "#ffb7d0",
              lineHeight: 1.6,
            }}
          >
            {msg.text}
...
const HomePage = ({
  ...
  navigate: (p: string, scrollTarget?: string) => void;
  summary: UserSummary | null;
  storeEnabled: boolean;
  ...
  const responsiveColumns = (
    ...
    tablet: string,
    desktop: string,
  ) => (_w < 768 ? mobile : _w < 1024 ? tablet : desktop);
  const classes =
    lang === "en"
      ? [
          {
          ...
          },
          {
            ...
            count: "15 classes",
            color: C.gold,
            bg: "rgba(200,162,0,.08)",
            border: "rgba(200,162,0,.2)",
          },
          {
            icon: "🤸",
            name: "Pilates",
  ...
  const initialMembershipSource =
    initialMembershipRows.filter((mb) => mb.kind === "package").length > 0
      ? initialMembershipRows.filter((mb) => mb.kind === "package")
      : initialMembershipRows.filter((mb) => mb.kind === "subscription");
  const [memberships, setMemberships] = useState(() =>
    initialMembershipSource.slice(0, 3).map((mb, i) => ({
      id: mb.id,
      name: mb.name,
      price: mb.price,
  ...
  const [trainerDetailModal, setTrainerDetailModal] =
    useState<PublicTrainer | null>(null);
  const [privateBookingModal, setPrivateBookingModal] = useState<{
    trainer: PublicTrainer;
    type: "private" | "mini_private";
  } | null>(null);
  const [nutritionist, setNutritionist] = useState<PublicNutritionist | null>(
    null,
  );
  ...
  const [nutritionDone, setNutritionDone] = useState<{
    sessionId: string;
    status: string;
  } | null>(null);
  ...
  const [homeOffers, setHomeOffers] = useState<PublicOffer[]>(() =>
    (initialHomeData?.offers ?? [])
      .filter((offer) => offer.showOnHome)
      .slice(0, 3),
  );
  const [homeCustomPlans, setHomeCustomPlans] = useState<PublicMembership[]>(
    () =>
      initialMembershipRows.filter((mb) => mb.kind === "custom").slice(0, 3),
  );
  const [homeFeaturedPlan, setHomeFeaturedPlan] = useState<{
    id: string;
    name: string;
    price: number;
    priceBefore: number | null;
    ...
    return featured
      ? {
          id: featured.id,
          name: featured.name,
          price: featured.priceAfter ?? featured.price,
          priceBefore: featured.priceBefore ?? null,
          subtitle: featured.subtitle ?? null,
          features: featured.features.slice(0, 4),
  ...
  const homeSectionTopology = useRef({
    offers:
      (initialHomeData?.offers ?? []).some((offer) => offer.showOnHome) ||
      initialMembershipRows.some((mb) => mb.kind === "custom"),
    featured: initialMembershipRows.some((mb) => mb.isFeatured),
  });
  const [trialMembership, setTrialMembership] = useState<{
    id: string;
    name: string;
    price: number;
    sessionsCount: number;
  ...
  const [heroContent, setHeroContent] = useState<HomeHeroContent>(() => ({
    ...
    slides: Array.isArray(initialHomeData?.hero?.slides)
      ? initialHomeData.hero.slides.filter(
          (item): item is string => typeof item === "string",
        )
      : [],
    stats: Array.isArray(initialHomeData?.hero?.stats)
      ? (initialHomeData.hero.stats as HomeHeroContent["stats"])
      : [],
    statsEn: Array.isArray(initialHomeData?.hero?.statsEn)
      ? (initialHomeData.hero.statsEn as HomeHeroContent["statsEn"])
      : [],
  }));
    ...
    loadPublicApi(true)
      .then((d) => {
        if (Array.isArray(d.memberships) && d.memberships.length > 0) {
          const featured = (d.memberships as PublicMembership[]).find(
            (mb) => mb.isFeatured,
          );
          if (featured || !homeSectionTopology.current.featured)
            setHomeFeaturedPlan(
              featured
                ? {
                    id: featured.id,
          ...
          const packages = (d.memberships as PublicMembership[]).filter(
            (mb) => mb.kind === "package",
          );
          const subscriptions = (d.memberships as PublicMembership[]).filter(
            (mb) => mb.kind === "subscription",
          );
          const source = packages.length > 0 ? packages : subscriptions;
          const homeCustom = (d.memberships as PublicMembership[]).filter(
            (mb) => mb.kind === "custom",
          );
          if (homeCustom.length > 0 || !homeSectionTopology.current.offers)
            setHomeCustomPlans(homeCustom.slice(0, 3));
          setMemberships(
            source.slice(0, 3).map((mb, i) => ({
              id: mb.id,
              name: mb.name,
              price: mb.price,
              priceBefore: mb.priceBefore ?? null,
              ...
              image: mb.image ?? null,
              period: cycleLabel(mb.cycle, mb.durationDays),
              features: Array.isArray(mb.features)
                ? mb.features.slice(0, 4)
                : [],
              color: HOME_PLAN_COLORS[i % HOME_PLAN_COLORS.length],
              popular: i === 1,
            })),
        ...
        if (Array.isArray(d.offers)) {
          const onHome = (d.offers as PublicOffer[])
            .filter((o) => o.showOnHome)
            .slice(0, 3);
          if (onHome.length > 0 || !homeSectionTopology.current.offers)
      ...
      .then((d) => {
        if (d.hero && typeof d.hero === "object") {
          ...
          setHeroContent((current) => ({
            ...
            ...next,
            slides:
              Array.isArray(next.slides) && next.slides.length > 0
                ? next.slides.filter(Boolean)
                : current.slides,
            stats:
              Array.isArray(next.stats) && next.stats.length > 0
                ? next.stats
                : current.stats,
          }));
        }
  ...
  useEffect(() => {
    ...
    if (
      !nextUrl ||
      nextUrl === currentUrl ||
      preloadedHeroUrlsRef.current.has(nextUrl)
    )
      return;
  ...
  useEffect(() => {
    ...
    const tick = (now: number) => {
      ...
      if (todaySegmentWidthRef.current <= 0 && todayTrackRef.current) {
        ...
        if (sw > 0) {
          const containerW =
            todayContainerWidthRef.current || window.innerWidth;
          todaySegmentWidthRef.current = sw;
  ...
  const moveTodayCarousel = useCallback(
    (direction: "prev" | "next") => {
      if (
        animatedTodayClasses.length === 0 ||
        todaySegmentWidthRef.current <= 0
      )
        return;
      const step = todaySegmentWidthRef.current / animatedTodayClasses.length;
      const delta = direction === "next" ? -step : step;
      todayOffsetRef.current = wrapCarouselOffset(
        todayOffsetRef.current + delta,
        todaySegmentWidthRef.current,
      );
      if (todayTrackRef.current) {
        todayTrackRef.current.style.transform = `translate3d(${todayOffsetRef.current}px, 0, 0)`;
  ...
  const heroStats = summary?.authenticated
    ? [
        [
          ...
          t("رصيدك الحالي", "Current balance"),
        ],
        [
          (summary.rewardPoints ?? 0).toLocaleString(
            lang === "en" ? "en-US" : "ar-EG",
          ),
          t("فيتزوناتك الحالية", "Your points"),
        ],
        [
          summary.membership?.name ?? t("بدون اشتراك", "No membership"),
          t("الباقة النشطة", "Active plan"),
        ],
      ]
    : (lang === "en"
        ? (heroContent.statsEn ?? heroContent.stats)
        : heroContent.stats
  ...
  const walletHighlights = [
    ...
    [
      "🎁",
      summary?.authenticated
        ? `${summary?.referralEarned ?? 0} ${lang === "en" ? "EGP" : "ج.م"}`
        : "20%",
      summary?.authenticated
        ? t("مكافآت الإحالة", "Referral rewards")
        : t("خصم الإحالة", "Referral discount"),
    ],
    [
      "📦",
      summary?.membership?.name ?? getTierLabel(summary?.rewardTier),
      summary?.membership
        ? t("الاشتراك النشط", "Active plan")
        : t("مستوى العضوية", "Membership tier"),
    ],
  ];
  const heroSlides = heroContent.slides ?? [];
  const nextHeroSlideIndex =
    heroSlides.length > 1 ? (heroSlideIndex + 1) % heroSlides.length : -1;
  const visibleHeroSlides = heroSlides
    .map((slide, index) => ({ slide, index }))
    .filter(
      ({ index }) => index === heroSlideIndex || index === nextHeroSlideIndex,
    )
    .filter(
      ({ slide }, index, slides) =>
        slides.findIndex((entry) => entry.slide === slide) === index,
    );
  const heroBadge =
    lang === "en"
      ? (heroContent.badgeEn ?? heroContent.badge)
      : heroContent.badge;
  const heroHeadline1 =
    lang === "en"
      ? (heroContent.headline1En ?? heroContent.headline1)
      : heroContent.headline1;
  const heroHeadline2 =
    lang === "en"
      ? (heroContent.headline2En ?? heroContent.headline2)
      : heroContent.headline2;
  const heroHeadline3 =
    lang === "en"
      ? (heroContent.headline3En ?? heroContent.headline3)
      : heroContent.headline3;
  const heroSubtext =
    lang === "en"
      ? (heroContent.subtextEn ?? heroContent.subtext)
      : heroContent.subtext;
  const heroCtaPrimary =
    lang === "en"
      ? (heroContent.ctaPrimaryEn ?? heroContent.ctaPrimary)
      : heroContent.ctaPrimary;
  const heroCtaSecondary =
    lang === "en"
      ? (heroContent.ctaSecondaryEn ?? heroContent.ctaSecondary)
      : heroContent.ctaSecondary;
  const handleTrialBooking = () => {
    window.dispatchEvent(
      new CustomEvent("fitzone:trial-booking", {
        detail: { scheduleId: null },
      }),
    );
  };
  ...
  const startMembershipFlow = (
    ...
    window.dispatchEvent(
      new CustomEvent(GLOBAL_SUBSCRIBE_EVENT, {
        detail: {
          membershipId,
          offerId: offerId ?? null,
          offerSpecialPrice: offerSpecialPrice ?? null,
        },
      }),
    );
  ...
  return (
    <div>
          ...
          <div style={{ position: "absolute", inset: 0 }}>
            ...
            <div
              style={{
                ...
                inset: 0,
                background:
                  "linear-gradient(90deg, rgba(252,228,236,.85) 30%, rgba(255,240,245,.4) 100%)",
              }}
            />
          </div>
          <div
          ...
          >
            ...
            >
              ...
              >
                ...
                <h1
                  style={{
                    fontSize: viewportWidth() < 768 ? 34 : 56,
                    fontWeight: 900,
                    lineHeight: 1.3,
                    color: C.white,
                    marginBottom: 20,
                ...
                >
                  ...
                  {heroHeadline3}{" "}
                  <span
                    style={{ color: C.red, textShadow: `0 0 30px ${C.red}66` }}
                  >
                    {heroHeadline2}
                  </span>
                </h1>
                <p
                  style={{
                    fontSize: viewportWidth() < 768 ? 15 : 17,
                    color: C.gray,
                    lineHeight: 1.8,
                    marginBottom: 36,
                    maxWidth: 460,
                ...
                >
                  {heroStats.map(([n, l]) => (
                    <div key={l} style={{ minWidth: 72 }}>
                      <div
                        style={{ fontSize: 30, fontWeight: 900, color: C.red }}
                      >
                        {n}
                      </div>
                      <div
                  ...
                  >
                      ...
                      {heroSlides.length === 0 ? (
                        ...
                        <div
                          style={{
                            ...
                            borderRadius: 14,
                            background:
                              "linear-gradient(135deg, rgba(30,5,20,.9), rgba(10,2,8,.95))",
                          }}
                        />
                      ) : (
                            ...
                            >
                              ...
                              <div
                                style={{
                                  ...
                                  inset: 0,
                                  background:
                                    "linear-gradient(180deg, transparent, rgba(26,8,18,.18))",
                                  pointerEvents: "none",
                                }}
                              />
                              <div
                    ...
                    <div
                      style={{
                        ...
                        right: 18,
                        bottom: 18,
                        display: heroSlides.length > 0 ? "flex" : "none",
                        gap: 8,
                      }}
                    >
                      {heroSlides.map((_, index) => (
                        <button
                          ...
                          style={{
                            ...
                            opacity: index === heroSlideIndex ? 1 : 0.85,
                            transition:
                              "transform .2s ease, opacity .2s ease, background-color .2s ease",
                          }}
                        />
                      ))}
                    </div>
                ...
                left:
                  viewportWidth() < 768
                    ...
                    : lang === "ar"
                      ...
                      : "auto",
                right:
                  viewportWidth() < 768 ? 16 : lang === "ar" ? "auto" : "5%",
                bottom: viewportWidth() < 768 ? 16 : 40,
                background: C.bgCard,
                border: `1px solid ${C.border}`,
                borderRadius: 12,
                padding: "14px 20px",
                display: viewportWidth() < 768 ? "none" : "flex",
                alignItems: "center",
                gap: 12,
                zIndex: 2,
              }}
            >
              ...
              <div>
                <div style={{ fontWeight: 700, fontSize: 13, color: C.white }}>
                  {summary?.authenticated
                    ? summary.user?.name || t("عضوة جديدة", "New member")
                    : t("مشتركات اليوم", "Today's members")}
                </div>
                <div style={{ fontSize: 11, color: C.redDark }}>
                  {summary?.authenticated
                    ? `${t("الباقة:", "Plan:")} ${summary.membership?.name ?? t("بدون اشتراك", "No membership")}`
                    : "+12 عضوة جديدة"}
                </div>
              </div>
            </div>
      ...
      {/* ─ HOME OFFERS GRID ─ */}
      {hydrationDisable !== "offers" &&
        homeDataReady &&
        homeSectionTopology.current.offers && (
          <section
            className="section"
              ...
              >
                <div>
                  <h2 className="section-title">
                    {t("العروض", "Current")}{" "}
                    <span>{t("الحالية", "Offers")}</span>
                  </h2>
                  <p style={{ color: C.gray, fontSize: 14, marginTop: 4 }}>
                    {t(
                      "عروض لفترة محدودة — اشتركي قبل انتهاء الوقت",
                      "Limited-time offers — subscribe before time runs out",
                    )}
                  </p>
                </div>
                <button
                  ...
                  onClick={() => {
                    sessionStorage.setItem(
                      "fitzone_offers_scroll",
                      "offers-section",
                    );
                    navigate("offers");
                  }}
                >
                  {t("مزيد من العروض", "More offers")}
                </button>
              </div>
              <div
                style={{
                  ...
                  gridTemplateColumns: responsiveColumns(
                    "1fr",
                    "1fr 1fr",
                    `repeat(${Math.min(Math.max(homeOffers.length + homeCustomPlans.length, 3), 3)}, 1fr)`,
                  ),
                  gap: 24,
                }}
              >
                {homeOffers.map((offer) => {
                  ...
                  const maxSubscribers =
                    typeof offer.maxSubscribers === "number"
                      ? offer.maxSubscribers
                      : null;
                  const hasSeatLimit =
                    offer.showMaxSubscribers &&
                    maxSubscribers != null &&
                    maxSubscribers > 0;
                  ...
                  return (
                    ...
                    >
                        ...
                        >
                          ...
                          <div
                            style={{
                              ...
                              inset: 0,
                              background:
                                "linear-gradient(to top, rgba(10,5,8,.75) 0%, transparent 55%)",
                            }}
                          />
                          <span
                            style={{
                      ...
                      <div style={{ padding: "20px 22px 22px" }}>
                          ...
                          <span
                            style={{
                              ...
                              background: isSpecial
                                ? C.redText
                                : `${accentColor}22`,
                              color: isSpecial ? "#fff" : accentColor,
                              fontSize: 11,
                              fontWeight: 800,
                              padding: "3px 10px",
                              borderRadius: 20,
                        ...
                        >
                          {isSpecial
                            ? formatCurrency(offer.specialPrice ?? 0)
                            : offer.type === "percentage"
                              ? `${offer.discount}%`
                              : `${offer.discount} ${t("ج.م", "EGP")}`}
                        </div>
                        <div
                          style={{
                            fontSize: 11,
                          ...
                          >
                            {offer.showCurrentSubscribers !== false && (
                              <div style={{ textAlign: "center" }}>
                                ...
                                >
                                  {offer.currentSubscribers.toLocaleString(
                                    lang === "en" ? "en-US" : "ar-EG",
                                  )}
                                </div>
                            ...
                            >
                              <div
                                style={{
                                  fontSize: 16,
                                  fontWeight: 900,
                                  color: cd.expired ? C.gray : accentColor,
                                }}
                              >
                        ...
                        <button
                          ...
                          onClick={() => {
                            if (offer.friendOfferEnabled) {
                              window.sessionStorage.setItem(
                                "fitzone_friend_offer_pending",
                                JSON.stringify({
                                  kind: "open",
                                  offerId: offer.id,
                                }),
                ...
                {homeCustomPlans.map((plan) => {
                  ...
                  const discountedPrice =
                    plan.priceAfter != null
                      ? plan.priceAfter
                      : pct > 0
                        ? Math.round(plan.price * (1 - pct / 100))
                        : plan.price;
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        {plan.image ? (
                          ...
                          <div
                            style={{
                              ...
                              justifyContent: "center",
                              gap: 10,
                              background: `linear-gradient(135deg, ${C.red}22, ${C.red}0D)`,
                            }}
                          >
                        ...
                        <div
                          style={{
                            ...
                            inset: 0,
                            background:
                              "linear-gradient(to top, rgba(10,5,8,.80) 0%, transparent 55%)",
                          }}
                        />
                        {pct > 0 && (
                          <span
                      ...
                      >
                        ...
                        >
                          <span>
                            📅 {minM} – {maxM} {t("شهور", "months")}
                          </span>
                          {pct > 0 && (
                            <span style={{ color: C.successText }}>
                              ✅{" "}
                              {t(
                                `خصم ${pct}% على الإجمالي`,
                                `${pct}% total discount`,
                              )}
                            </span>
                          )}
                        ...
                        <button
                          ...
                          onClick={() => startMembershipFlow(plan.id)}
                        >
                          {t("اشتركي الآن", "Subscribe now")}
                        </button>
                      </div>
      ...
      {homeDataReady &&
        homeSectionTopology.current.featured &&
        homeFeaturedPlan && (
          <section
            className="section"
            ...
            <div className="container">
              <div
                style={{
                  ...
                  background:
                    "linear-gradient(135deg, rgba(28,0,22,0.97) 0%, rgba(48,0,32,0.97) 60%, rgba(33,0,25,0.97) 100%)",
                  boxShadow:
                    "0 20px 60px rgba(199,0,114,0.15), 0 4px 20px rgba(0,0,0,0.4)",
                  overflow: "hidden",
                  display: "flex",
              ...
              >
                ...
                <div
                  style={{
                    width: viewportWidth() < 768 ? "100%" : 6,
                    height: viewportWidth() < 768 ? 6 : "auto",
                    background: "linear-gradient(135deg, #c70072, #8c004f)",
                    flexShrink: 0,
                    alignSelf: "stretch",
                  }}
                />
                <div
                  style={{
                    padding: viewportWidth() < 768 ? "28px 20px" : "32px 40px",
                    flex: 1,
                  }}
                >
                  <div
                  ...
                  >
                    <div>
                      <div
                        style={{
                          ...
                          alignItems: "center",
                          gap: 6,
                          background: "rgba(199,0,114,0.15)",
                          border: "1px solid rgba(199,0,114,0.35)",
                          borderRadius: 8,
                          padding: "4px 12px",
                          marginBottom: 12,
                        }}
                      ...
                      >
                        {homeFeaturedPlan.subtitle ??
                          t(
                            `احضري كلاسات بلا حدود خلال ${homeFeaturedPlan.durationDays} يومًا كاملة`,
                            `Unlimited classes for ${homeFeaturedPlan.durationDays} full days`,
                          )}
                      </p>
                      <ul
                        style={{
                      ...
                      >
                        {homeFeaturedPlan.features.map((feat, i) => (
                          ...
                          >
                            <span style={{ color: "#c70072", fontSize: 14 }}>
                              ✦
                            </span>
                            {feat}
                          </li>
                    ...
                    <div style={{ textAlign: "center", flexShrink: 0 }}>
                      ...
                      >
                        {homeFeaturedPlan.priceBefore != null &&
                          homeFeaturedPlan.priceBefore >
                            homeFeaturedPlan.price && (
                            <div
                              style={{
                                fontSize: 16,
                                color: "#b06080",
                            ...
                            >
                              {homeFeaturedPlan.priceBefore.toLocaleString(
                                "ar-EG",
                              )}{" "}
                              {t("ج.م", "EGP")}
                            </div>
                        ...
                        >
                          {homeFeaturedPlan.price.toLocaleString("ar-EG")}
                        </div>
                      </div>
                      <div
                        style={{
                      ...
                      >
                        {t("جنيه", "EGP")} / {homeFeaturedPlan.durationDays}{" "}
                        {t("يوم", "days")}
                      </div>
                      <button
                        onClick={() => {
                          ...
                          setTimeout(
                            () =>
                              window.dispatchEvent(
                                new CustomEvent("fitzone:goto-featured"),
                              ),
                            120,
                          );
                        }}
                        style={{
                          background:
                            "linear-gradient(135deg, #c70072, #8c004f)",
                          color: "#fff",
                          border: "none",
                          borderRadius: 12,
                          padding: "14px 28px",
                          ...
                          cursor: "pointer",
                          fontFamily: "'Cairo', sans-serif",
                          boxShadow: "0 6px 20px rgba(199,0,114,0.4)",
                        }}
                      >
                        {t("اشتركي الآن ⭐", "Subscribe Now ⭐")}
                      </button>
        ...
        <div className="container">
          ...
          >
            {[
              {
                icon: "repeat",
                label: t("الاشتراكات", "Memberships"),
                page: "memberships",
                sub: t("باقات متنوعة", "Flexible plans"),
              },
              {
                icon: "gift",
                label: t("الباقات", "Packages"),
                page: "offers",
                sub: t("عروض خاصة", "Special deals"),
              },
              {
                icon: "tag",
                label: t("العروض", "Offers"),
                page: "offers",
                sub: t("خصومات حصرية", "Exclusive discounts"),
              },
              {
                icon: "calendar",
                label: t("الجدول الأسبوعي", "Weekly schedule"),
                page: "schedule",
                sub: t("احجزي مقعدك", "Book your spot"),
              },
              ...(storeEnabled
                ? [
                    {
                      ...
                      label: t("المتجر", "Shop"),
                      page: "shop",
                      sub: t("منتجات رياضية", "Sports products"),
                    },
                  ]
                : []),
              {
                icon: "wallet",
                label: t("شحن المحفظة", "Top up wallet"),
                page: "wallet",
                sub: t("بونص حتى 15%", "Bonus up to 15%"),
              },
              ...
              >
                ...
                <div style={{ textAlign: "right" }}>
                  <div
                    style={{ fontWeight: 700, fontSize: 14, color: C.white }}
                  >
                    {label}
                  </div>
        ...
        <section className="section">
          <div className="container">
            <div style={{ textAlign: "center", marginBottom: 48 }}>
              ...
              >
                {t("كلاساتنا", "Our classes")}
              </span>
              <h2 className="section-title">
                {t("كلاسات تناسب", "Classes for")}{" "}
                <span>{t("كل أهدافك", "every goal")}</span>
              </h2>
              <p className="section-sub">
                {t(
                  "كلاسات جيم متنوعة في بني سويف تساعدك على اللياقة، النزول في الوزن، والمرونة بإشراف مدربات متخصصات.",
                  "Diverse gym classes in Beni Suef for fitness, weight loss, flexibility, and better performance with specialized coaches.",
                )}
              </p>
            </div>
            <div
              ...
              {classes.map((c) => (
                <button
                  ...
                  style={{
                    ...
                    alignItems: "center",
                    gap: 10,
                    minWidth: viewportWidth() < 768 ? 96 : 110,
          ...
          <div className="container">
            ...
            >
              <div>
                ...
                <h2 className="section-title">
                  {t("اختاري", "Choose")} <span>{t("الباقة", "the plan")}</span>{" "}
                  {t("المناسبة", "that fits")}
                </h2>
                <p className="section-sub" style={{ marginTop: 6 }}>
                  {t(
                    "باقات جيم مرنة تناسب أهداف السيدات والأطفال في بني سويف، بأسعار واضحة وخيارات متعددة.",
                    "Flexible gym plans for women and kids in Beni Suef, with clear pricing and multiple options.",
                  )}
                </p>
              </div>
              <button
            ...
            >
              {memberships.length === 0 ? (
                ...
                memberships.map((m, i) => {
                  const accentColor =
                    m.color ?? PLAN_COLORS[i % PLAN_COLORS.length];
                  const textColor = getAccessibleTextColor(accentColor);
                  const hasDis =
                    m.priceBefore != null &&
                    m.priceBefore > (m.priceAfter ?? m.price);
                  const discount = hasDis
                    ? Math.round(
                        (1 - (m.priceAfter ?? m.price) / m.priceBefore!) * 100,
                      )
                    : null;
                  return (
                    <div
                      ...
                      style={{
                        ...
                        overflow: "hidden",
                        border: `1px solid ${accentColor}33`,
                        boxShadow: m.popular ? `0 0 0 2px ${C.red}` : "none",
                        display: "flex",
                        flexDirection: "column",
                        height: "100%",
                      }}
                    >
                      ...
                      >
                        ...
                        {hasDis && m.priceBefore != null && (
                          ...
                          >
                            {formatCurrency(m.priceBefore)} {t("ج.م", "EGP")}
                          </div>
                        )}
                        <div
                          style={{
                        ...
                        <button
                          ...
                          onClick={() => startMembershipFlow(m.id)}
                        >
                          {t("اشتركي الآن", "Subscribe now")}
                        </button>
                      </div>
      ...
      <section className="section">
        <div className="container">
          ...
          >
            <div>
              <h2 className="section-title">
                {t("كلاسات", "Today's")} <span>{t("اليوم", "classes")}</span>
              </h2>
              <p style={{ color: C.gray, fontSize: 14 }}>
                {t("جدول اليوم", "Today’s schedule")} ·{" "}
                {t("بني سويف", "Beni Suef")}
              </p>
            </div>
            <button
              className="btn-outline"
          ...
          {todayClasses.length === 0 ? (
            <div
              className="card"
              style={{ padding: 24, textAlign: "center", color: C.gray }}
            >
              {t(
                "لا توجد كلاسات لليوم حالياً. يمكنك الاطلاع على الجدول الكامل لاختيار موعد مناسب.",
                "No classes today. Check the full schedule to pick a suitable time.",
              )}
            </div>
          ) : (
            <div style={{ position: "relative" }}>
              ...
              <div
                ...
                onMouseEnter={() => {
                  todayPausedRef.current = true;
                }}
                onMouseLeave={() => {
                  todayPausedRef.current = false;
                }}
              >
                <div
                  ref={todayTrackRef}
                  className="today-classes-track"
                  style={{ direction: "ltr" }}
                >
                    ...
                    animatedTodayClasses.map((s, index) => (
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            {formatTime12Hour(s.time, { meridiem: "en" })}
                          </span>
                          <span
                            style={{
                              fontSize: 11,
                        ...
                        >
                          ...
                          <span style={{ color: C.gray, fontSize: 13 }}>
                            {t("مع المدربة", "With trainer")}:{" "}
                            {s.trainer ||
                              t("لم يتم تحديد المدربة", "Not assigned")}
                          </span>
                        </div>
                        <button
                          className="btn-primary"
                          style={{
                            ...
                            padding: "8px",
                            fontSize: 13,
                            opacity: s.spots === 0 ? 0.5 : 1,
                          }}
                          disabled={s.spots === 0}
                          onClick={() => {
                            window.dispatchEvent(
                              new CustomEvent("fitzone:trial-booking", {
                                detail: { scheduleId: s.id },
                              }),
                            );
                          }}
                        >
      ...
      <section
        style={{
          background: `linear-gradient(135deg, #FFE8F0 0%, ${C.bgCard} 100%)`,
          borderTop: `1px solid ${C.border}`,
          borderBottom: `1px solid ${C.border}`,
          padding: "64px 0",
        }}
      >
        <div
          ...
          style={{
            display: "grid",
            gridTemplateColumns: responsiveColumns("1fr", "1fr", "1fr 1fr"),
            gap: 48,
            alignItems: "center",
          }}
        >
          <div>
            ...
            >
              💳 {t("نظام المحفظة والمكافآت", "Wallet & rewards system")}
            </span>
            <h2
              style={{
                fontSize: 36,
            ...
            >
              {t("اشحني محفظتك", "Top up your wallet")}
              <br />
              <span style={{ color: C.red }}>
                {t("واكسبي أكثر", "and earn more")}
              </span>
            </h2>
            <p
              style={{
            ...
            >
              {t(
                "بونص إضافي مع كل شحن! اشحني بـ 200 ج.م واحصلي على 20 ج.م إضافية. اكسبي فيتزونات مع كل عملية واستبديليها بخصومات حصرية.",
                "Extra bonus with every top-up! Add 200 EGP and get +20 EGP. Earn points with every purchase and redeem exclusive discounts.",
              )}
            </p>
          ...
          >
            {walletHighlights.map(([icon, val, lbl]) => (
              ...
              >
                ...
                <div
                  style={{ color: C.goldDark, fontWeight: 900, fontSize: 20 }}
                >
                  {val}
                </div>
        ...
        <section className="section">
          <div className="container">
            ...
            >
              <div>
                <h2 className="section-title">
                  {t("المتجر", "Shop")} <span>{t("الرياضي", "gear")}</span>
                </h2>
                <p className="section-sub">
                  {t(
                    "متجر رياضي يضم منتجات مختارة لدعم التمرين، التغذية، وأدوات اللياقة المناسبة لاحتياجك اليومي.",
                    "A sports shop with selected products to support training, nutrition, and everyday fitness needs.",
                  )}
                </p>
              </div>
              <button
            ...
            {(() => {
              ...
              const shown = showAllHomeProducts
                ? products
                : products.slice(0, INITIAL);
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                ...
                                >
                                  {p.vatEnabled ? applyVat(p.price) : p.price}{" "}
                                  <span
                            ...
                            <button
                              style={{
                                ...
                                background: outOfStock
                                  ? "#e5e7eb"
                                  : `linear-gradient(135deg,${C.red},#c2185b)`,
                                color: outOfStock ? C.grayLight : "#fff",
                                fontWeight: 800,
                                fontSize: isMobile ? 11 : 13,
                            ...
                            >
                              <I
                                n="cart"
                                s={isMobile ? 12 : 14}
                                c={outOfStock ? C.grayLight : "#fff"}
                              />{" "}
                              {outOfStock
                                ? t("نفذت الكمية", "Out of stock")
                                : t("أضيفي للسلة", "Add to cart")}
                            </button>
                          </div>
                        </div>
                      );
                    ...
                    <div style={{ textAlign: "center", marginTop: 28 }}>
                      <button
                        ...
                        onMouseEnter={(e) => {
                          ...
                          b.style.background = C.redText;
                          b.style.color = "#fff";
                        }}
                        onMouseLeave={(e) => {
                          const b = e.currentTarget as HTMLButtonElement;
                          b.style.background = "transparent";
                          b.style.color = C.redText;
                        }}
                      >
                        {t(
                          `عرض المزيد (${products.length - INITIAL}+)`,
                          `Show more (${products.length - INITIAL}+)`,
                        )}
                      </button>
                    </div>
                  )}
      ...
      >
        ...
        >
          ...
          >
            {t("ادعي صحبتك", "Invite a friend")}{" "}
            <span style={{ color: C.red }}>
              {t("واكسبي مكافأة مالية!", "and earn a cash reward!")}
            </span>
          </h2>
          <p
            style={{
          ...
          >
            {t(
              "مكافأة تتضاف على محفظتك بمجرد اشتراك صديقتك بدعوتك.",
              "A reward is added to your wallet as soon as your friend subscribes through your invite.",
            )}
          </p>
          <button
            className="btn-primary"
          ...
          >
            <I n="share" s={16} c="#fff" />{" "}
            {t("اشتركي في برنامج الإحالة", "Join referral program")}
          </button>
        </div>
      </section>
      ...
      {nutritionist && (
        <section
          id="nutrition"
          className="section"
          style={{ background: C.bgCard2, scrollMarginTop: 120 }}
        >
          <div className="container">
            {/* Section header */}
            <div style={{ textAlign: "center", marginBottom: 40 }}>
              ...
              <p className="section-sub" style={{ marginTop: 6 }}>
                {t(
                  "استشارة تغذوية متخصصة مع خبيرة معتمدة لمساعدتك على الوصول لهدفك الصحي.",
                  "Personalized nutrition consultation with a certified expert to help you reach your health goal.",
                )}
              </p>
            </div>
              ...
              >
                ...
                {nutritionist.image ? (
                  ...
                  >
                    ...
                    <div
                      style={{
                        ...
                        inset: 0,
                        background:
                          "linear-gradient(to top, rgba(26,8,18,.72) 0%, transparent 55%)",
                      }}
                    />
                    <div
                      style={{
                    ...
                    >
                      ...
                      >
                        {t("دكتورة تغذية", "Nutrition Doctor")}
                      </div>
                    </div>
                  </div>
                ) : (
                  ...
                  >
                    ...
                    <div
                      style={{ fontWeight: 900, fontSize: 18, color: C.white }}
                    >
                      {nutritionist.name}
                    </div>
                    <div
                ...
                {/* Body */}
                <div
                  style={{ padding: "18px 22px 22px", background: C.bgCard }}
                >
                  {nutritionist.bio && (
                    <p
                      style={{
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {nutritionist.consultationFee} {t("ج.م", "EGP")}
                      </div>
                      <div
                        style={{ fontSize: 11, color: C.gray, marginTop: 3 }}
                      >
                        {t("حجز كشف", "Consultation")}
                      </div>
                    </div>
                    <div
                      style={{
                    ...
                    >
                      ...
                      >
                        {nutritionist.followupFee} {t("ج.م", "EGP")}
                      </div>
                      <div
                        style={{ fontSize: 11, color: C.gray, marginTop: 3 }}
                      >
                        {t("إعادة كشف", "Follow-up")}
                      </div>
                    </div>
                  </div>
      ...
      <section className="section">
        <div className="container">
          ...
          >
            <div>
              <h2 className="section-title">
                {t("مدرباتنا", "Our trainers")}{" "}
                <span>{t("المحترفات", "experts")}</span>
              </h2>
              <p className="section-sub" style={{ marginTop: 6 }}>
                {t(
                  "فريق مدربات محترفات في بني سويف لمساعدتك على بناء برنامج مناسب لهدفك.",
                  "A team of professional coaches in Beni Suef to help you reach your goal.",
                )}
              </p>
            </div>
            <button
              className="btn-outline"
              onClick={() => navigate("trainers", "trainers-list")}
            >
              {t("عرض كل المدربات", "All trainers")}
            </button>
          </div>
          <div
            style={{
              ...
              gridTemplateColumns:
                trainers.length === 1
                  ? "minmax(0,360px)"
                  : responsiveColumns("1fr", "1fr 1fr", "repeat(3, 1fr)"),
              gap: 24,
              justifyContent: trainers.length === 1 ? "center" : undefined,
            }}
          >
                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      inset: 0,
                      background:
                        "linear-gradient(to top, rgba(10,5,8,.6) 0%, transparent 55%)",
                    }}
                  />
                </div>
                {/* Info */}
                <div style={{ padding: "16px 18px 20px" }}>
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        style={{ fontSize: 10, color: C.gray, marginTop: 2 }}
                      >
                        {t("التقييم", "Rating")}
                      </div>
                    </div>
                  ...
                  {summary?.authenticated ? (
                    ...
                    >
                      <button
                        onClick={() =>
                          setPrivateBookingModal({ trainer, type: "private" })
                        }
                        style={{
                          padding: "11px 6px",
                          borderRadius: 10,
      ...
      <section className="section" style={{ background: C.bgCard }}>
        <div className="container">
          <div style={{ textAlign: "center", marginBottom: 40 }}>
            <h2 className="section-title">
              {t("تجارب", "Member")} <span>{t("العضوات", "reviews")}</span>
            </h2>
          </div>
          <div
            style={{
            ...
            {testimonials.map((t, index) => {
              ...
              return (
                <div
                  key={t.id ?? `${name}-${index}`}
                  className="card"
                  style={{ padding: 28, borderRight: `3px solid ${C.red}` }}
                >
                  <div style={{ display: "flex", marginBottom: 12 }}>
                    {[...Array(t.rating)].map((_, i) => (
                      <span key={i} style={{ color: C.goldText, fontSize: 16 }}>
                        ⭐
                      </span>
                    ))}
                  </div>
                  ...
                  >
                    ...
                    <span
                      style={{ fontWeight: 700, fontSize: 13, color: C.white }}
                    >
                      {name}
                    </span>
                  </div>
      ...
      {trainerDetailModal && (
        ...
        >
          ...
          >
            ...
            <div
              style={{
                height: _w < 640 ? 220 : 260,
                borderRadius: _w < 640 ? 0 : "20px 20px 0 0",
                overflow: "hidden",
                position: "relative",
              }}
            >
              {trainerDetailModal.image ? (
                <img
                  src={trainerDetailModal.image}
                  alt={trainerDetailModal.name}
                  style={{
                    width: "100%",
                    height: "100%",
                    objectFit: "cover",
              ...
              <div
                style={{
                  ...
                  inset: 0,
                  background:
                    "linear-gradient(to top, rgba(10,5,8,.92) 0%, rgba(10,5,8,.3) 50%, transparent 100%)",
                }}
              />
              <button
                onClick={() => setTrainerDetailModal(null)}
                style={{
                  position: "absolute",
                  top: 14,
                  insetInlineEnd: 14,
              ...
              >
                <div
                  style={{
                    fontWeight: 900,
                    fontSize: _w < 640 ? 20 : 22,
                    color: "#fff",
                    textShadow: "0 2px 8px rgba(0,0,0,.6)",
                  }}
                >
                  {lang === "en" && trainerDetailModal.nameEn
                    ? trainerDetailModal.nameEn
                    : trainerDetailModal.name}
                </div>
                <div
                  style={{
                    color: "#ff7aa8",
                ...
                >
                  {lang === "en" && trainerDetailModal.specialtyEn
                    ? trainerDetailModal.specialtyEn
                    : trainerDetailModal.specialty}
                </div>
              </div>
            </div>
            <div
              style={{
                padding: _w < 640 ? "18px 16px 24px" : "24px 28px 28px",
              }}
            >
              {/* Stats */}
              <div
              ...
              >
                ...
                <div
                  style={{ width: 1, background: "rgba(255,255,255,.08)" }}
                />
                <div style={{ textAlign: "center" }}>
                  <div style={{ fontWeight: 800, fontSize: 18, color: "#fff" }}>
                    {trainerDetailModal.sessionsCount}
                  </div>
                  <div style={{ fontSize: 11, color: "#888", marginTop: 2 }}>
                    {t("جلسة", "Sessions")}
                  </div>
                ...
                <div style={{ textAlign: "center" }}>
                  <div style={{ fontWeight: 800, fontSize: 18, color: "#fff" }}>
                    {trainerDetailModal.classesCount}
                  </div>
                  <div style={{ fontSize: 11, color: "#888", marginTop: 2 }}>
                    {t("كلاس", "Classes")}
                  </div>
              ...
              {/* Bio */}
              {(lang === "en"
                ? trainerDetailModal.bioEn || trainerDetailModal.bio
                : trainerDetailModal.bio) && (
                <div style={{ marginBottom: 20 }}>
                  ...
                  <p
                    style={{ color: "#e8d8e0", fontSize: 14, lineHeight: 1.85 }}
                  >
                    {lang === "en"
                      ? trainerDetailModal.bioEn || trainerDetailModal.bio
                      : trainerDetailModal.bio}
              ...
              {/* Certifications */}
              {(lang === "en"
                ? (trainerDetailModal.certificationsEn ??
                  trainerDetailModal.certifications)
                : trainerDetailModal.certifications
              ).length > 0 && (
                <div style={{ marginBottom: 20 }}>
                  <div
                  ...
                  >
                    {t("الشهادات والمؤهلات", "Certifications")}
                  </div>
              ...
              {trainerDetailModal.certificateFiles.length > 0 && (
                <div style={{ marginBottom: 20 }}>
                  ...
                  >
                    {t("صور الشهادات", "Certificate Images")}
                  </div>
                  <div
                    style={{
                      display: "grid",
              ...
              {summary?.authenticated ? (
                <div
                  style={{
                    display: "grid",
                    gridTemplateColumns: _w < 400 ? "1fr" : "1fr 1fr",
                    gap: 10,
                    marginTop: 4,
                  }}
                >
                  ...
                  >
                    ...
                    <br />
                    <span
                      style={{ fontSize: 11, fontWeight: 400, opacity: 0.75 }}
                    >
                      {t("برنامج مخصص 100%", "100% personalised")}
                    </span>
                  </button>
                  <button
                    style={{
                      borderRadius: 12,
                      border: `1.5px solid #c060e0`,
                  ...
                  >
                    ...
                    <br />
                    <span
                      style={{ fontSize: 11, fontWeight: 400, opacity: 0.85 }}
                    >
                      {t("3–5 عملاء", "3–5 clients")}
                    </span>
                  </button>
                </div>
              ) : (
      ...
      {nutritionModal &&
        nutritionist &&
        (() => {
          const nf = (key: string, value: unknown) =>
          ...
          const nfArr = (key: string, val: string, checked: boolean) => {
            ...
            setNutritionForm((f) => ({
              ...f,
              [key]: checked ? [...prev, val] : prev.filter((v) => v !== val),
            }));
          };
          const isGymMember = summary?.membership?.status === "active";
          const consultationPrice = isGymMember
            ? nutritionist.consultationFeeMember
            : nutritionist.consultationFee;
          const followupPrice = isGymMember
            ? nutritionist.followupFeeMember
            : nutritionist.followupFee;
          const price =
            nutritionType === "consultation"
              ? consultationPrice
              : followupPrice;
          ...
          const submitBooking = async () => {
            ...
            try {
              ...
              if (!res.ok) {
                setNutritionMsg({ ok: false, text: data.error ?? "حدث خطأ" });
                return;
              }
              setNutritionDone({
              ...
              setNutritionMsg({ ok: false, text: "تعذر إرسال الطلب" });
            } finally {
          ...
          const startPayment = async (sessionId: string) => {
            ...
            try {
              const res = await fetch("/api/payments/nutrition-intent", {
                ...
                body: JSON.stringify({
                  sessionId,
                  returnUrl: `${window.location.origin}/account?tab=nutrition`,
              ...
              if (data.checkoutUrl) {
                ...
                setNutritionMsg({
                  ok: false,
                  text: data.error ?? "تعذر بدء الدفع",
                });
              }
            } catch {
              setNutritionMsg({ ok: false, text: "تعذر بدء الدفع" });
            } finally {
              setNutritionSubmitting(false);
            }
          };
          ...
          const submitAndPay = async () => {
            ...
            try {
              ...
              const payRes = await fetch("/api/payments/nutrition-intent", {
                ...
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
                  sessionId: submitData.session!.id,
                  returnUrl: `${window.location.origin}/account?tab=nutrition`,
                  cancelUrl: window.location.href,
                }),
              });
              ...
              if (payData.checkoutUrl) {
                ...
                setNutritionMsg({
                  ok: false,
                  text: payData.error ?? "تعذر بدء الدفع",
                });
              }
            } catch {
              setNutritionMsg({ ok: false, text: "تعذر إرسال الطلب" });
          ...
          const mdInputSt: React.CSSProperties = {
            width: "100%",
            background: "rgba(255,255,255,.06)",
              ...
              >
                ...
                >
                  <div>
                    ...
                    <div
                      style={{ fontSize: 12, color: "#ffb7d0", marginTop: 3 }}
                    >
                      {nutritionist.name}
                    </div>
                  </div>
                ...
                {!nutritionDone && (
                  <div style={{ padding: "12px 20px 0" }}>
                    ...
                    <div
                      style={{ fontSize: 11, color: "#ffb7d0", marginTop: 6 }}
                    >
                      {t("خطوة", "Step")} {nutritionStep + 1} {t("من", "of")}{" "}
                      {totalSteps + 1}: {stepTitles[nutritionStep]}
                    </div>
                  </div>
                )}
                    ...
                    <div style={{ textAlign: "center", padding: "20px 0" }}>
                      {nutritionDone.status === "approved" ? (
                        <>
                          ...
                          >
                            {t("تم تأكيد موعدك!", "Appointment confirmed!")}
                          </div>
                          <div
                            style={{
                              color: "#ffb7d0",
                          ...
                          >
                            {t(
                              `موعدك مع دكتورة ${nutritionist.name} تم تأكيده. أكملي الدفع لتثبيت الحجز.`,
                              `Your appointment with Dr. ${nutritionist.name} is confirmed. Complete payment to secure your booking.`,
                            )}
                          </div>
                          <div
                            style={{
                          ...
                          <button
                            ...
                            onClick={() =>
                              void startPayment(nutritionDone.sessionId)
                            }
                            disabled={nutritionSubmitting}
                          >
                            {nutritionSubmitting
                              ? t("جارٍ التحويل...", "Redirecting...")
                              : `💳 ${t("أكملي الدفع", "Complete Payment")} — ${price} ${t("ج.م", "EGP")}`}
                          </button>
                          <button
                            onClick={closeModal}
                            style={{
                          ...
                          >
                            {t("لاحقاً من حسابي", "Later from my account")}
                          </button>
                        </>
                      ) : (
                        <>
                          ...
                          >
                            {t(
                              `تم استلام طلب حجزك مع دكتورة ${nutritionist.name}. سنتواصل معك قريباً لتأكيد الموعد.`,
                              `Your booking request with Dr. ${nutritionist.name} has been received. We'll contact you soon to confirm your appointment.`,
                            )}
                          </div>
                          <button
                            className="btn-primary"
                    ...
                    <>
                      ...
                      {nutritionStep === 0 && (
                        <div>
                          ...
                          >
                            {t("اختاري نوع الجلسة:", "Choose session type:")}
                          </div>
                          {[
                            {
                              type: "consultation" as const,
                              label: t("حجز كشف", "Consultation"),
                              price: consultationPrice,
                              icon: "🩺",
                              desc: t(
                                "أول زيارة لتقييم حالتك الصحية ووضع خطة غذائية مخصصة",
                                "First visit to assess your health and create a personalized nutrition plan",
                              ),
                            },
                            {
                              type: "followup" as const,
                              label: t("إعادة كشف", "Follow-up"),
                              price: followupPrice,
                              icon: "🔄",
                              desc: t(
                                "متابعة التقدم وتعديل الخطة الغذائية",
                                "Progress check and nutrition plan adjustment",
                              ),
                            },
                          ].map(({ type, label, price: p, icon, desc }) => (
                            <button
                              key={type}
                              onClick={() => setNutritionType(type)}
                              style={{
                                width: "100%",
                                marginBottom: 12,
                                padding: "16px 18px",
                                borderRadius: 12,
                                border: `2px solid ${nutritionType === type ? C.red : mdBorder}`,
                                background:
                                  nutritionType === type
                                    ? "rgba(233,30,99,.1)"
                                    : "rgba(255,255,255,.03)",
                            ...
                            >
                              ...
                              >
                                ...
                                <div
                                  style={{ textAlign: "end", flexShrink: 0 }}
                                >
                                  <div
                                    style={{
                                      fontWeight: 900,
                                  ...
                                  <div
                                    style={{ fontSize: 11, color: "#ffb7d0" }}
                                  >
                                    {t("ج.م", "EGP")}
                                  </div>
                                </div>
                          ...
                          {isGymMember && (
                            ...
                            >
                              ✅{" "}
                              {t(
                                "أنتِ عضوة في الجيم — تم تطبيق السعر المميز",
                                "You're a gym member — member price applied",
                              )}
                            </div>
                          )}
                        </div>
                        ...
                        >
                          {[
                            ...
                            <div key={key}>
                              ...
                              <input
                                type={type}
                                value={(nutritionForm[key] as string) ?? ""}
                                onChange={(e) => nf(key, e.target.value)}
                              ...
                              if (q.type === "textarea")
                                return (
                                  <div key={q.id}>
                                    ...
                                    <textarea
                                      value={
                                        (nutritionForm[fkey] as string) ?? ""
                                      }
                                      onChange={(e) => nf(fkey, e.target.value)}
                                      rows={3}
                                      style={{
                                        ...mdInputSt,
                                        resize: "vertical" as const,
                      ...
                      {nutritionStep === 2 && (
                        <div>
                          ...
                          >
                            {t(
                              "اختاري هدفك من الاستشارة الغذائية (يمكن اختيار أكثر من هدف):",
                              "Choose your nutrition goal(s):",
                            )}
                          </div>
                          <div
                            style={{
                              ...
                              return (
                                <label
                                  ...
                                  style={{
                                    ...
                                    padding: "10px 14px",
                                    borderRadius: 10,
                                    border: `1px solid ${checked ? C.red : mdBorder}`,
                                    background: checked
                                      ? "rgba(233,30,99,.1)"
                                      : "rgba(255,255,255,.03)",
                                    cursor: "pointer",
                                ...
                                >
                                  <input
                                    ...
                                    checked={checked}
                                    onChange={(e) =>
                                      nfArr("goals", goal, e.target.checked)
                                    }
                                    style={{ accentColor: C.red }}
                                  />
                          ...
                          <div style={{ marginTop: 14 }}>
                            ...
                            >
                              {t("أخرى (اكتبي هنا):", "Other:")}
                            </label>
                            <input
                              type="text"
                              value={(nutritionForm.goalsOther as string) ?? ""}
                              onChange={(e) => nf("goalsOther", e.target.value)}
                              placeholder={t(
                                "أي هدف آخر...",
                                "Any other goal...",
                              )}
                      ...
                      {nutritionStep === 3 && (
                        <div>
                          ...
                          >
                            {t(
                              "هل لديكِ أي من الحالات الطبية التالية؟",
                          ...
                          >
                            {medHistory.map((condition) => {
                              const checked = (
                                (nutritionForm.medHistory as string[]) ?? []
                              ).includes(condition);
                              return (
                                <label
                                  key={condition}
                          ...
                          {(
                            ...
                            <div style={{ marginTop: 10 }}>
                              ...
                              >
                                {t("حدديها:", "Specify allergies:")}
                              </label>
                              <input
                                type="text"
                                value={
                                  (nutritionForm.allergyDetails as string) ?? ""
                                }
                                onChange={(e) =>
                                  nf("allergyDetails", e.target.value)
                                }
                                placeholder={t(
                                  "مثال: حساسية من الفول السوداني، اللاكتوز...",
                                  "e.g. peanuts, lactose...",
                                )}
                                style={mdInputSt}
                              />
                          ...
                          <div style={{ marginTop: 14 }}>
                            ...
                            <input
                              type="text"
                              value={
                                (nutritionForm.medications as string) ?? ""
                              }
                              onChange={(e) =>
                                nf("medications", e.target.value)
                              }
                              placeholder={t(
                                "اكتبي أي أدوية تتناولينها حالياً...",
                      ...
                      {nutritionStep === 4 && (
                        <div>
                          ...
                          >
                            {t(
                              "القياسات (اختياري — تساعد الدكتورة على وضع خطة أدق):",
                              "Measurements (optional — helps create a more accurate plan):",
                            )}
                          </div>
                          <div
                            style={{
                          ...
                          >
                            ...
                            <div>
                              ...
                              <textarea
                                value={(nutritionForm.notes as string) ?? ""}
                                onChange={(e) => nf("notes", e.target.value)}
                                rows={3}
                                placeholder={t(
                                  "أي معلومات إضافية تودين مشاركتها...",
                                  "Any additional information...",
                                )}
                                style={{ ...mdInputSt, resize: "vertical" }}
                              />
                            </div>
                          </div>
                        </div>
                      ...
                      {nutritionStep === slotStep && hasSlots && (
                        <div>
                          ...
                          >
                            {nutritionist.slots.map((slot) => {
                              ...
                              return (
                                <button
                                  key={slotId}
                                  onClick={() =>
                                    setNutritionSlot(selected ? null : slotId)
                                  }
                                  aria-pressed={selected}
                                  style={{
                                    padding: "12px 16px",
                                    borderRadius: 12,
                                    border: `2px solid ${selected ? C.red : mdBorder}`,
                                    background: selected
                                      ? "rgba(233,30,99,.1)"
                                      : "rgba(255,255,255,.04)",
                                    cursor: "pointer",
                            ...
                            <button
                              onClick={() => setNutritionSlot(null)}
                              style={{
                                padding: "10px 16px",
                                borderRadius: 12,
                                border: `1px solid ${nutritionSlot === null ? C.red : mdBorder}`,
                                background:
                                  nutritionSlot === null
                                    ? "rgba(233,30,99,.08)"
                                    : "transparent",
                            ...
                            >
                              {t(
                                "⏭ إرسال الطلب بدون تحديد موعد (سنتواصل معكِ)",
                                "⏭ Send request without a slot (we'll contact you)",
                              )}
                            </button>
                          </div>
                          ...
                          {nutritionSlot &&
                            (() => {
                              ...
                              const selectedSlot = nutritionist.slots.find(
                                (s) => `${s.day}-${s.time}` === nutritionSlot,
                              );
                              return (
                                <div
                                  style={{
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    >
                                      {t(
                                        "موعدك محجوز — أكملي الدفع لتثبيته",
                                  ...
                                  >
                                    <div
                                      style={{ fontSize: 12, color: "#d7aabd" }}
                                    >
                      ...
                      <div style={{ display: "flex", gap: 10, marginTop: 20 }}>
                        {nutritionStep > 0 && (
                          <button
                            onClick={() => setNutritionStep((s) => s - 1)}
                            style={{
                              flex: 1,
                              padding: "12px",
                              borderRadius: 8,
                        ...
                        {nutritionStep < totalSteps ? (
                          <button
                            onClick={() => {
                              if (nutritionStep === 1) {
                                if (
                                  !(
                                    (nutritionForm.fullName as string) ?? ""
                                  ).trim()
                                ) {
                                  setNutritionMsg({
                                    ok: false,
                                ...
                                if (hasCustomQuestions) {
                                  const missing = nutritionist.questions.filter(
                                    (q) => {
                                  ...
                                  if (missing.length > 0) {
                                    setNutritionMsg({
                                      ok: false,
                                      text: t(
                                        `يرجى الإجابة على: ${missing.map((q) => q.label).join("، ")}`,
                          ...
                          <button
                            ...
                            style={{
                              ...
                              opacity: nutritionSubmitting ? 0.6 : 1,
                            }}
                          >
                            {nutritionSubmitting
                              ? t(
                              ...
                              : `💳 ${t("ادفعي الآن", "Pay now")} — ${price} ${t("ج.م", "EGP")}`}
                          </button>
                        ) : (
...
function mapMembershipToPlanItem(
  ...
  return {
    ...
    classSessions: Array.isArray((membership as any).classSessions)
      ? (membership as any).classSessions
      : null,
    allowedClassTypes: Array.isArray((membership as any).allowedClassTypes)
      ? (membership as any).allowedClassTypes
      : null,
    allowedClassIds: Array.isArray(membership.allowedClassIds)
      ? membership.allowedClassIds
      : undefined,
...
const MembershipsPage = ({
  ...
  navigate: (p: string) => void;
  summary: UserSummary | null;
  coachState?: CoachVisualState;
}) => {
  const t = useT();
  const { lang } = useLang();
  const [tab, setTab] = useState<
    "all" | "monthly" | "quarterly" | "semi_annual" | "annual" | "custom"
  >("all");
  ...
  const [trialClassesConfig, setTrialClassesConfig] = useState<
    Record<string, { trialEnabled: boolean; trialPrice: number }>
  >({});
  ...
  const [subMsg, setSubMsg] = useState<{
    text: string;
    ok: boolean;
    action?: "back_to_schedule" | "back_to_plan";
  } | null>(null);
  ...
  const [membershipTrainers, setMembershipTrainers] = useState<PublicTrainer[]>(
    [],
  );

  const [
    selectedCoachMembershipTrainerId,
    setSelectedCoachMembershipTrainerId,
  ] = useState<string | null>(null);
  const [subCheckoutOptions, setSubCheckoutOptions] = useState<{
    walletBalance: number;
    rewardPoints: number;
  ...
  const [customMonthsPlan, setCustomMonthsPlan] = useState<PlanItem | null>(
    null,
  );
  ...
  const [membershipPaymentSettings, setMembershipPaymentSettings] =
    ...
    loadPublicApi(true)
      .then((d) => {
        ...
        if (Array.isArray(d.goals)) {
          setGoals(
            (d.goals as PublicGoal[]).sort((a, b) => a.sortOrder - b.sortOrder),
          );
        }
        if (Array.isArray(d.classes)) {
        ...
        if (Array.isArray(d.healthQuestions)) {
          setHealthQuestions(
            (d.healthQuestions as PublicHealthQuestion[]).sort(
        ...
        if (d.paymentSettings && typeof d.paymentSettings === "object") {
          setMembershipPaymentSettings((prev) => ({
            ...prev,
            ...(d.paymentSettings as PublicPaymentSettings),
          }));
        }
        if (typeof window !== "undefined") {
          const rawPendingFlow = window.sessionStorage.getItem(
            MEMBERSHIP_FLOW_STORAGE_KEY,
          );
          if (rawPendingFlow) {
            try {
              const parsed = JSON.parse(
                rawPendingFlow,
              ) as PendingMembershipFlow;
              if (parsed?.membershipId) {
                const matchedMembership = allMemberships.find(
                ...
                if (matchedMembership) {
                  const colorIndex = Math.max(
                    ...
                    allMemberships.findIndex(
                      (membership) => membership.id === matchedMembership.id,
                    ),
                  );
                  setPendingPlan(
                    mapMembershipToPlanItem(
                      ...
                      matchedMembership.kind === "subscription" &&
                        colorIndex === 1,
                    ),
                  );
  ...
  useLayoutEffect(() => {
    ...
    const { membershipId, offerId, offerSpecialPrice } =
      pendingExternalSubscribe;
    let resolved = false;
    if (membershipId) {
      ...
      if (mb) {
        ...
        const planItem: PlanItem = {
          ...
          ...(matchedOffer?.durationDays != null
            ? { durationDays: matchedOffer.durationDays }
            : {}),
          ...(matchedOffer?.sessionsCount != null
            ? { sessionsCount: matchedOffer.sessionsCount }
            : {}),
          ...(matchedOffer
            ? {
                ...
                allowedClassTypes: Array.isArray(matchedOffer.allowedClassTypes)
                  ? matchedOffer.allowedClassTypes
                  : null,
              }
            : {}),
        };
    ...
    if (!resolved && offerId) {
      ...
      if (offer) {
        const effectivePrice =
          offerSpecialPrice != null
            ? offerSpecialPrice
            : offer.specialPrice != null && offer.specialPrice > 0
              ? offer.specialPrice
              : 0;
        const virtualOfferPlan: PlanItem = {
          ...
          features: [
            offer.description ||
              t("اشتراك عرض خاص", "Special offer subscription"),
            offer.appliesTo
              ? `${t("ينطبق على", "Applies to")}: ${offer.appliesTo}`
              : t(
                  "صلاحية الاشتراك حسب العرض",
                  "Subscription validity follows offer policy",
                ),
          ],
          color: C.red,
          popular: false,
  ...
  useEffect(() => {
    const handler = (e: Event) => {
      const scheduleId =
        (e as CustomEvent<{ scheduleId?: string | null }>).detail?.scheduleId ??
        null;
      loadPublicApi()
        .then((d) => {
          const trialMb = d.trialMembership as {
            id: string;
            name: string;
            price: number;
            sessionsCount: number;
          ...
          const trialPlan: PlanItem = {
            ...
            cycle: null,
            sessionsCount: 1,
            features: trialMb?.features?.length
              ? trialMb.features
              : ["حجز كلاس فردي من جميع الأنواع", "اختاري أي موعد متاح"],
            color: C.red,
            popular: false,
            goalIds: [],
            isTrial: true,
          ...
          if (Array.isArray(d.classes))
            setPublicClasses(d.classes as PublicClass[]);
          if (
            d.trialClassesConfig &&
            typeof d.trialClassesConfig === "object"
          ) {
            setTrialClassesConfig(
              d.trialClassesConfig as Record<
                string,
  ...
  const gamesRoot = useMemo(
    () => rootGoals.find((goal) => goal.kind === "games_root"),
    [rootGoals],
  );
  ...
  const gamesChildIds = useMemo(
    () => gamesChildren.map((goal) => goal.id),
    [gamesChildren],
  );
  ...
  const goalViewParent = useMemo(
    () =>
      goalViewParentId
        ? (goals.find((goal) => goal.id === goalViewParentId) ?? null)
        : null,
    [goals, goalViewParentId],
  );
  const goalViewChildren = useMemo(() => {
    if (!goalViewParentId) return [];
    return (goalsByParent.get(goalViewParentId) ?? []).sort(
      (a, b) => a.sortOrder - b.sortOrder,
    );
  ...
  const toggleGoal = (goalId: string) => {
    ...
    setSelectedGoals((prev) => {
      ...
      const cleaned =
        childIds.length > 0
          ? next.filter((id) => !childIds.includes(id))
          : next;
  ...
  useEffect(() => {
    const showGoalMembershipsForTour = () => {
      ...
      const firstSelectableGoal = displayGoals.find(
        (goal) => (goalsByParent.get(goal.id)?.length ?? 0) === 0,
      );
    ...
    const clearTourGoal = () => {
      ...
      setSelectedGoals((current) =>
        current.filter((goalId) => goalId !== temporaryGoalId),
      );
      tourSelectedGoalRef.current = null;
    };
    window.addEventListener(
      "fitzone:tour-show-goal-memberships",
      showGoalMembershipsForTour,
    );
  ...
  const filteredPlans = useMemo(() => {
    ...
    const byCycle =
      tab === "all"
        ? byGoal
        : byGoal.filter((plan) => (plan.cycle ?? "custom") === tab);
    const requestedIds = coachState?.membershipResultIds ?? [];
    const requested = requestedIds.length
      ? byCycle.filter((plan) => requestedIds.includes(plan.id ?? ""))
      : byCycle;
    if (coachState?.membershipSort === "price_asc")
      return [...requested].sort(
        (a, b) => (a.priceAfter ?? a.price) - (b.priceAfter ?? b.price),
      );
    if (coachState?.membershipSort === "price_desc")
      return [...requested].sort(
    ...
    selectedGoals,
    tab,
    coachState?.membershipResultIds,
    coachState?.membershipSort,
  ]);
  ...
  // Canonical customer entitlement from /api/public.
  // Presence matters: [] means ZERO eligible classes, while undefined means
  // this is a legacy/non-canonical path and may use the compatibility fallback.
  const planAllowedClassIds = useMemo((): Set<string> | null => {
    if (!schedulePlan || !Array.isArray(schedulePlan.allowedClassIds))
      return null;
    return new Set(schedulePlan.allowedClassIds);
  }, [schedulePlan]);

  // Compatibility fallback only. Membership/package purchase flows should use
  // canonical allowedClassIds and must not reinterpret legacy classSessions.
  const planAllowedClassTypes = useMemo((): Set<string> | null => {
    ...
    if (
      schedulePlan.allowedClassTypes &&
      schedulePlan.allowedClassTypes.length > 0
    ) {
    ...
    if (types.size === 0) {
      ...
      const linkedIds = new Set(
        schedulePlan.classSessions.map((cs) => cs.classId),
      );
  ...
  const scheduleChoices = useMemo(() => {
    ...
    const blocked = new Set(
      surveyBlockedTypes.map((t) => normalizeClassTypeKey(t)),
    );
    ...
    publicClasses.forEach((c) => {
      ...
      // Authoritative membership/package entitlement.
      // An empty canonical set intentionally blocks every class.
      if (planAllowedClassIds && !planAllowedClassIds.has(c.id)) return;

      // Legacy/special-offer fallback only when canonical IDs are unavailable.
      if (
        !planAllowedClassIds &&
        planAllowedClassTypes &&
        typeKey &&
        !planAllowedClassTypes.has(typeKey)
      )
        return;

      // Trial Class availability is controlled explicitly by Admin.
      if (isTrial) {
        const cfg = trialClassesConfig[c.id];
        const configuredTrialPrice = Number(cfg?.trialPrice);

        if (
          cfg?.trialEnabled !== true ||
          !Number.isFinite(configuredTrialPrice) ||
          configuredTrialPrice <= 0
        ) {
          return;
        }
      }
      (c.schedules || []).forEach((s) => {
        ...
        // Keep the UI aligned with the authoritative server rule:
        // Schedule.date is a calendar anchor and Schedule.time is Cairo wall-clock time.
        // Never offer a seed slot that has already started.
        const slotInstant = scheduleSlotInstant(date, s.time);
        if (slotInstant.getTime() <= nowMs) return;
  ...
  const scheduleSplit = useMemo(() => {
    const cutoff = 15 * 60;
    const morning = scheduleSlots.filter(
      (slot) => parseScheduleTime(slot) < cutoff,
    );
    const evening = scheduleSlots.filter(
      (slot) => parseScheduleTime(slot) >= cutoff,
    );
  ...
  const toggleScheduleSelection = (
    entry: { id: string; day: string; time: string; date: string },
    disabled: boolean,
  ) => {
    if (disabled) return;
    setScheduleError(null);
    setScheduleSelections((prev) => {
      ...
      const dayCount = cleaned.filter(
        (id) => scheduleChoices.find((c) => c.id === id)?.day === entry.day,
      ).length;
      if (dayCount >= 2) {
        setScheduleError(
          daysPerWeek
      ...
      const maxSessions = daysPerWeek
        ? daysPerWeek * 2
        : Math.min(12, schedulePlan?.sessionsCount ?? 12);
      ...
      if (daysPerWeek) {
        const selectedDays = new Set(
          cleaned
            .map((id) => scheduleChoices.find((c) => c.id === id)?.day)
            .filter(Boolean),
        );
        if (!selectedDays.has(entry.day) && selectedDays.size >= daysPerWeek) {
          setScheduleError(
            `يمكنكِ اختيار ${daysPerWeek} أيام مختلفة فقط في الأسبوع.`,
          );
          return prev;
        }
      }
  ...
  const openSurvey = (plan: PlanItem) => {
    ...
    if (plan.id && plan.kind === "subscription")
      trackBusinessView("subscription_viewed", plan.id);
    if (plan.id && plan.kind === "package")
      trackBusinessView("package_viewed", plan.id);
    ...
    healthQuestions.forEach((question) => {
      initialAnswers[question.id] = surveyAnswers[question.id] ?? {
        answer: null,
        reason: "",
      };
    });
  ...
  const handleSurveyContinue = async () => {
    ...
    const unanswered = healthQuestions.some(
      (q) => surveyAnswers[q.id]?.answer == null,
    );
    if (unanswered) {
      setSurveyError(
        t(
    ...
    const missingReason = healthQuestions.find(
      (q) =>
        q.allowReason &&
        surveyAnswers[q.id]?.answer === true &&
        !surveyAnswers[q.id]?.reason?.trim(),
    );
    if (missingReason) {
      setSurveyError(
        t(
          `يرجى كتابة السبب للسؤال: "${missingReason.title}"`,
          `Please provide a reason for: "${missingReason.title}"`,
        ),
      );
      return;
    }
    ...
    // Always bind the current plan before schedule eligibility is evaluated.
    // scheduleChoices is derived from schedulePlan, so checking it here would
    // read stale state from the previous/null plan.
    setSchedulePlan(plan);
    setScheduleSelections([]);
    setScheduleError(null);
    setDaysPerWeek(null);
  ...
  const validateDiscount = async (membershipId?: string) => {
    ...
    try {
      ...
      if (!res.ok || !data.valid) {
        setDiscountError(
          data.error || t("كود الخصم غير صالح.", "Invalid discount code."),
        );
      } else {
        setDiscountResult({
          id: data.id!,
      ...
      setDiscountError(
        t("تعذر التحقق من الكود.", "Could not validate the code."),
      );
    } finally {
  ...
  const getMembershipFinancialSummary = (plan: PlanItem) => {
    const originalPrice =
      plan.priceBefore != null && plan.priceBefore > 0
        ? plan.priceBefore
        : plan.price;
    const membershipPrice =
      plan.priceAfter != null && plan.priceAfter > 0
        ? plan.priceAfter
        : plan.price;
    ...
    if (discountResult) {
      if (discountResult.type === "percentage") {
        const raw =
          Math.round(((membershipPrice * discountResult.value) / 100) * 100) /
          100;
        promoDiscount =
          discountResult.maxDiscount != null
            ? Math.min(raw, discountResult.maxDiscount)
            : raw;
      } else {
    ...
    const isEligibleForAffiliateDiscount =
      !plan.offerId && plan.kind !== "package";
    const affiliateRate =
      isEligibleForAffiliateDiscount &&
      subCheckoutOptions?.affiliateDiscountEligible
        ? (subCheckoutOptions.affiliateDiscountRate ?? 0)
        : 0;
    const affiliateDiscount =
      affiliateRate > 0
        ? Math.round(((afterPromo * affiliateRate) / 100) * 100) / 100
        : 0;
    ...
    const rewardsDiscount = subUseRewards
      ? Math.min(subRewardsEGP, afterAffiliate)
      : 0;
    const walletDiscount = subUseWallet
      ? Math.min(subWalletBal, Math.max(0, afterAffiliate - rewardsDiscount))
      : 0;
    const finalAmount = Math.max(
      0,
      afterAffiliate - rewardsDiscount - walletDiscount,
    );
    const pointsToDeduct =
      subUseRewards && subCheckoutOptions
        ? Math.ceil(rewardsDiscount / subCheckoutOptions.pointValueEGP)
        : 0;
    return {
      originalPrice,
      membershipPrice,
  ...
  const openCheckoutPreview = (plan: PlanItem, scheduleIds: string[] = []) => {
    ...
    setSelectedCoachMembershipTrainerId(null);
    ...
    fetch("/api/public", { cache: "no-store" })
      ...
      .then((d: { trainers?: PublicTrainer[] } | null) => {
        setMembershipTrainers(
          Array.isArray(d?.trainers)
            ? d.trainers.filter(
                (trainer) => trainer.coachMembershipEligible === true,
              )
            : [],
        );
      })
  ...
  const handleSubscribe = async (
    plan: PlanItem,
    scheduleIds: string[] = [],
    paymentOverride?: "paymob",
    coachMembershipTrainerId?: string | null,
  ) => {
    if (!plan.id && !plan.offerId) {
      navigate("register");
      return;
    }
    ...
    if (plan.coachMembershipEnabled === true && !coachMembershipTrainerId) {
      setSubMsg({
        text: t(
          "اختاري المدرب أولاً لإكمال اشتراك المدرب.",
          "Please select a coach before continuing with Coach Membership.",
        ),
        ok: false,
      });
      return;
    ...
    try {
      const res = await fetch("/api/subscribe", {
        ...
        body: JSON.stringify(
          (() => {
            ...
            const storedAffiliateRef = localStorage.getItem(
              "fitzone:affiliate-ref",
            );
            return {
              membershipId: plan.id,
              scheduleIds,
              paymentMethod: paymentOverride ?? membershipPayMethod,
              discountCode: discountResult
                ? discountCode.trim().toUpperCase()
                : null,
              memberBenefitCode:
                !discountResult && storedPartnerBenefitCode
                  ? storedPartnerBenefitCode
                  : undefined,
              affiliateRef: storedAffiliateRef || undefined,
              walletDeduct:
                fs.walletDiscount > 0 ? fs.walletDiscount : undefined,
              pointsDeduct:
                fs.pointsToDeduct > 0 ? fs.pointsToDeduct : undefined,
              ...
              coachMembershipTrainerId:
                plan.coachMembershipEnabled === true
                  ? (coachMembershipTrainerId ?? undefined)
                  : undefined,
              startDate:
                plan.isFeatured && featuredStartDate
                  ? featuredStartDate
                  : undefined,
            };
          })(),
      ...
      if (res.status === 401) {
        setSubMsg({
          text: "⚠️ يجب تسجيل الدخول أولاً يابطلة للاشتراك — جارٍ تحويلك لصفحة الدخول...",
          ok: false,
        });
        setTimeout(() => {
          window.location.href = `/login?callbackUrl=${encodeURIComponent("/?page=memberships")}`;
      ...
      if (data.checkoutUrl) {
        ...
        setSubMsg({
          text: `✅ تم الاشتراك في باقة ${plan.name} بنجاح!`,
          ok: true,
        });
  ...
  const handleScheduleConfirm = async () => {
    ...
    if (scheduleChoices.length > 0) {
      ...
      const bookingPolicy = resolveBookingPolicy({
        kind: schedulePlan.isTrial
          ? "trial"
          : (schedulePlan.kind ?? "subscription"),
        sessionsCount: schedulePlan.sessionsCount ?? null,
        durationDays: schedulePlan.durationDays,
      });

      if (
        bookingPolicy.minRequiredSelection !== null &&
        scheduleSelections.length < bookingPolicy.minRequiredSelection
      ) {
        setScheduleError(
          `يلزم اختيار ${bookingPolicy.minRequiredSelection} مواعيد على الأقل لتغطية حصص الاشتراك.`,
        );
        return;
      }
      ...
      if (daysPerWeek) {
        ...
        if (selectedDays.size < daysPerWeek) {
          setScheduleError(
            `يجب اختيار مواعيد من ${daysPerWeek} أيام مختلفة على الأقل.`,
          );
          return;
        }
        if (scheduleSelections.length < daysPerWeek) {
          setScheduleError(
            `يجب اختيار ${daysPerWeek} حصص على الأقل (حصة واحدة من كل يوم).`,
          );
          return;
        }
      }
    ...
    const selected = scheduleSelections.filter(
      (id) => !scheduleChoices.length || validIds.has(id),
    );
    if (plan.isTrial && selected.length === 0) {
      setScheduleError("الموعد المختار لم يعد متاحًا. يرجى اختيار موعد آخر.");
      return;
    }
    // Trial Class price comes only from explicit Admin configuration.
    if (plan.isTrial && selected.length > 0) {
      const slot = scheduleChoices.find((c) => c.id === selected[0]);
      const cfg = slot ? trialClassesConfig[slot.classId] : undefined;
      const price = Number(cfg?.trialPrice);

      if (cfg?.trialEnabled !== true || !Number.isFinite(price) || price <= 0) {
        setScheduleError("هذا الكلاس غير مضبوط ككلاس تجريبي من الإدارة.");
        return;
      }
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        setVerifyMsg({
          text: data.error || t("كود غير صحيح", "Invalid code"),
          ok: false,
        });
        return;
      }
      setVerifyMsg({
        text: t(
          "✅ تم تفعيل حسابك بنجاح! جارٍ الاشتراك...",
          "✅ Your account has been verified successfully. Completing subscription...",
        ),
        ok: true,
      });
      ...
      if (pendingPlan) {
        setTimeout(
          () =>
            handleSubscribe(
              pendingPlan.plan,
              pendingPlan.scheduleIds,
              membershipPayMethod,
              pendingPlan.coachMembershipTrainerId ?? null,
            ),
          800,
        );
      }
  ...
  const handleResend = async () => {
    ...
    try {
      ...
      setVerifyMsg({
        text: t("تعذر إرسال الكود", "Could not send the code"),
        ok: false,
      });
    } finally {
  ...
  const faqs = [
    {
      ...
      a: t(
        "نعم، يمكنك إلغاء اشتراكك في أي وقت. سيستمر الاشتراك حتى نهاية الفترة المدفوعة.",
        "Yes, you can cancel your subscription at any time. It will remain active until the end of the paid period.",
      ),
    },
    {
      q: t("كيف أحجز الكلاسات؟", "How do I book classes?"),
      a: t(
        "بعد الاشتراك، يمكنك الحجز مباشرة من صفحة الجدول الأسبوعي أو من تفاصيل الكلاس.",
        "After subscribing, you can book directly from the weekly schedule page or from the class details.",
      ),
    },
    {
      q: t("هل يمكن تجميد الاشتراك؟", "Can I freeze my subscription?"),
      a: t(
        "نعم، نتيح تجميد الاشتراك لمدة تصل إلى شهرين في السنة.",
        "Yes, you can freeze your subscription for up to two months per year.",
      ),
    },
    {
      q: t("ما طرق الدفع المتاحة؟", "What payment methods are available?"),
      a: t(
        "جميع وسائل الدفع الإلكترونية تتم عبر Paymob، ومنها البطاقات والمحافظ وخيارات الدفع المتاحة من خلاله.",
        "All electronic payment methods are processed through Paymob, including cards, wallets, and the available payment options it supports.",
      ),
    },
    {
      q: t("هل يوجد كلاسات للأطفال؟", "Are there classes for kids?"),
      a: t(
        "نعم! لدينا برامج مخصصة للأطفال من سن 4 سنوات فأكثر.",
        "Yes! We have dedicated programs for children from age 4 and up.",
      ),
    },
  ];
    ...
    <div>
        ...
        >
          <div
            style={{
              ...
              maxWidth: 460,
              width: "100%",
              boxShadow: "0 24px 60px rgba(233,30,99,.25)",
          ...
          >
            ...
            >
              <h2 style={{ fontWeight: 900, fontSize: 20, color: "#fff" }}>
                {t("اختاري عدد الشهور", "Select number of months")}
              </h2>
              <button
                onClick={() => setCustomMonthsPlan(null)}
                style={{
                  border: "none",
                  background: "none",
                  fontSize: 22,
            ...
            <p style={{ color: "#bbb", fontSize: 13, marginBottom: 22 }}>
              {t(
                `سعر الشهر الواحد: ${customMonthsPlan.price} ج.م — خصم ${customMonthsPlan.discountPct ?? 0}%`,
                `Price per month: ${customMonthsPlan.price} EGP — ${customMonthsPlan.discountPct ?? 0}% discount`,
              )}
            </p>
            <div
              style={{
            ...
            >
              {Array.from(
                {
                  length:
                    (customMonthsPlan.maxMonths ?? 6) -
                    (customMonthsPlan.minMonths ?? 3) +
                    1,
                },
                (_, i) => (customMonthsPlan.minMonths ?? 3) + i,
              ).map((m) => {
                const pct = customMonthsPlan.discountPct ?? 0;
                const total = Math.round(
                  customMonthsPlan.price * m * (1 - pct / 100),
                );
                const selected = selectedCustomMonths === m;
                return (
                  <button
                    key={m}
                    onClick={() => setSelectedCustomMonths(m)}
                    style={{
                      flex: "1 1 calc(50% - 10px)",
                      minWidth: 120,
                      padding: "14px 10px",
                      borderRadius: 14,
                      border: `2px solid ${selected ? C.red : "rgba(255,255,255,.15)"}`,
                      background: selected
                        ? "rgba(233,30,99,.18)"
                        : "rgba(255,255,255,.04)",
                      cursor: "pointer",
                  ...
                  >
                    <div
                      style={{ fontWeight: 900, fontSize: 18, color: "#fff" }}
                    >
                      {m} {t("شهور", "months")}
                    </div>
                    <div style={{ fontSize: 11, color: "#bbb", marginTop: 2 }}>
                      {customMonthsPlan.price} × {m} ={" "}
                      <span style={{ color: "#f87" }}>
                        {customMonthsPlan.price * m} ج.م
                      </span>
                    </div>
                    <div
                      style={{
                    ...
                    {pct > 0 && (
                      <div
                        style={{ fontSize: 10, color: "#4ade80", marginTop: 2 }}
                      >
                        خصم {pct}%
                      </div>
                    )}
        ...
        >
          <div
            style={{
              background: "#fff",
              borderRadius: 18,
              padding: viewportWidth() < 640 ? 16 : 28,
              maxWidth: 680,
              width: "100%",
              boxShadow: "0 24px 60px rgba(233,30,99,.2)",
              border: `1px solid ${C.border}`,
              marginTop: "auto",
              marginBottom: "auto",
            }}
          >
            ...
            >
              <h2 style={{ fontWeight: 900, fontSize: 20, color: C.white }}>
                {t("استبيان الإصابات", "Health Survey")}
              </h2>
              <button
                onClick={() => setSurveyPlan(null)}
            ...
            >
              {t(
                ...
                "Answer the following questions so we can determine the right classes for you before subscribing.",
              )}
            </p>

            <div style={{ display: "grid", gap: 12 }}>
              {healthQuestions.map((question) => {
                const entry = surveyAnswers[question.id] ?? {
                  answer: null,
                  reason: "",
                };
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      style={{ color: C.gray, fontSize: 13, lineHeight: 1.7 }}
                    >
                      {question.prompt}
                    </div>
                    <div style={{ display: "flex", gap: 8, marginTop: 12 }}>
                      <button
                        onClick={() =>
                          setSurveyAnswers((prev) => ({
                            ...
                            [question.id]: {
                              answer: true,
                              reason: prev[question.id]?.reason ?? "",
                            },
                          }))
                        }
                        className="btn-outline"
                      ...
                      <button
                        onClick={() =>
                          setSurveyAnswers((prev) => ({
                            ...prev,
                            [question.id]: { answer: false, reason: "" },
                          }))
                        }
                        className="btn-outline"
                        style={{
                    ...
                    question.restrictedClassTypes.length > 0 ? (
                      <div style={{ marginTop: 8, fontSize: 12, color: C.red }}>
                        {t("الكلاسات الممنوعة:", "Restricted classes:")}{" "}
                        {question.restrictedClassTypes
                          .map(formatClassType)
                          .join("، ")}
                      </div>
                    ) : null}
            ...
            {surveyBlockedTypes.length > 0 ? (
              ...
              >
                <div
                  style={{ fontWeight: 800, color: C.white, marginBottom: 6 }}
                >
                  {t("ملخص الكلاسات الممنوعة", "Restricted classes summary")}
                </div>
              ...
              <div>
                <h2
                  style={{
                    fontWeight: 900,
                    fontSize: 20,
                    color: scheduleStep === "view-only" ? "#f5c542" : "#fff",
                  }}
                >
                  {schedulePlan?.isTrial
                    ? t(
                        "اختاري موعد الكلاس التجريبي",
                        "Choose your trial class slot",
                      )
                    : scheduleStep === "view-only"
                      ? "📅 مواعيد الكلاسات المتاحة"
                      : scheduleStep === "frequency"
                        ? "كثافة الحضور الأسبوعية"
                        : "اختاري مواعيدك المناسبة"}
                </h2>
                <p style={{ color: "#c9b9c1", fontSize: 13, marginTop: 4 }}>
                  {schedulePlan?.isTrial
                    ? t(
                        "اختاري يوماً وحصة واحدة فقط.",
                        "Select one day and one session only.",
                      )
                    : scheduleStep === "view-only"
            ...
            {scheduleStep === "view-only" ? (
              <div>
                ...
                >
                  ...
                  <span>
                    اشتراك اوبن تايم — يمكنك حضور أي كلاس وأي عدد حصص خلال فترة
                    اشتراكك بدون قيود
                  </span>
                </div>
                {scheduleChoices.length === 0 ? (
                  ...
                  >
                    لا توجد مواعيد معروضة حاليًا، تواصل مع الإدارة لمعرفة
                    الجدول.
                  </div>
                ) : (
                  <>
                        ...
                        <div className="schedule-outer">
                          ...
                          >
                            <table className="schedule-table">
                              <thead>
                                <tr>
                                  <th className="schedule-cell day-head">
                                    اليوم
                                  </th>
                                  {scheduleSplit.morning.map((slot) => (
                                    <th
                                      key={`vo-morning-head-${slot}`}
                                      className="schedule-cell time"
                                    >
                              ...
                              <tbody>
                                {scheduleDays.map((day) => (
                                  <tr key={`vo-morning-row-${day}`}>
                                    ...
                                    {scheduleSplit.morning.map((slot) => {
                                      const cellEntries =
                                        scheduleChoices.filter(
                                          (e) =>
                                            e.day === day && e.time === slot,
                                        );
                                      return (
                                        <td
                                          key={`vo-${day}-morning-${slot}`}
              ...
              (() => {
                if (scheduleChoices.length === 0) {
                  return (
                    <div>
                      ...
                      >
                        {t(
                          "لا توجد مواعيد مطلوبة لهذه الباقة الآن، يمكنك المتابعة مباشرة إلى ملخص الاشتراك ثم اختيار وسيلة الدفع.",
                          "No schedule selection is required for this membership right now. You can continue directly to the subscription summary and then choose your payment method.",
                        )}
                      </div>
                      <div
                        style={{
                ...
                const availableDays = new Set(scheduleChoices.map((c) => c.day))
                  .size;
                const maxDays =
                  planAllowedClassTypes && availableDays > 0
                ...
                return (
                  <div>
                    ...
                    {daysPerWeek && (
                      ...
                      >
                        {t(
                          `ستختارين ${daysPerWeek} أيام بحد أقصى حصتين لكل يوم — إجمالي من ${daysPerWeek} إلى ${daysPerWeek * 2} حصة/أسبوع`,
                          `You will select ${daysPerWeek} days with max 2 sessions per day — ${daysPerWeek} to ${daysPerWeek * 2} sessions/week total`,
                        )}
                      </div>
                    )}
                    <div
                    ...
                    >
                      ...
                      <button
                        ...
                        style={{
                          ...
                          borderRadius: 10,
                          border: "none",
                          background: daysPerWeek
                            ? C.red
                            : "rgba(255,255,255,.1)",
                          color: daysPerWeek ? "#fff" : "#666",
                          cursor: daysPerWeek ? "pointer" : "not-allowed",
                          fontWeight: 700,
                          fontSize: 14,
                        }}
                      >
              ...
              <>
                ...
                >
                  <div
                    style={{ color: "#f5c542", fontWeight: 800, fontSize: 13 }}
                  >
                    {schedulePlan.isTrial ? (
                      t(
                        "اختاري موعداً واحداً للكلاس التجريبي",
                        "Select one slot for your trial class",
                      )
                    ) : daysPerWeek ? (
                      <>
                        {daysPerWeek} أيام / أسبوع ·{" "}
                        <span style={{ color: "#c9b9c1", fontWeight: 400 }}>
                          حصتان كحد أقصى في اليوم · إجمالي {daysPerWeek * 2} حصة
                        </span>
                      </>
                    ) : (
                ...
                {schedulePlan.isTrial && (
                  ...
                  >
                    ...
                    <span>
                      {t(
                        "السعر يظهر على كل كلاس — اختاري الموعد المناسب.",
                        "The price is shown on each class card — pick your preferred slot.",
                      )}
                    </span>
                  </div>
                )}
                ...
                {scheduleChoices.length === 0 ? (
                  ...
                  >
                    لا توجد مواعيد متاحة حاليًا، يمكنك المتابعة وسيتم التنسيق
                    لاحقًا من الإدارة.
                  </div>
                ) : (
                  <>
                    {!schedulePlan.isTrial && (
                      ...
                      >
                        ...
                        <span>
                          {t(
                            "يمكنكِ حجز أكثر من كلاس في نفس اليوم.",
                            "You can book more than one class on the same day.",
                          )}
                        </span>
                      </div>
                    )}
      ...
      {pendingPaymentUrl && (
        ...
        >
          ...
          >
            {t("صفحة الدفع الآمن جاهزة", "Secure payment page ready")}
          </div>
          <div
            style={{
              color: "#d7aabd",
          ...
          >
            {t(
              "اضغطي على الزرار للانتقال إلى صفحة الدفع",
              "Tap the button to proceed to the payment page",
            )}
          </div>
          <a
        ...
        >
          <div
            style={{
              background: "#fff",
              borderRadius: 20,
              padding: viewportWidth() < 640 ? 18 : 28,
              maxWidth: 520,
              width: "100%",
              boxShadow: "0 24px 60px rgba(233,30,99,.2)",
              border: `1px solid ${C.border}`,
            ...
            {(() => {
              ...
              return (
                <>
                  ...
                  >
                    <h2
                      style={{ fontWeight: 900, fontSize: 22, color: C.white }}
                    >
                      {t("ملخص الاشتراك", "Subscription summary")}
                    </h2>
                    <button
                  ...
                  >
                    ...
                    >
                      <div>
                        ...
                        >
                          {checkoutPreview.plan.name}
                        </div>
                        <div
                          style={{ color: C.gray, fontSize: 12, marginTop: 4 }}
                        >
                          {t("مدة الاشتراك", "Membership duration")}{" "}
                          {checkoutPreview.plan.durationDays} {t("يوم", "days")}
                        </div>
                        {checkoutPreview.plan.isFeatured &&
                          featuredStartDate && (
                            <div
                              style={{
                                marginTop: 6,
                      ...
                      {checkoutPreview.scheduleIds.length > 0 ? (
                        ...
                        >
                          {checkoutPreview.scheduleIds.length}{" "}
                          {t("مواعيد مختارة", "selected slots")}
                        </div>
                      ) : null}
                    </div>
                    ...
                    <div style={{ display: "grid", gap: 8, fontSize: 13 }}>
                      ...
                      >
                        ...
                        <strong style={{ color: C.white }}>
                          {formatCurrency(summary.originalPrice)}
                        </strong>
                      </div>
                      {summary.membershipDiscount > 0 ? (
                        ...
                        >
                          ...
                          <strong style={{ color: C.successText }}>
                            - {formatCurrency(summary.membershipDiscount)}
                          </strong>
                        </div>
                      ) : null}
                        ...
                        >
                          <span>
                            {discountResult?.description
                              ? `${t("كود الخصم", "Promo code")} (${discountCode.trim().toUpperCase()})`
                              : t("خصم الكود", "Promo discount")}
                          </span>
                          <strong style={{ color: C.successText }}>
                      ...
                      {summary.affiliateDiscount > 0 ? (
                        ...
                        >
                          ...
                          <strong style={{ color: C.successText }}>
                            - {formatCurrency(summary.affiliateDiscount)}
                          </strong>
                        </div>
                      ) : subCheckoutOptions?.affiliateDiscountEligible &&
                        (checkoutPreview.plan.offerId ||
                          checkoutPreview.plan.kind === "package") ? (
                        <div
                          style={{
                            fontSize: 11,
                            color: C.gray,
                        ...
                        >
                          {t(
                            "خصم الشريك لا ينطبق على العروض أو الباقات",
                            "Partner discount does not apply to offers or packages",
                          )}
                        </div>
                      ) : null}
                      {summary.rewardsDiscount > 0 ? (
                        ...
                        >
                          ...
                          <strong style={{ color: C.goldText }}>
                            - {formatCurrency(summary.rewardsDiscount)}
                          </strong>
                        </div>
                      ) : null}
                      {summary.walletDiscount > 0 ? (
                        ...
                        >
                          ...
                          <strong style={{ color: C.successText }}>
                            - {formatCurrency(summary.walletDiscount)}
                          </strong>
                        </div>
                      ) : null}
                      <div
                      ...
                      >
                        <span style={{ fontWeight: 900, color: C.white }}>
                          {t("الإجمالي المستحق", "Amount due")}
                        </span>
                        <strong style={{ color: C.redText, fontSize: 18 }}>
                  ...
                  {subCheckoutOptions &&
                    (subCheckoutOptions.rewardPointsEGP > 0 ||
                      ...
                      >
                        ...
                        >
                          {t("استخدام رصيدك", "Use your balance")}
                        </div>
                        {subCheckoutOptions.rewardPointsEGP > 0 && (
                          <div
                            onClick={() => setSubUseRewards((v) => !v)}
                            style={{
                              display: "flex",
                              alignItems: "center",
                              gap: 10,
                          ...
                          >
                            <div
                              style={{
                                ...
                                height: 18,
                                borderRadius: 4,
                                border: `2px solid ${subUseRewards ? C.red : C.border}`,
                                background: subUseRewards
                                  ? C.red
                                  : "transparent",
                                display: "flex",
                                alignItems: "center",
                            ...
                            <span style={{ fontSize: 13, color: C.grayLight }}>
                              ...
                              <strong style={{ color: C.goldText }}>
                                (
                                {subCheckoutOptions.rewardPoints.toLocaleString(
                                  lang === "ar" ? "ar-EG" : "en-US",
                                )}{" "}
                                {t("فيتزونة", "FZs")} ={" "}
                                {formatCurrency(
                                  subCheckoutOptions.rewardPointsEGP,
                                )}
                                )
                              </strong>
                            </span>
                          ...
                          >
                            <div
                              style={{
                                ...
                                height: 18,
                                borderRadius: 4,
                                border: `2px solid ${subUseWallet ? C.red : C.border}`,
                                background: subUseWallet
                                  ? C.red
                                  : "transparent",
                                display: "flex",
                                alignItems: "center",
                            ...
                            <span style={{ fontSize: 13, color: C.grayLight }}>
                              ...
                              <strong style={{ color: C.successText }}>
                                (
                                {formatCurrency(
                                  subCheckoutOptions.walletBalance,
                                )}{" "}
                                {t("ج.م", "EGP")})
                              </strong>
                            </span>
                  ...
                  {!checkoutPreview.confirmed ? (
                    ...
                    <>
                        ...
                        >
                          ...
                          >
                            ...
                            <div style={{ flex: 1 }}>
                              ...
                              >
                                {membershipPaymentSettings.displayLabel ||
                                  t(
                            ...
                            >
                              {[
                                ...
                                "/payment-logos/u-valu-logo.webp",
                                "/payment-logos/sympl-menu2.png",
                              ]
                                .filter(Boolean)
                                .map((src) => (
                                  <div
                              ...
                              >
                                ...
                                >
                                  {[
                                    "/payment-logos/vodafone-cash.svg",
                                    "/payment-logos/we-pay.svg",
                                    "/payment-logos/etisalat-cash.svg",
                                    "/payment-logos/orange-cash.svg",
                                    "/payment-logos/fawry.svg",
                                  ]
                                    .filter(Boolean)
                                    .map((src) => (
                                      <img
                      ...
                      {checkoutPreview.plan.coachMembershipEnabled === true && (
                        <div
                          style={{
                            marginBottom: 14,
                            padding: "14px",
                        ...
                        >
                          ...
                          >
                            {t("اختاري المدرب", "Choose your coach")}
                          </div>

                          {membershipTrainers.length === 0 ? (
                            <div
                              style={{
                                color: "#fca5a5",
                                fontSize: 13,
                            ...
                            >
                              {t(
                                "لا يوجد مدرب متاح حالياً لهذا النوع من الاشتراك. تواصلي مع الإدارة للمساعدة.",
                                "No eligible coach is currently available for this membership. Please contact the club for assistance.",
                              )}
                            </div>
                          ) : (
                            <select
                              value={selectedCoachMembershipTrainerId ?? ""}
                              onChange={(e) => {
                                setSelectedCoachMembershipTrainerId(
                                  e.target.value || null,
                                );
                            ...
                            >
                              <option value="">
                                {t("اختاري المدرب", "Select a coach")}
                              </option>

                              {membershipTrainers.map((trainer) => (
                      ...
                      {subMsg && !subMsg.ok && (
                        ...
                        >
                          <div style={{ marginBottom: subMsg.action ? 10 : 0 }}>
                            {subMsg.text}
                          </div>
                          {subMsg.action === "back_to_schedule" && (
                            <button
                              onClick={() => {
                                ...
                                setDaysPerWeek(null);
                                setScheduleStep("frequency");
                                setSchedulePlan(checkoutPreview?.plan ?? null);
                              }}
                              style={{
                                marginTop: 4,
                                padding: "7px 18px",
        ...
        >
          <div
            style={{
              background: "#fff",
              borderRadius: 20,
              padding: viewportWidth() < 640 ? 20 : 32,
              maxWidth: 420,
              width: "100%",
              boxShadow: "0 24px 60px rgba(233,30,99,.2)",
              border: `1px solid ${C.border}`,
          ...
          >
            ...
            >
              ...
              <br />
              أدخل الكود للمتابعة والاشتراك في باقة{" "}
              <strong style={{ color: C.red }}>{verifyModal.plan.name}</strong>
            </p>
            <input
              value={verifyCode}
              onChange={(e) =>
              ...
              style={{
                ...
                padding: "12px 16px",
                borderRadius: 12,
                border: `2px solid ${verifyCode.length === 6 ? C.red : C.border}`,
                outline: "none",
                marginBottom: 16,
                color: C.white,
            ...
            {verifyMsg && (
              <div
                style={{
                  ...
                  padding: "10px 14px",
                  borderRadius: 10,
                  background: verifyMsg.ok ? "#dcfce7" : "#fee2e2",
                  color: verifyMsg.ok ? "#166534" : "#991b1b",
                  fontWeight: 700,
                  fontSize: 13,
                }}
              >
            ...
            <button
              ...
              style={{
                ...
                fontSize: 16,
                cursor:
                  verifyLoading || verifyCode.length < 4
                    ? "not-allowed"
                    : "pointer",
                opacity: verifyLoading || verifyCode.length < 4 ? 0.6 : 1,
                marginBottom: 12,
            ...
            >
              <button
                ...
                style={{
                  background: "none",
                  border: "none",
                  color: resendCooldown > 0 ? C.gray : C.red,
                  fontSize: 13,
                  fontWeight: 600,
      ...
      <section
        id="memberships"
        style={{
          background: `linear-gradient(135deg, #FFE0EC, ${C.bg})`,
          padding: "64px 0",
          scrollMarginTop: 120,
        }}
      >
        <div className="container" style={{ textAlign: "center" }}>
          ...
          >
            {t("الأهداف والاشتراكات", "Goals and memberships")}
          </span>
          <h1
            style={{
              fontSize: viewportWidth() < 768 ? 32 : 44,
              fontWeight: 900,
              marginBottom: 12,
              color: C.white,
            }}
          >
            {t("اختاري", "Choose")}{" "}
            <span style={{ color: C.red }}>
              {t("هدفك واشتراكك", "your goal and membership")}
            </span>
          </h1>
          <p style={{ color: C.gray, fontSize: 16, marginBottom: 32 }}>
            {t(
              "اختاري من اشتراكات الجيم والباقات الرياضية في بني سويف حسب هدفك ومستوى تدريبك.",
              "Choose from gym memberships and fitness packages in Beni Suef based on your goal and training level.",
            )}
          </p>
          <div
            style={{
          ...
          >
            ...
            <button
              className={`tab ${tab === "quarterly" ? "active" : ""}`}
              onClick={() => setTab("quarterly")}
            >
              {t("ربع سنوي", "Quarterly")}
            </button>
            <button
              className={`tab ${tab === "semi_annual" ? "active" : ""}`}
              onClick={() => setTab("semi_annual")}
            >
              {t("نصف سنوي", "Semi-annual")}
            </button>
            <button
              className={`tab ${tab === "annual" ? "active" : ""}`}
          ...
          <div className="container">
            <div style={{ textAlign: "center", marginBottom: 28 }}>
              <h2 className="section-title">
                {goalViewParentId ? (
                  <>
                    {t("اختاري هدفك", "Choose your")}{" "}
                    <span>{t("الفرعي", "sub-goal")}</span>
                  </>
                ) : (
                  <>
                    {t("اختاري هدفك", "Choose your")}{" "}
                    <span>{t("الرياضي", "fitness goal")}</span>
                  </>
                )}
              </h2>
              <p className="section-sub">
                {goalViewParentId
                  ? t(
                      `أهداف ${goalViewParent?.name ?? "مختارة"} — اختاري هدفًا فرعيًا لعرض الاشتراكات والبرامج المناسبة.`,
                      `${goalViewParent?.name ?? "Selected"} goals - choose a sub-goal to view matching memberships and programs.`,
                    )
                  : t(
                      "يمكنك اختيار أكثر من هدف لعرض الاشتراكات والبرامج المناسبة لكل هدف.",
                      "You can choose more than one goal to view the memberships and programs that fit each one.",
                    )}
              </p>
              {goalViewParentId && (
                <button
            ...
            {goals.length === 0 ? (
              <div
                className="card"
                style={{ padding: 20, textAlign: "center", color: C.gray }}
              >
              ...
              <>
                <div
                  ...
                  style={{
                    ...
                    gap: 16,
                    minHeight: viewportWidth() < 768 ? 260 : 340,
                    scrollMarginTop: 120,
                  }}
                >
                  {displayGoals.map((goal) => {
                    ...
                    const hasChildren =
                      !goal.parentId &&
                      (goalsByParent.get(goal.id)?.length ?? 0) > 0;
                    return (
                      <button
                        key={goal.id}
                        onClick={() => {
          ...
          <div className="container">
            {subMsg && (
              <div
                style={{
                  ...
                  padding: "14px 20px",
                  borderRadius: 8,
                  background: subMsg.ok ? "#dcfce7" : "#fee2e2",
                  color: subMsg.ok ? "#166534" : "#991b1b",
                  fontWeight: 700,
                  textAlign: "center",
                  fontSize: 14,
                }}
            ...
            >
              ...
              {discountResult && (
                ...
                >
                  <span>
                    ✅ {t("تم تطبيق الخصم:", "Discount applied:")}{" "}
                    {discountResult.type === "percentage"
                      ? `${discountResult.value}%`
                      : `${discountResult.value} ${t("جنيه", "EGP")}`}
                    {discountResult.discountAmount != null &&
                      discountResult.discountAmount > 0 &&
                      ` — ${t("توفيري", "You save")} ${discountResult.discountAmount} ${t("جنيه", "EGP")}`}
                  </span>
                  <button
                    onClick={() => {
                      setDiscountResult(null);
            ...
            {featuredPlan &&
              (() => {
                ...
                const endDateStr = featuredStartDate
                  ? (() => {
                      const d = new Date(featuredStartDate + "T00:00:00");
                      d.setDate(d.getDate() + featuredPlan.durationDays);
                  ...
                  : null;
                const featuredPrice =
                  featuredPlan.priceAfter ?? featuredPlan.price;
                const featuredPriceBefore = featuredPlan.priceBefore ?? null;
                const hasDiscount =
                  featuredPriceBefore != null &&
                  featuredPriceBefore > featuredPrice;
                return (
                  <div
                    ref={featuredCardRef}
                    style={{
                  ...
                  >
                    ...
                    <div
                      style={{
                        height: 3,
                        background:
                          "linear-gradient(90deg, transparent, #c70072, #e0359a, #c70072, transparent)",
                      }}
                    />
                    ...
                    >
                      ...
                      <div style={{ flex: "1 1 240px" }}>
                        ...
                        <div
                          style={{
                            ...
                            gap: 6,
                            background: "rgba(199,0,114,0.15)",
                            border: "1px solid rgba(199,0,114,0.4)",
                            borderRadius: 999,
                            padding: "4px 14px",
                            marginBottom: 14,
                          }}
                        ...
                        >
                          {featuredPlan.subtitle ??
                            t(
                              `احضري كلاسات بلا حدود خلال ${featuredPlan.durationDays} يومًا كاملة`,
                              `Unlimited classes for ${featuredPlan.durationDays} full days`,
                            )}
                        </p>
                        ...
                        >
                          ...
                          >
                            {featuredPrice.toLocaleString("ar-EG")}
                          </span>
                          <span style={{ color: "#f0c0d8", fontSize: 13 }}>
                            {t("ج.م", "EGP")}
                          </span>
                          {hasDiscount && (
                            <span
                            ...
                            >
                              {featuredPriceBefore!.toLocaleString("ar-EG")}
                            </span>
                          )}
                        </div>
                        {hasDiscount && (
                          ...
                          >
                            وفّري{" "}
                            {Math.round(
                              (1 - featuredPrice / featuredPriceBefore!) * 100,
                            )}
                            ٪
                          </div>
                        )}
                      ...
                      >
                        <div
                          style={{
                            background: "rgba(255,255,255,0.04)",
                            border: "1px solid rgba(199,0,114,0.25)",
                            borderRadius: 10,
                            padding: "16px 16px 14px",
                          }}
                        >
                          <label
                            htmlFor="featured-plan-start-date"
                            style={{
                              display: "block",
                              fontSize: 12,
                              fontWeight: 700,
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setFeaturedStartDate(e.target.value)
                            }
                          ...
                          {!featuredStartDate && (
                            ...
                            >
                              {t(
                                "اختاري التاريخ ثم اضغطي اشتركي",
                                "Pick a date, then subscribe",
                              )}
                            </div>
                          )}
                        </div>
                        ...
                        <button
                          onClick={() => {
                            if (!featuredStartDate) {
                              alert(
                                t(
                                  "اختاري تاريخ البداية أولاً",
                          ...
                          disabled={
                            featuredPlan.id !== null &&
                            subscribing === featuredPlan.id
                          }
                          style={{
                            width: "100%",
                            padding: "13px 20px",
                            borderRadius: 12,
                            border: "none",
                            background: featuredStartDate
                              ? "linear-gradient(135deg, #c70072, #8c004f)"
                              : "rgba(199,0,114,0.2)",
                            color: featuredStartDate ? "#fff" : "#906070",
                            fontWeight: 900,
                            fontSize: 15,
                            cursor: featuredStartDate
                              ? "pointer"
                              : "not-allowed",
                            fontFamily: "'Cairo', sans-serif",
                            boxShadow: featuredStartDate
                              ? "0 8px 24px rgba(199,0,114,0.35)"
                              : "none",
                            transition: "all .2s",
                          }}
                        >
                          {subscribing === featuredPlan.id
                            ? t("جارٍ الاشتراك...", "Processing...")
                            : t("اشتركي الآن ⭐", "Subscribe Now ⭐")}
                        </button>
                      </div>
                    </div>
              ...
              >
                {goalViewParentId
                  ? t(
                      ...
                      "Select a sub-goal to see suitable plans.",
                    )
                  : t(
                      "اختاري هدفًا أو أكثر لعرض الاشتراكات المناسبة.",
                      "Select one or more goals to see suitable plans.",
                    )}
              </div>
                ...
                {filteredPlans.map((p, index) => {
                  ...
                  return (
                    <div
                      key={p.name}
                      ref={
                        index === 0 && selectedGoals.length > 0
                          ? firstMatchingPlanRef
                          : undefined
                      }
                      data-tour={
                        index === 0 ? "first-goal-membership-card" : undefined
                      }
                      className="card"
                      style={{
                        padding: 0,
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <span style={{ color: C.gray, fontSize: 11 }}>
                            / {cycleLabel(p.cycle, p.durationDays)}
                          </span>
                        </div>
                      ...
                      >
                        <div style={{ flex: 1 }}>
                          {p.features.map((feat, fi) => (
                            ...
                            >
                              ...
                              <span
                                style={{ color: C.grayLight, lineHeight: 1.5 }}
                              >
                                {feat}
                              </span>
                            </div>
                        ...
                        <button
                          ...
                          style={{
                            ...
                            fontWeight: 800,
                            cursor:
                              p.id !== null && subscribing === p.id
                                ? "not-allowed"
                                : "pointer",
                            transition: "all .2s",
                            opacity:
                              p.id !== null && subscribing === p.id ? 0.7 : 1,
                            boxShadow: p.popular
                              ? `0 6px 18px ${p.color}44`
                              : "none",
                            fontFamily: "'Cairo','Tajawal',sans-serif",
                          }}
                        >
      ...
      <section className="section" style={{ background: C.bgCard }}>
        <div className="container" style={{ maxWidth: 700, margin: "0 auto" }}>
          ...
          >
            {t("الأسئلة", "Frequently")}{" "}
            <span>{t("الشائعة", "Asked Questions")}</span>
          </h2>
          {faqs.map((f, i) => (
            <div
              key={i}
            ...
            >
              ...
              >
                {f.q}{" "}
                <I n={openFaq === i ? "minus" : "plus"} s={16} c={C.red} />
              </button>
              {openFaq === i && (
                <div
                  style={{
      ...
      <div
        style={{
          position: viewportWidth() < 768 ? "static" : "sticky",
          bottom: 0,
          background: C.bgCard,
          borderTop: `1px solid ${C.border}`,
          padding: "14px 0",
      ...
      >
        ...
        >
          <p style={{ fontWeight: 600, color: C.gray, fontSize: 14 }}>
            {t(
              "مستعدة تبدئي رحلتك مع فيت زون؟",
              "Ready to start your journey with Fit Zone?",
            )}
          </p>
          <button
            className="btn-primary"
            style={{
              padding: "10px 32px",
              opacity: selectedGoals.length === 0 || !primaryPlan ? 0.6 : 1,
            }}
            onClick={() => {
              setSubMsg({
                text: "برجاء الضغط على الاشتراك المفضل لديكِ للاستكمال.",
                ok: false,
              });
              setTimeout(() => {
                plansRef.current?.scrollIntoView({
...
const OffersPage = ({
  ...
  const [friendOffer, setFriendOffer] = useState<PublicOffer | null>(null);
  const [friendGroup, setFriendGroup] = useState<FriendOfferGroupView | null>(
    null,
  );
  ...
  const friendInviteUrl = (token: string) => {
    if (typeof window === "undefined") return "";

    const url = new URL(window.location.origin + window.location.pathname);
    url.searchParams.set("page", "offers");
    url.searchParams.set("friendOffer", token);
  ...
  const createFriendGroup = async (
    ...
    if (summary == null) {
      setFriendError(
        t(
          "جاري تحميل بيانات الحساب، حاولي مرة أخرى.",
    ...
    try {
      const response = await fetch("/api/friend-offers", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          action: "create",
      ...
      if (!response.ok || !data?.group) {
        throw new Error(
          data?.error ||
            t(
              "تعذر إنشاء مجموعة عرض الصحاب.",
              "Could not create the friends group.",
            ),
        );
      }

      setFriendGroup(data.group);
    } catch (error) {
      setFriendError(
        error instanceof Error
          ? error.message
          : t("حدث خطأ أثناء إنشاء المجموعة.", "Could not create the group."),
      );
    } finally {
      setFriendBusy(false);
    }
  ...
  const loadOrJoinFriendGroup = async (token: string) => {
    setFriendBusy(true);
    setFriendError("");

    try {
      let response = await fetch(
        `/api/friend-offers?token=${encodeURIComponent(token)}`,
        { cache: "no-store" },
      );

      let data = (await response.json().catch(() => null)) as
        FriendOfferGroupView | { error?: string } | null;

      if (!response.ok || !data || !("token" in data)) {
        throw new Error(
          data && "error" in data && data.error
            ? data.error
            : t("رابط عرض الصحاب غير صالح.", "Invalid friends offer link."),
        );
      }

      let group = data as FriendOfferGroupView;

      if (summary?.authenticated && !group.currentParticipant) {
        response = await fetch("/api/friend-offers", {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
            action: "join",
        ...
        const joined = (await response.json().catch(() => null)) as {
          success?: boolean;
          error?: string;
          group?: FriendOfferGroupView;
        } | null;

        if (!response.ok || !joined?.group) {
          throw new Error(
            joined?.error ||
              t(
                "تعذر الانضمام إلى مجموعة عرض الصحاب.",
                "Could not join the friends group.",
              ),
          );
        }
      ...
      setFriendOffer(
        (current) =>
          current ?? {
            ...
            title:
              lang === "en"
                ? group.offer.titleEn || group.offer.title
                : group.offer.title,
            type: "special",
            discount: 0,
            specialPrice: group.offer.specialPrice,
            priceBefore: null,
            description: "",
            appliesTo: "",
            membershipId: null,
            ...
            expiresAt: group.offer.expiresAt,
            durationDays: group.offer.durationDays,
            sessionsCount: group.offer.sessionsCount,
            friendOfferEnabled: true,
            friendRequiredMembers: group.requiredMembers,
          },
      );
    } catch (error) {
      setFriendError(
        error instanceof Error
          ? error.message
          : t("تعذر تحميل عرض الصحاب.", "Could not load the friends offer."),
      );
    } finally {
      setFriendBusy(false);
    }
  ...
  const startFriendCheckout = async () => {
    ...
    try {
      ...
      returnUrl.searchParams.set("page", "offers");
      returnUrl.searchParams.set("friendOffer", friendGroup.token);
      returnUrl.searchParams.set("friendPayment", "success");

      const cancelUrl = new URL(
        window.location.origin + window.location.pathname,
      );
      cancelUrl.searchParams.set("page", "offers");
      cancelUrl.searchParams.set("friendOffer", friendGroup.token);
      cancelUrl.searchParams.set("friendPayment", "cancel");
      ...
      if (!response.ok || !data?.checkoutUrl) {
        throw new Error(
          data?.error ||
            t("تعذر تجهيز عملية الدفع.", "Could not prepare payment."),
        );
      }
      ...
      setFriendError(
        error instanceof Error
          ? error.message
          : t("حدث خطأ أثناء تجهيز الدفع.", "Could not prepare payment."),
      );
      setFriendBusy(false);
    }
  };
    ...
    loadPublicApi()
      .then((d) => {
        if (Array.isArray(d.offers) && d.offers.length > 0) {
          ...
          setOffers(
            (d.offers as PublicOffer[]).map((offer, i) => ({
              ...offer,
        ...
        if (Array.isArray(d.memberships)) {
          const pack = (d.memberships as PublicMembership[]).filter(
            (mb) => mb.kind === "package",
          );
          setPackages(pack);
          const custom = (d.memberships as PublicMembership[]).filter(
            (mb) => mb.kind === "custom",
          );
  ...
  useEffect(() => {
    ...
    const inviteToken = params.get("friendOffer")?.trim();

    if (inviteToken) {
      void loadOrJoinFriendGroup(inviteToken);
      return;
    }

    if (offers.length === 0) return;

    const raw = window.sessionStorage.getItem(FRIEND_PENDING_KEY);
    if (!raw) return;

    try {
      const pending = JSON.parse(raw) as {
        kind?: "open" | "create" | "join";
        offerId?: string;
        matchingEnabled?: boolean;
        token?: string;
      };

      window.sessionStorage.removeItem(FRIEND_PENDING_KEY);

      if (pending.kind === "open" && pending.offerId) {
        const offer = offers.find((item) => item.id === pending.offerId);

        if (offer?.friendOfferEnabled) {
          openFriendOffer(offer);
        }
      ...
      if (pending.kind === "join" && pending.token) {
        void loadOrJoinFriendGroup(pending.token);
        return;
      }

      if (pending.kind === "create" && pending.offerId) {
        const offer = offers.find((item) => item.id === pending.offerId);

        if (offer?.friendOfferEnabled) {
          setFriendOffer(offer);
          void createFriendGroup(offer, pending.matchingEnabled === true);
        }
      }
    } catch {
      window.sessionStorage.removeItem(FRIEND_PENDING_KEY);
    ...
    // Resume only when auth state or offer data becomes available.
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [summary?.authenticated, offers.length]);
    ...
    <div>
      {friendOffer ? (
        <div
          role="dialog"
          aria-modal="true"
          aria-label={t("عرض الصحاب", "Friends offer")}
          style={{
            position: "fixed",
            inset: 0,
            zIndex: 10000,
          ...
          >
            ...
            {!friendGroup ? (
              <>
                ...
                >
                  {t(
                    "اختاري طريقة الاشتراك. السعر الظاهر هو سعر المجموعة بالكامل، وكل واحدة تدفع حصتها فقط.",
                    "Choose how to join. The shown price is for the full group and each member pays only her share.",
                  )}
                </div>
                ...
                >
                  <button
                    type="button"
                    disabled={friendBusy}
                    onClick={() => void createFriendGroup(friendOffer, false)}
                    style={{
                      padding: 18,
                      borderRadius: 14,
                      border: `1px solid ${C.red}`,
                  ...
                  >
                    ...
                    <div style={{ marginTop: 7 }}>
                      {t("معايا صاحبتي", "I have my friend")}
                    </div>
                    <div
                      style={{
                        marginTop: 5,
                    ...
                    >
                      {t(
                        "اعملي المجموعة وابعتي لها رابط الدعوة",
                        "Create the group and send her the invite link",
                      )}
                    </div>
                  </button>
                  ...
                  <button
                    type="button"
                    disabled={friendBusy}
                    onClick={() => void createFriendGroup(friendOffer, true)}
                    style={{
                      padding: 18,
                      borderRadius: 14,
                  ...
                  >
                    🔎
                    <div style={{ marginTop: 7 }}>
                      {t("ابحثي لي عن شريكة", "Find me a partner")}
                    </div>
                    <div
                      style={{
                        marginTop: 5,
                    ...
                    >
                      {t(
                        "الجيم يساعدك في استكمال مجموعة العرض",
                        "The gym helps complete your group",
                      )}
                    </div>
                  </button>
                </div>
              ...
              <>
                ...
                >
                  <div>
                    ...
                    >
                      {friendGroup.joinedCount} / {friendGroup.requiredMembers}
                    </div>
                  </div>
                  ...
                  {friendGroup.currentParticipant ? (
                    <div>
                      ...
                      >
                        {formatCurrency(
                          friendGroup.currentParticipant.shareAmountMinor / 100,
                        )}
                      </div>
                    </div>
                  ) : null}
                ...
                {friendGroup.matchingEnabled ? (
                  ...
                  >
                    🔎{" "}
                    {t(
                      "تم تسجيل طلب العثور على شريكة. يمكنك دفع حصتك، ولن يتفعّل الاشتراك إلا بعد اكتمال المجموعة ودفع الجميع.",
                      "Your partner request is registered. You can pay your share; activation waits until the group is complete and everyone has paid.",
                    )}
                  </div>
                ) : (
                  <>
                    ...
                    >
                      {t("رابط دعوة صاحبتك", "Friend invite link")}
                    </div>

                    <input
                      readOnly
                      value={friendInviteUrl(friendGroup.token)}
                    ...
                    >
                        ...
                        onClick={async () => {
                          try {
                            await navigator.clipboard.writeText(
                              friendInviteUrl(friendGroup.token),
                            );
                      ...
                      <button
                        ...
                        onClick={() => {
                          const message = t(
                            `انضمي معايا في ${friendOffer.title} على FitZone 👭
${friendInviteUrl(friendGroup.token)}`,
                            `Join me in ${friendOffer.title} at FitZone 👭
${friendInviteUrl(friendGroup.token)}`,
                          );
                ...
                {!summary?.authenticated ? (
                  ...
                  >
                    {t("سجلي الدخول للانضمام", "Sign in to join")}
                  </button>
                ) : friendGroup.currentParticipant?.status === "paid" ||
                  friendGroup.currentParticipant?.status === "activated" ? (
                  <div
                    style={{
                      textAlign: "center",
                      padding: 12,
                  ...
                  >
                    ✓{" "}
                    {friendGroup.currentParticipant.status === "activated"
                      ? t("تم تفعيل اشتراكك", "Your membership is active")
                      : t(
                          "تم دفع حصتك — في انتظار اكتمال المجموعة",
                          "Your share is paid — waiting for the group",
                        )}
                  </div>
                ) : friendGroup.currentParticipant ? (
                  <button
                  ...
                  >
                    {friendBusy
                      ...
                      : t(
                          `ادفعي حصتك ${formatCurrency(
                            friendGroup.currentParticipant.shareAmountMinor /
                              100,
                          )}`,
                          `Pay your share ${formatCurrency(
                            friendGroup.currentParticipant.shareAmountMinor /
                              100,
                          )}`,
                        )}
      ...
      <section
        style={{
          background: `linear-gradient(135deg, #FFE0EC, #FFF5F8, ${C.bg})`,
          padding: "64px 0",
          textAlign: "center",
          position: "relative",
          overflow: "hidden",
      ...
      >
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(circle at 30% 50%, rgba(200,162,0,.08), transparent 60%), radial-gradient(circle at 70% 50%, rgba(233,30,99,.08), transparent 60%)",
          }}
        />
        <div className="container" style={{ position: "relative" }}>
          <div
            style={{
              fontSize: viewportWidth() < 768 ? 42 : 56,
              marginBottom: 16,
            }}
          >
            🔥
          ...
          >
            {t("العروض", "Offers")}{" "}
            <span style={{ color: C.red }}>
              {t("والباقات", "and packages")}
            </span>
          </h1>
          <p style={{ color: C.gray, fontSize: 17 }}>
            {t(
              "عروض الاشتراكات والباقات الخاصة في فيت زون بني سويف لتبدأي أو تجددي اشتراكك بسعر أفضل.",
              "Membership offers and special packages at Fit Zone Beni Suef to help you start or renew at a better price.",
            )}
          </p>
        </div>
      </section>
      ...
      <section id="offers" className="section" style={{ scrollMarginTop: 120 }}>
        <div className="container">
          <h2 className="section-title" style={{ marginBottom: 32 }}>
            {t("العروض", "Current")} <span>{t("الحالية", "offers")}</span>
          </h2>
          <div
            style={{
              display: "grid",
          ...
          >
            {offers.map((o) => {
              ...
              const maxSubscribers =
                typeof o.maxSubscribers === "number" ? o.maxSubscribers : null;
              const hasSeatLimit =
                o.showMaxSubscribers &&
                maxSubscribers != null &&
                maxSubscribers > 0;
              const remaining = hasSeatLimit
              ...
              const offerUnavailable =
                countdown.expired ||
                (!o.friendOfferEnabled &&
                  remaining != null &&
                  remaining <= 0);
              const offerTextColor =
                o.type === "special" ? C.redText : C.goldText;
              return (
                <div
                  key={o.id}
                  className="card card-hover"
                  style={{
                    padding: 0,
                    position: "relative",
                    border: coachState?.highlightedItems.offer?.includes(o.id)
                      ? `3px solid ${C.red}`
                      : `1px solid ${o.color}33`,
                    boxShadow: "0 18px 45px rgba(233,30,99,.12)",
                    overflow: "hidden",
                    display: "flex",
                    flexDirection: "column",
                ...
                >
                  ...
                  >
                      ...
                      {o.image ? (
                        ...
                        <div
                          style={{
                            ...
                            justifyContent: "center",
                            gap: 10,
                            background: `linear-gradient(135deg, ${o.color}22, ${o.color}0D)`,
                          }}
                        >
                          <div
                            style={{
                              fontSize: viewportWidth() < 768 ? 34 : 42,
                            }}
                          >
                            {o.type === "special" ? "⏳" : "🎁"}
                          </div>
                    ...
                    >
                      ...
                      <div style={{ flexShrink: 0, textAlign: "left" }}>
                        ...
                        >
                          {o.type === "special"
                            ? formatCurrency(o.specialPrice ?? 0)
                            : o.type === "percentage"
                              ? `${o.discount}%`
                              : `${o.discount} ${t("ج.م", "EGP")}`}
                        </div>
                        <div
                          style={{ color: C.gray, fontSize: 11, marginTop: 4 }}
                        >
                          {o.type === "special"
                            ? t("سعر العرض الخاص", "Special offer price")
                            : t("قيمة الخصم", "Discount value")}
                        </div>
                      </div>
                    </div>
                    {o.description ? (
                      <p
                        style={{ color: C.gray, fontSize: 13, lineHeight: 1.8 }}
                      >
                        {o.description}
                      </p>
                    ) : null}
                  ...
                  >
                      ...
                      >
                        {o.showCurrentSubscribers !== false && (
                          <div>
                            ...
                            >
                              {o.currentSubscribers.toLocaleString(
                                lang === "en" ? "en-US" : "ar-EG",
                              )}
                            </div>
                            <div style={{ fontSize: 10, color: C.gray }}>
                    ...
                    >
                      {o.appliesTo ? (
                        <span>
                          {t("ينطبق على:", "Applies to:")} {o.appliesTo}
                        </span>
                      ) : null}
                      <span>
                        {countdown.expired
                          ? t("انتهى العرض", "Offer expired")
                          : t("العرض ساري الآن", "Offer is active")}
                      </span>
                    </div>
                    <button
                      onClick={() => {
                        trackBusinessView("offer_viewed", o.id);

                        if (o.friendOfferEnabled) {
                          openFriendOffer(o);
                          return;
                        }
                    ...
                    >
                      {offerUnavailable
                        ? t("العرض غير متاح", "Offer unavailable")
                        : t("اشتركي الآن", "Subscribe now")}
                    </button>
                  </div>
                </div>
          ...
          {customPlans.length > 0 && (
            <>
              ...
              >
                {t("عروض", "Flexible")} <span>{t("التخصيص", "Plans")}</span>
              </h2>
              <p style={{ color: C.gray, fontSize: 14, marginBottom: 32 }}>
                {t(
                  "اختاري عدد الشهور اللي يناسبك وادفعي بسعر مخصوص",
                  "Choose the duration that suits you at a special rate",
                )}
              </p>
              <div
                style={{
                  ...
                  return (
                    <div
                      ...
                      style={{
                        padding: 0,
                        overflow: "hidden",
                        border: coachState?.highlightedItems.offer?.includes(
                          plan.id,
                        )
                          ? `3px solid ${C.red}`
                          : `1px solid ${planColor}33`,
                        boxShadow: "0 18px 45px rgba(233,30,99,.12)",
                        display: "flex",
                        flexDirection: "column",
                        height: "100%",
                        ...
                        {plan.image ? (
                          ...
                          <div
                            style={{
                              ...
                              justifyContent: "center",
                              gap: 10,
                              background: `linear-gradient(135deg, ${planColor}22, ${planColor}0D)`,
                            }}
                          >
                            <div style={{ fontSize: 42 }}>🎯</div>
                            <div
          ...
          >
            {t("الباقات", "Special")} <span>{t("الخاصة", "packages")}</span>
          </h2>
          {packages.length === 0 ? (
            <div
              className="card"
                ...
                return (
                  <div
                    ...
                    style={{
                      padding: 0,
                      overflow: "hidden",
                      border: coachState?.highlightedItems.membership?.includes(
                        pkg.id,
                      )
                        ? `3px solid ${C.red}`
                        : `1px solid ${packageColor}33`,
                      boxShadow: "0 18px 45px rgba(233,30,99,.12)",
                      display: "flex",
                      flexDirection: "column",
                      height: "100%",
                  ...
                  >
                      ...
                      {pkg.image ? (
                        ...
                        <div
                          style={{
                            ...
                            justifyContent: "center",
                            gap: 10,
                            background: `linear-gradient(135deg, ${packageColor}22, ${packageColor}0D)`,
                          }}
                        >
                    ...
                    >
                      ...
                      >
                        <span>
                          📅 {pkg.durationDays} {t("يوم", "days")}
                        </span>
                        {pkg.sessionsCount ? (
                          <span>
                            🎯 {pkg.sessionsCount} {t("حصة", "sessions")}
                          </span>
                        ) : null}
                      </div>
                      <ul
                        style={{ listStyle: "none", marginBottom: 20, flex: 1 }}
                      >
                      ...
                      <button
                        ...
                        onClick={() => {
                          trackBusinessView("package_viewed", pkg.id);
...
const intMapEn: Record<string, string> = {
  low: "Low",
  medium: "Medium",
  high: "High",
  extreme: "Very High",
...
function getIntensityColor(val: string) {
  return (
    intensityColorMap[val] ?? intensityColorMap[val?.toLowerCase()] ?? "#9ca3af"
  );
}
...
const gymImageKnownTypes = new Set([
  "yoga",
  "zumba",
  "strength",
  "pilates",
...
const ClassesPage = ({ navigate }: { navigate: (p: string) => void }) => {
  ...
  const types = [
    ...
    ...Array.from(
      new Set(
        classes.map((c) => getClassTypeLabel(c.type, lang)).filter(Boolean),
      ),
    ),
  ];
  const filtered = classes.filter(
    (c) =>
      (filterType === allLabel ||
        getClassTypeLabel(c.type, lang) === filterType) &&
      (search === "" ||
    ...
    <div>
      ...
      >
        <div className="container">
          ...
          <p style={{ color: C.gray, fontSize: 15, marginBottom: 24 }}>
            {t(
              "اكتشفي كلاساتنا المتنوعة واحجزي مكانك الآن",
              "Explore our diverse classes and book your spot now",
            )}
          </p>
          <div style={{ position: "relative", maxWidth: 480 }}>
            <input
              className="input"
              placeholder={t(
                "ابحثي عن كلاس أو مدربة...",
                "Search for a class or trainer...",
              )}
              value={search}
              onChange={(e) => setSearch(e.target.value)}
              style={{
                paddingRight: lang === "ar" ? 44 : undefined,
                paddingLeft: lang === "en" ? 44 : undefined,
              }}
            />
            <span
              style={{
        ...
        <div className="container">
          ...
          >
            {types.map((tp) => (
              <button
                key={tp}
                className={`tab ${filterType === tp ? "active" : ""}`}
          ...
          >
            {filtered.map((c, index) => {
              ...
              return (
                <div
                  key={c.id}
                  data-tour={index === 0 ? "first-class-card" : undefined}
                  className="card card-hover"
                  style={{ cursor: "pointer", scrollMarginTop: 120 }}
                  onClick={() => {
                    if (typeof window !== "undefined") {
                      window.sessionStorage.setItem(
                        CLASS_STORAGE_KEY,
                ...
                >
                  <div style={{ height: 180 }}>
                    <GymImg
                      type={resolveClassImageType(c.type)}
                      w="100%"
                      h={180}
                    />
                  </div>
                  <div style={{ padding: 20 }}>
                    ...
                    >
                      ...
                      {c.intensity && (
                        ...
                        >
                          {getIntensityLabel(c.intensity, lang)}
                        </span>
                      )}
                      <span
                        style={{
...
const ClassDetailPage = ({ navigate }: { navigate: (p: string) => void }) => {
  ...
  const [bookingScheduleId, setBookingScheduleId] = useState<string | null>(
    null,
  );
    ...
    try {
      ...
      setBookingMsg({
        text:
          data.message ??
          t(
            "تم الحجز بنجاح. جاري تحويلك إلى حسابك.",
            "Booked successfully. Redirecting to your account.",
          ),
        ok: true,
      });
      ...
      setBookingMsg({
        text: t(
          "حدث خطأ غير متوقع أثناء تنفيذ الحجز.",
  ...
  return (
    <div>
      <div style={{ height: 340, position: "relative" }}>
        <GymImg
          type={resolveClassImageType(gymClass?.type ?? "yoga")}
          w="100%"
          h={340}
        />
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(to bottom, rgba(10,10,10,.3) 0%, rgba(10,10,10,.85) 100%)",
          }}
        />
        <div style={{ position: "absolute", bottom: 32, left: 0, right: 0 }}>
          <div className="container">
            ...
            >
              {getClassTypeLabel(gymClass?.type ?? "yoga", lang)}
            </span>
            <h1 style={{ color: C.white, fontSize: 38, fontWeight: 900 }}>
              {gymClass?.name ?? " "}
            </h1>
            <div
              style={{
            ...
            >
              {gymClass?.duration && (
                ...
                >
                  <I n="clock" s={13} c={C.gray} /> {gymClass.duration}
                </span>
              )}
              {gymClass?.intensity && (
                <span
                ...
                >
                  <I n="fire" s={13} c={iColor} />{" "}
                  {getIntensityLabel(gymClass.intensity, lang)}
                </span>
              )}
              {gymClass?.maxSpots != null && (
                <span
                  style={{
                    color: C.gray,
                    fontSize: 13,
                ...
                >
                  <I n="users" s={13} c={C.gray} />{" "}
                  {sessions[0]?.availableSpots ?? gymClass.maxSpots}{" "}
                  {t("مقعد متاح", "seats available")}
                </span>
              )}
            </div>
          </div>
      ...
      <div className="container" style={{ padding: "48px 24px" }}>
        <div
          style={{
            display: "grid",
            gridTemplateColumns: responsiveColumns("1fr", "1fr", "1fr 360px"),
            gap: 40,
          }}
        >
          <div>
            <div className="card" style={{ padding: 28, marginBottom: 20 }}>
              ...
              >
                {t("عن الكلاس", "About the Class")}
              </h2>
              <p style={{ color: C.gray, lineHeight: 1.8, fontSize: 14 }}>
                {gymClass?.description ||
                  t(
                    "لا يوجد وصف لهذا الكلاس.",
            ...
            {gymClass?.trainer && (
              <div className="card" style={{ padding: 28 }}>
                ...
                <div style={{ display: "flex", gap: 16, alignItems: "center" }}>
                  ...
                  >
                    <GymImg type="trainer1" w={80} h={80} />
                  </div>
                  <div>
                    <h3
                      style={{ fontWeight: 800, fontSize: 17, color: C.white }}
                    >
                      {gymClass.trainer}
                    </h3>
                    {gymClass.trainerSpecialty && (
                      <p
                        style={{ color: C.red, fontSize: 13, fontWeight: 600 }}
                      >
                        {gymClass.trainerSpecialty}
                      </p>
                    )}
          ...
          <div
            ...
            style={{
              padding: 24,
              position: viewportWidth() < 1024 ? "static" : "sticky",
              top: 86,
            }}
          >
            <h3
            ...
            >
              {t("اختاري الموعد", "Choose a session")}
            </h3>
            {bookingMsg && (
              <div
                style={{
                  ...
                  padding: "12px 14px",
                  borderRadius: 8,
                  background: bookingMsg.ok ? "#dcfce7" : "#fee2e2",
                  color: bookingMsg.ok ? "#166534" : "#991b1b",
                  fontWeight: 700,
                  fontSize: 13,
                }}
              >
              ...
              >
                ...
                >
                    ...
                    style={{
                      background:
                        s.availableSpots === 0
                          ? "rgba(239,68,68,.12)"
                          : "rgba(34,197,94,.12)",
                      color: s.availableSpots === 0 ? "#EF4444" : C.success,
                      padding: "3px 8px",
                      borderRadius: 4,
                      fontSize: 11,
                      fontWeight: 600,
                  ...
                  >
                    {s.availableSpots === 0
                      ? t("ممتلئ", "Full")
                      : `${s.availableSpots} ${t("متبقية", "left")}`}
                  </span>
                </div>
                <div
                  style={{
                ...
                >
                  <span style={{ fontWeight: 900, color: C.red }}>
                    {formatCurrency(gymClass?.price ?? 0)}
                  </span>
                  <button
                    className="btn-primary"
                    style={{
                      padding: "5px 14px",
                      fontSize: 12,
                      opacity: s.availableSpots === 0 ? 0.4 : 1,
                    }}
                    disabled={
                      s.availableSpots === 0 ||
                      bookingId === s.id ||
            ...
            >
              ...
              >
                ...
                <span style={{ fontWeight: 700, fontSize: 13, color: C.red }}>
                  {t("ميزة الاشتراك والحجز", "Subscription & Booking Perk")}
                </span>
              </div>
              <p style={{ fontSize: 11, color: C.gray }}>
                {t(
                  "احجزي حصتك الآن، وسيظهر الحجز مباشرة داخل صفحة حسابك.",
                  "Book your spot now and it will appear instantly in your account page.",
                )}
              </p>
            </div>
          </div>
...
const SchedulePage = () => {
  ...
  const dayName = (index: number) =>
    (lang === "en" ? DAY_NAMES_EN : DAY_NAMES_AR)[index] ?? "";
  ...
  const buildSlots = (list: typeof entries, fallback: string[]) => {
    ...
    return Array.from(new Set([...times, ...fallback])).sort(
      (a, b) => parseTime(a) - parseTime(b),
    );
  };

  const morningSlots = useMemo(
    () => buildSlots(splitEntries.morning, MORNING_FALLBACK),
    [splitEntries.morning],
  );
  const eveningSlots = useMemo(
    () => buildSlots(splitEntries.evening, EVENING_FALLBACK),
  ...
  const renderBoard = (
    ...
    const dayHeadSt: React.CSSProperties = isAr
      ? {
          ...
          fontWeight: 800,
          fontSize: 11,
          boxShadow: "-1.5px 0 0 rgba(255,255,255,.16)",
          textAlign: "center",
          padding: "10px 4px",
          width: 88,
          minWidth: 88,
    ...
    const daySt: React.CSSProperties = isAr
      ? {
          ...
          right: 0,
          zIndex: 3,
          background: "linear-gradient(90deg,#1d1619,#161114)",
          color: "#fff",
          fontWeight: 900,
          fontSize: 12,
          boxShadow: "-1.5px 0 0 rgba(255,255,255,.16)",
      ...
      : {
          ...
          left: 0,
          zIndex: 3,
          background: "linear-gradient(90deg,#161114,#1d1619)",
          color: "#fff",
          fontWeight: 900,
          fontSize: 12,
          boxShadow: "1.5px 0 0 rgba(255,255,255,.16)",
    ...
    return (
      <div className="schedule-shell" style={{ marginBottom: 36 }}>
        ...
        <div
          className="schedule-scroll"
          style={{ direction: isAr ? "rtl" : "ltr", overflowX: "auto" }}
        >
          <table className="schedule-table">
            <thead>
              <tr>
                <th className="schedule-cell" style={dayHeadSt}>
                  {t("اليوم", "Day")}
                </th>
                {slots.map((slot) => (
                  <th key={`head-${slot}`} className="schedule-cell time">
            ...
            <tbody>
              {activeDayIndices.map((dayIdx) => (
                <tr key={`row-${dayIdx}`}>
                  <td className="schedule-cell" style={daySt}>
                    {dayName(dayIdx)}
                  </td>
                  {slots.map((slot) => {
                    const cellEntries = list.filter(
                      (e) => e.dayIndex === dayIdx && e.time === slot,
                    );
                    return (
      ...
      >
        <div className="container">
          ...
          <p style={{ color: C.gray, fontSize: 15 }}>
            {t(
              "كل المواعيد تُسجَّل من لوحة الإدارة ويمكن تعديلها في أي وقت.",
              "All times are managed from the admin panel and can be updated anytime.",
            )}
          </p>
        </div>
      </section>
      <section className="section">
        <div className="container" style={{ overflowX: "hidden" }}>
          ...
          {renderBoard(
            ...
            t(
              "اختاري أفضل توقيت بعد اليوم الطويل",
              "Pick the best time after a long day",
            ),
            splitEntries.evening,
            eveningSlots,
          )}
...
const categoryEnByArabic: Record<string, string> = Object.entries(
  catMap,
).reduce(
  (acc, [key, value]) => {
...
function localizeStoreCategory(
  label: string,
...
function localizeDiscountBadge(
...
const ProductMiniCard = ({
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          padding: compact ? "10px 10px 12px" : "14px 16px 16px",
          display: "flex",
          flexDirection: "column",
          flex: 1,
        }}
      >
            ...
            {[1, 2, 3, 4, 5].map((s) => (
              <span
                ...
                style={{
                  fontSize: 12,
                  color:
                    s <= Math.round(product.rating) ? "#f59e0b" : "#e5e7eb",
                }}
              >
                ★
              </span>
        ...
        {!compact &&
          ...
          product.sizes.length > 0 && (
            <div style={{ color: C.gray, fontSize: 11, marginBottom: 6 }}>
              {t("المقاسات", "Sizes")}: {product.sizes.slice(0, 4).join(" - ")}
            </div>
          )}
        <div
          style={{
        ...
        >
          ...
          >
            ...
            >
              {formatCurrency(
                product.vatEnabled ? applyVat(product.price) : product.price,
              )}{" "}
              <span style={{ fontSize: compact ? 10 : 12, fontWeight: 600 }}>
                {lang === "en" ? "EGP" : "ج.م"}
              </span>
            </span>
            {product.oldPrice && (
          ...
          {product.vatEnabled && (
            ...
            >
              {lang === "en" ? "Incl. 14% VAT" : "شامل ضريبة 14%"}
            </span>
          )}
        </div>
        <button
          ...
          onClick={(e) => {
            e.stopPropagation();
            if (outOfStock) return;
            const price = product.vatEnabled
              ? applyVat(product.price)
              : product.price;
            ...
            if (giftCampaignMin && giftCampaignMin > 0) {
              const newTotal = readCart().reduce(
                (s, i) => s + i.price * i.qty,
                0,
              );
              if (newTotal >= giftCampaignMin) {
                dispatchGiftToast({
                  type: "unlocked",
                  rewardLabel: giftRewardLabel ?? "هدية",
                });
              } else {
                dispatchGiftToast({
                  type: "progress",
                  remaining: Math.max(0, giftCampaignMin - newTotal),
                });
              }
            }
            navigate("cart");
...
const getProductRecommendationScore = (
  product: StoreProduct,
  searchTerm: string,
) => {
...
function giftCampaignRewardLabel(
  c:
    | {
        rewardType: string;
...
const ShopPage = ({
  ...
  useEffect(() => {
    ...
    if (filters.categoryId) {
      const category = categories.find(
        (item) =>
          item.key === filters.categoryId || item.label === filters.categoryId,
      );
    ...
    allLabel,
    categories,
    coachState?.actionSource,
    coachState?.productFilters,
  ]);
  ...
  useEffect(() => {
    fetch("/api/store/free-gifts/check", { cache: "no-store" })
      ...
      .then((d: { enabled?: boolean } | null) => {
        if (d?.enabled) setShopGameEnabled(true);
      })
      .catch(() => {});
  }, []);
  ...
  const coachSorted =
    coachState?.productFilters.sort === "price_asc"
  ...
  const recommended = search.trim()
    ? [...products]
        .map((product) => ({
          product,
          score: getProductRecommendationScore(product, search),
        }))
  ...
  const bestSellers = [...products]
    .filter(
      (p) =>
        p.rating >= 4.5 ||
        (p.badge ?? "").includes("الأكثر") ||
        (p.badge ?? "").includes("مبيعًا"),
    )
    ...
    <div>
      ...
      >
        <div className="container">
          ...
          >
            {t("المتجر الرياضي", "Sports shop")}
          </h1>
          <p style={{ color: C.gray, fontSize: 15 }}>
            {t(
              "ملابس وإكسسوارات ومنتجات رياضية مختارة لدعم التمرين والتعافي وأهداف اللياقة.",
              "Selected apparel, accessories, and fitness products to support training, recovery, and your fitness goals.",
            )}
          </p>
        </div>
      </section>
      <section className="section">
        <div className="container">
          ...
          >
              ...
              >
                {categoryButtons.map((label) => {
                  ...
                  const displayLabel =
                    label === allLabel
                      ? allLabel
                      : localizeStoreCategory(label, categoryRecord?.key, lang);
            ...
            <div style={{ position: "relative", width: "100%" }}>
              <input
                className="input"
                placeholder={t(
                  "ابحثي عن منتج أو مقاس أو وصف...",
                  "Search for a product, size, or description...",
                )}
                value={search}
                onChange={(e) => setSearch(e.target.value)}
              ...
              {giftCampaign?.active && (
                <div
                  style={{
                    ...
                    gap: 12,
                    background:
                      "linear-gradient(135deg,rgba(233,30,99,.08),rgba(194,24,91,.04))",
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    >
                      {giftCampaign.titleAr ||
                        t("حملة الهدايا نشطة", "Gift Campaign Active")}
                    </p>
                    <p
                      style={{
                        margin: "2px 0 0",
                    ...
                    >
                      {t(
                        `تسوقي بـ ${giftCampaign.minSubtotal.toLocaleString("ar-EG")} ج.م واحصلي على هدية`,
                        `Shop for ${giftCampaign.minSubtotal.toLocaleString()} EGP and get a gift`,
                      )}
                    </p>
                  </div>
                </div>
              ...
              {shopGameEnabled && (
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    >
                      {t(
                        "العبي اللعبة واختاري منتجات مجانية",
                        "Play the game and pick free products",
                      )}
                    </p>
                  </div>
          ...
          {bestSellers.length > 0 && !search.trim() && (
            <div style={{ marginBottom: 48 }}>
              ...
              <div
                style={{
                  display: "grid",
                  gridTemplateColumns: shopGridCols,
                  gap: shopGap,
                }}
              >
                {bestSellers.map((p) => (
                  <ProductMiniCard
                    ...
                    lang={lang}
                    t={t}
                    giftCampaignActive={giftCampaign?.active}
                    giftCampaignMin={giftCampaign?.minSubtotal}
                    giftRewardLabel={giftCampaignRewardLabel(giftCampaign)}
                    compact={isMobile}
                  />
                ))}
              </div>
          ...
          {/* ── All Products ── */}
          {(() => {
            const shownFiltered = showAllShopProducts
              ? coachSorted
              : coachSorted.slice(0, SHOP_INITIAL);
            const hasMoreShop =
              coachSorted.length > SHOP_INITIAL && !showAllShopProducts;
            return (
              <>
                <div
                  id="shop-products"
                ...
                >
                  {shownFiltered.map((p, index) => (
                    <ProductMiniCard
                      ...
                      compact={isMobile}
                      tourTarget={
                        index === 0 ? "first-shop-product" : undefined
                      }
                    />
                  ))}
                </div>
                {hasMoreShop && (
                  <div style={{ textAlign: "center", marginTop: 28 }}>
                    ...
                    >
                      {t(
                        `عرض المزيد (${coachSorted.length - SHOP_INITIAL}+)`,
                        `Show more (${coachSorted.length - SHOP_INITIAL}+)`,
                      )}
                    </button>
                  </div>
                )}
...
const getDefaultStoreVariant = (product: StoreProduct | null) => {
...
const ProductDetailPage = ({
  ...
  const selectedVariant =
    product?.variants?.find((variant) => {
      const sizeMatches =
        (variant.size ?? null) ===
        (product?.sizeType === "none" ? null : selectedSize);

      const colorMatches = (variant.color ?? null) === (selectedColor ?? null);

      return sizeMatches && colorMatches;
    }) ?? null;

  const variantSelectionMissing = hasVariants && !selectedVariant;
  ...
  const outOfStock = hasVariants
    ? variantSelectionMissing || variantOutOfStock
  ...
  useEffect(() => {
    ...
    try {
      ...
      const defaultVariant = getDefaultStoreVariant(parsed);

      setSelectedSize(
        parsed.sizeType === "none"
          ? null
          : (parsed.variants?.length ?? 0) > 0
        ...
        if (Array.isArray(d.products) && d.products.length > 0) {
          const mapped = d.products.map(
            (
              ...
              index: number,
            ) => mapApiProductToStoreProduct(item, index),
          );
          setCatalog(mapped);
          const refreshed = product?.id
            ? mapped.find((item) => item.id && item.id === product.id)
            : undefined;
          if (refreshed) {
            setProduct(refreshed);

            const defaultVariant = getDefaultStoreVariant(refreshed);

            setSelectedSize(
              refreshed.sizeType === "none"
                ? null
                : (refreshed.variants?.length ?? 0) > 0
                  ? (defaultVariant?.size ?? null)
                  : (refreshed.sizes?.[0] ?? null),
            );

            setSelectedColor(
              (refreshed.variants?.length ?? 0) > 0
                ? (defaultVariant?.color ?? null)
                : (refreshed.colors?.[0] ?? null),
            );
          }
        }
      })
  ...
  const fallbackSizes =
    product?.sizeType === "shoes"
      ...
      : product?.sizeType === "clothing"
        ...
        : [];
  const sizes =
    product?.sizes && product.sizes.length > 0 ? product.sizes : fallbackSizes;
  ...
  const submitReview = async () => {
    if (!product?.id) {
      setReviewMessage({
        text: t(
          "هذا المنتج غير مربوط بقاعدة البيانات بعد.",
          "This product is not linked to the database yet.",
        ),
        ok: false,
      });
      return;
    ...
    try {
      ...
      setReviewContent("");
      const reload = await fetch(`/api/products/${product.id}/reviews`, {
        cache: "no-store",
      });
      ...
      if (reload.ok) {
        ...
        setAverageRating(
          typeof reloadData.averageRating === "number"
            ? reloadData.averageRating
            : 0,
        );
        setReviewCount(
          typeof reloadData.count === "number" ? reloadData.count : 0,
        );
      }
    } catch {
      setReviewMessage({
  ...
  if (!product)
    return (
      <div
        className="container"
        style={{ padding: "48px 24px", textAlign: "center", color: C.gray }}
      >
  ...
  return (
    <div>
      <div
        className="container"
        style={{ padding: viewportWidth() < 768 ? "24px 16px" : "48px 24px" }}
      >
        <div
          style={{
            display: "grid",
            gridTemplateColumns: responsiveColumns("1fr", "1fr", "1fr 1fr"),
            gap: viewportWidth() < 768 ? 24 : 48,
            alignItems: "start",
          }}
        >
          <div>
          ...
          <div>
            ...
            <h1
              style={{
                fontSize: viewportWidth() < 768 ? 22 : 30,
                fontWeight: 900,
                color: C.white,
                marginBottom: 12,
              }}
            ...
            >
              ...
              {product.badge && (
                <span className="badge">
                  {localizeDiscountBadge(product.badge, lang)}
                </span>
              )}
              {product.vatEnabled && (
                <span
              ...
              {outOfStock && (
                <span
                  className="badge"
                  style={{ background: "#2b0f1b", color: "#ffd166" }}
                >
                  {t("نفذت الكمية", "Out of stock")}
                </span>
              )}
            ...
            >
              <div style={{ color: C.gold, fontWeight: 800 }}>
                {"★".repeat(
                  Math.max(1, Math.round(averageRating || product.rating || 0)),
                )}
              </div>
              <div style={{ color: C.gray, fontSize: 13 }}>
                {averageRating > 0
            ...
            {product.description && (
              <p style={{ color: C.gray, lineHeight: 1.9, marginBottom: 24 }}>
                {product.description}
              </p>
            )}
            ...
            {product.sizeType !== "none" && sizes.length > 0 && (
              <div style={{ marginBottom: 24 }}>
                <div
                  style={{ color: C.white, fontWeight: 700, marginBottom: 10 }}
                >
                  {t("المقاس", "Size")}
                </div>
                  ...
                  {sizes.map((size) => (
                    <button
                      ...
                      style={{
                        ...
                        padding: "10px 14px",
                        borderRadius: 8,
                        border: `1px solid ${selectedSize === size ? C.red : C.border}`,
                        background: selectedSize === size ? C.red : C.bgCard,
                        color: selectedSize === size ? "#fff" : C.white,
                        cursor: "pointer",
                        fontFamily: "'Cairo', sans-serif",
                        fontWeight: 700,
                      }}
                    ...
                    if (color === "multicolor") {
                      return (
                        <button
                          ...
                          title={t("ألوان متعددة", "Multicolor")}
                          style={{
                            width: 30,
                            height: 30,
                            borderRadius: "50%",
                            border: `2px solid ${selectedColor === color ? C.red : C.border}`,
                            background:
            ...
            {product.unitLabel && (
              ...
              >
                <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
                  <span
                    style={{ color: C.gray, fontSize: 13, fontWeight: 600 }}
                  >
                    {t("الخامة:", "Material:")}
                  </span>
                  <span
              ...
              <button
                ...
                onClick={() => {
                  ...
                  addToCart({
                    ...
                    name: product.name,
                    price: product.vatEnabled ? applyVat(basePrice) : basePrice,
                    vatEnabled: product.vatEnabled ?? false,
                    qty,
                    size: product.sizeType === "none" ? null : selectedSize,
                    color:
            ...
            <div className="card" style={{ padding: 18 }}>
              <div style={{ color: C.gray, fontSize: 13, marginBottom: 8 }}>
                {t("الرصيد الحالي بالمحفظة", "Current wallet balance")}
              </div>
              <div style={{ color: C.gold, fontWeight: 900, fontSize: 24 }}>
            ...
            >
              ...
              >
                <svg
                  ...
                  fill="currentColor"
                >
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.746l7.73-8.835L1.254 2.25H8.08l4.265 5.639L18.244 2.25zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
                X
              </a>
            </div>
        ...
        {product.editorialReview && (
          ...
          >
            ...
            >
              ✍️ {t("المراجعة التحريرية", "Editorial Review")}
            </div>
            <p style={{ color: C.white, lineHeight: 1.9, fontSize: 15 }}>
              {product.editorialReview}
            </p>
          </div>
        )}
        ...
        {product.whoShouldBuy && product.whoShouldBuy.length > 0 && (
          <div style={{ marginTop: 40 }}>
            <h2
              style={{
                fontSize: viewportWidth() < 768 ? 18 : 22,
                fontWeight: 900,
                color: C.white,
                marginBottom: 20,
              }}
            >
              {t("من يجب أن يشتري؟", "Who Should Buy?")}
            </h2>
            <div
              style={{
                display: "grid",
            ...
            >
              {product.whoShouldBuy.map((item, i) => (
                <div
                  ...
                  style={{
                    padding: 20,
                    borderRight: `4px solid ${item.suitable ? C.success : "#ef4444"}`,
                  }}
                >
                  <div
                    style={{
                  ...
                  >
                    ...
                    <span
                      style={{ fontWeight: 800, color: C.white, fontSize: 15 }}
                    >
        ...
        {product.importantInfo && (
          ...
          >
            ...
            >
              ⚠️ {t("معلومات مهمة", "Important Information")}
            </div>
            <p
              style={{
                color: C.white,
        ...
        {product.faqs && product.faqs.length > 0 && (
          <div style={{ marginTop: 40 }}>
            ...
            >
              {t("أسئلة وأجوبة العملاء", "Customer Q&A")}
            </h2>
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {product.faqs.map((faq, i) => (
                <div key={i} className="card" style={{ padding: 20 }}>
                  ...
                  >
                    <span style={{ color: C.red }}>{t("س:", "Q:")}</span>{" "}
                    {lang === "en" && faq.qEn ? faq.qEn : faq.q}
                  </div>
                  <div
                    style={{
                      color: C.gray,
        ...
        <div
          style={{
            display: "grid",
            gridTemplateColumns: responsiveColumns("1fr", "1fr", "1.1fr 1fr"),
            gap: 32,
            marginTop: 56,
          }}
        >
          <div className="card" style={{ padding: 24 }}>
            ...
            >
              {t("أضيفي تقييمك", "Add your review")}
            </h2>
            <p
              style={{
                color: C.gray,
            ...
            >
              {t(
                "اكتبي رأيك في المنتج، وسيظهر التقييم باسم حسابك بعد الحفظ.",
                "Write your opinion about the product and your review will appear under your account name after saving.",
              )}
            </p>
                ...
                {[1, 2, 3, 4, 5].map((star) => (
                  <button
                    ...
                    style={{
                      ...
                      cursor: "pointer",
                      fontSize: 28,
                      color: star <= reviewRating ? C.gold : C.border,
                    }}
                  >
                    ★
                  </button>
            ...
            <div style={{ marginBottom: 14 }}>
              ...
              <textarea
                ...
                rows={6}
                placeholder={t(
                  "اكتبي رأيك في المنتج، الجودة، المقاس أو التجربة العامة.",
                  "Write your opinion about the product, quality, size, or overall experience.",
                )}
                className="input"
            ...
            {reviewMessage && (
              <div
                style={{
                  ...
                  padding: "12px 14px",
                  borderRadius: 12,
                  background: reviewMessage.ok
                    ? "rgba(34,197,94,.12)"
                    : "rgba(239,68,68,.12)",
                  color: reviewMessage.ok ? C.success : "#fca5a5",
                  fontSize: 13,
                  fontWeight: 700,
                }}
              >
            ...
            <button
              className="btn-primary"
              style={{ justifyContent: "center", minWidth: 170 }}
          ...
          <div className="card" style={{ padding: 24 }}>
            ...
            >
              <h2 style={{ fontWeight: 900, fontSize: 24, color: C.white }}>
            ...
            {reviewsLoading ? (
              <div style={{ color: C.gray }}>
                {t("جارٍ تحميل التقييمات...", "Loading reviews...")}
              </div>
            ) : reviews.length === 0 ? (
              <div style={{ color: C.gray, lineHeight: 1.8 }}>
                {t(
                  "لا توجد تقييمات لهذا المنتج بعد. كوني أول من يضيف مراجعة.",
                  "There are no reviews for this product yet. Be the first to add one.",
                )}
              </div>
            ) : (
              <div
                ...
                {reviews.map((review) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        <div style={{ fontWeight: 800, color: C.white }}>
                          {review.user.name}
                        </div>
                        <div style={{ color: C.grayDark, fontSize: 12 }}>
                      ...
                      <div
                        style={{ color: C.gray, lineHeight: 1.9, fontSize: 14 }}
                      >
                        {review.content}
                      </div>
                    </div>
            ...
            {(() => {
              ...
              return (
                <>
                  <h2
                    style={{
                      fontSize: relMobile ? 18 : 22,
                      fontWeight: 900,
                      color: C.white,
                      marginBottom: 20,
                    }}
                  >
                    🛍️ {t("منتجات مشابهة", "Similar products")}
                  </h2>
                  <div
                    style={{
                      display: "grid",
                      gridTemplateColumns: relMobile
                        ? "1fr 1fr"
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <span
                              style={{
                                fontWeight: 900,
                                color: C.red,
                                fontSize: relMobile ? 14 : 17,
                              }}
                            >
                              {formatCurrency(item.price)}{" "}
                              <span style={{ fontSize: relMobile ? 10 : 11 }}>
                                ج.م
                              </span>
                            </span>
                            {item.oldPrice && (
                          ...
                          <button
                            style={{
                              width: "100%",
                              padding: relMobile ? "7px 5px" : "8px",
                              borderRadius: 9,
                              border: "none",
                              background: `linear-gradient(135deg,${C.red},#c2185b)`,
                              color: "#fff",
                              fontWeight: 800,
                              fontSize: relMobile ? 11 : 12,
                              cursor: "pointer",
                              ...
                              gap: 5,
                              fontFamily: "inherit",
                              boxShadow: "0 3px 10px rgba(233,30,99,.25)",
                            }}
                            onClick={(e) => {
                              e.stopPropagation();
                          ...
                          >
                            <I n="cart" s={relMobile ? 11 : 12} c="#fff" />{" "}
                            {t("أضيفي للسلة", "Add to cart")}
                          </button>
                        </div>
                      </div>
...
const CartPage = ({
  ...
  useEffect(() => {
    fetch("/api/store/gift-campaign", { cache: "no-store" })
      ...
      .then((d) => {
        if (d && d.active)
          setGiftCampaign({ ...d.settings, ...d, active: true });
      })
      .catch(() => {});
    fetch("/api/store/free-gifts/check", { cache: "no-store" })
      .then((r) => (r.ok ? r.json() : null))
      .then((d: { enabled?: boolean } | null) => {
        if (d?.enabled) setFreeGiftGameEnabled(true);
      })
      .catch(() => {});
  }, []);
    ...
    loadPublicApi(true)
      .then((d) => {
        if (Array.isArray(d.deliveryOptions)) {
          const options = (d.deliveryOptions as PublicDeliveryOption[])
            .slice()
            .sort((a, b) => a.sortOrder - b.sortOrder);
        ...
        if (Array.isArray(d.products) && d.products.length > 0) {
          const apiProducts = d.products as Array<{
            id?: string;
            price: number;
            vatEnabled?: boolean;
            images?: string[];
          ...
          const updated = current.map((cartItem) => {
            ...
            const correctPrice = apiProduct.vatEnabled
              ? applyVat(apiProduct.price)
              : apiProduct.price;
            if (
              cartItem.vatEnabled !== (apiProduct.vatEnabled ?? false) ||
              Math.abs(cartItem.price - correctPrice) > 0.01
            ) {
              changed = true;
              return {
                ...cartItem,
                price: correctPrice,
                vatEnabled: apiProduct.vatEnabled ?? false,
              };
            }
            return cartItem;
          });
    ...
    if (summary?.authenticated) {
      fetch("/api/me/checkout-options", { cache: "no-store" })
        ...
        .then((d: { pointValueEGP?: number }) => {
          if (typeof d.pointValueEGP === "number")
            setPointValueEGP(d.pointValueEGP);
        })
        .catch(() => {});
    }
  }, [summary?.authenticated]);
  ...
  const rewardsValue =
    Math.round((summary?.rewardPoints ?? 0) * pointValueEGP * 100) / 100;
  const walletBalance = summary?.walletBalance ?? 0;
  const selectedDelivery =
    deliveryOptions.find((option) => option.id === selectedDeliveryId) ?? null;
  const shippingFee =
    selectedDelivery?.type === "pickup" ? 0 : (selectedDelivery?.fee ?? 0);
  ...
  const walletDiscount = useWallet
    ? Math.min(walletBalance, Math.max(0, baseTotal - rewardsDiscount))
    : 0;
  const discount = rewardsDiscount + walletDiscount;
  const total = Math.max(0, baseTotal - discount);
  const pointsToDeduct = useRewards
    ? Math.ceil(rewardsDiscount / pointValueEGP)
    : 0;
  ...
  const availablePayMethods = useMemo(() => {
    ...
    if (
      selectedDelivery?.showCashOnDelivery &&
      paymentSettings.cashOnDeliveryEnabled
    ) {
      methods.push({
        id: "cod",
        label:
          paymentSettings.cashOnDeliveryLabel ||
  ...
  const fillCurrentLocation = () => {
    if (!navigator.geolocation) {
      setOrderMsg({
        text: "المتصفح لا يدعم تحديد الموقع تلقائيًا.",
        ok: false,
      });
      return;
    }
    ...
    navigator.geolocation.getCurrentPosition(
      async ({ coords }) => {
        ...
        setOrderMsg({
          text: resolved?.displayName
            ? t(
                "تم تحديد عنوانك تلقائيًا من نفس موقعك الحالي.",
                "Your address was detected automatically from your current location.",
              )
            : t(
                "تم تحديد موقعك الحالي، لكن تعذر تحويله إلى عنوان دقيق فتم استخدام الإحداثيات.",
                "Your current location was detected, but it could not be converted to an exact address, so coordinates were used instead.",
              ),
          ok: true,
        });
        setLocating(false);
      ...
      () => {
        setOrderMsg({
          text: t(
            "تعذر تحديد موقعك. تأكدي من السماح بالوصول إلى الموقع الجغرافي.",
  ...
  const submitOrder = async () => {
    ...
    if (!address.phone.trim() || !address.details.trim()) {
      setOrderMsg({
        text: "يرجى إدخال رقم الهاتف والعنوان التفصيلي.",
        ok: false,
      });
      return;
    }
    ...
    try {
      ...
      if (!res.ok) {
        ...
        setOrderMsg({
          text: data.error ?? "تعذر إنشاء الطلب حاليًا.",
          ok: false,
        });
        return;
      }
      ...
      /*
       * The server has successfully created the Order at this point.
       * These items now belong to order history, not to the shopping cart.
       *
       * Clear the cart BEFORE redirecting to Paymob as well as for
       * COD/fully-paid orders. A failed/expired Paymob attempt is resumed
       * from the existing Order, never by rebuilding the cart.
       */
      writeCart([]);
      setCartItems([]);
  ...
  if (step === "success")
    return (
      ...
      >
        <div
          style={{
            width: viewportWidth() < 768 ? 72 : 90,
            height: viewportWidth() < 768 ? 72 : 90,
            background: "rgba(34,197,94,.15)",
            borderRadius: "50%",
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
            fontSize: viewportWidth() < 768 ? 34 : 44,
            marginBottom: 24,
          }}
        >
          ✅
        ...
        {createdOrderId && (
          <p style={{ color: C.gray, fontSize: 15, marginBottom: 6 }}>
            رقم الطلب: {createdOrderId}
          </p>
        )}
        <p style={{ color: C.gray, fontSize: 13, marginBottom: 24 }}>
          تم حفظ الطلب في النظام، وسيظهر في حسابك.
        </p>
        <div
          style={{
            display: "flex",
  ...
  return (
    <div>
              ...
              >
                <div
                  style={{
                    ...
                    height: 26,
                    borderRadius: "50%",
                    background: step === s ? C.red : C.grayDark,
                    color: "#fff",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                ...
                <span
                  style={{
                    fontWeight: 700,
                    fontSize: viewportWidth() < 480 ? 12 : 14,
                ...
                {i < 3 && (
                  <span style={{ color: C.grayDark, fontSize: 12 }}>
                    {lang === "ar" ? "←" : "→"}
                  </span>
                )}
              </div>
      ...
      <div
        className="container"
        style={{ padding: viewportWidth() < 640 ? "20px 12px" : "40px 24px" }}
      >
        {orderMsg && (
          <div
            style={{
              ...
              padding: "14px 18px",
              borderRadius: 10,
              background: orderMsg.ok ? "#dcfce7" : "#fee2e2",
          ...
          <div>
                ...
                {cartItems.length === 0 && (
                  ...
                  >
                    {t(
                      ...
                      "No products in the cart right now.",
                    )}
                  </div>
                )}
                {cartItems.map((item) => (
                  ...
                  >
                    ...
                    >
                      {cartProducts.find((p) => p.id === item.productId)
                        ?.images?.[0] ? (
                        <img
                          src={
                            cartProducts.find((p) => p.id === item.productId)!
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      {item.size && (
                        <p
                          style={{ color: C.gray, fontSize: 12, marginTop: 3 }}
                        >
                ...
                {freeGiftGameEnabled && (
                  <a
                    ...
                    style={{
                      ...
                      gap: 12,
                      background:
                        "linear-gradient(135deg,rgba(233,30,99,.1),rgba(194,24,91,.06))",
                  ...
                  >
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      >
                        {t(
                          "عندك هدايا مجانية في انتظارك!",
                          "You have free gifts waiting for you!",
                        )}
                      </p>
                      <p
                        style={{
                      ...
                      >
                        {t(
                          ...
                          "Play the game and pick free products with your order",
                        )}
                      </p>
                    </div>
            ...
            {step === "address" && (
              <div>
                ...
                >
                  {t("بيانات العنوان", "Address details")}
                </h2>
                <div className="card" style={{ padding: 24 }}>
                  <div
                    style={{
                  ...
                  <div style={{ marginBottom: 14 }}>
                    ...
                    >
                      <option>{t("بني سويف", "Beni Suef")}</option>
                      <option>{t("الفيوم", "Faiyum")}</option>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <button
                        ...
                        disabled={locating}
                      >
                        <I n="map" s={14} c={C.gold} />{" "}
                        {locating
                          ? t("جارٍ تحديد الموقع...", "Detecting location...")
                          : t(
                ...
                <div style={{ display: "flex", gap: 12, marginTop: 16 }}>
                  <button className="btn-ghost" onClick={() => setStep("cart")}>
                  ...
                  >
                    {t("متابعة إلى الشحن", "Continue to shipping")}
                  </button>
                </div>
              </div>
            )}
            ...
            {step === "delivery" && (
              <div>
                ...
                >
                  {t("وسيلة الشحن أو الاستلام", "Delivery or pickup")}
                </h2>
                  ...
                  {deliveryOptions.length === 0 ? (
                    <div style={{ color: C.gray, fontSize: 13 }}>
                      {t(
                        ...
                        "No shipping options are available right now. You can continue and we will contact you to arrange delivery.",
                      )}
                    </div>
                  ) : (
                    <div style={{ display: "grid", gap: 12 }}>
                      {deliveryOptions.map((option) => {
                        ...
                        const feeLabel =
                          option.type === "pickup"
                            ? t("استلام من الجيم", "Gym pickup")
                            : `${t("رسوم الشحن", "Shipping fee")} ${formatCurrency(option.fee)}`;
                        const etaLabel =
                          option.type === "pickup"
                ...
                {selectedDelivery?.type === "pickup" ? (
                  ...
                  >
                    ...
                    >
                      {t(
                        "الدفع عند الاستلام متاح عند الاستلام من الجيم فقط.",
                        "Cash on delivery is available only for gym pickup.",
                      )}
                    </div>
                  </div>
                ) : (
                  ...
                  >
                    <div
                      style={{ color: C.red, fontWeight: 700, fontSize: 12 }}
                    >
                      {t(
                        "عند اختيار شركة شحن، يتم الدفع إلكترونياً عبر Paymob قبل تأكيد الطلب.",
                        "When shipping is selected, payment is completed electronically through Paymob before the order is confirmed.",
                      )}
                    </div>
                  </div>
                )}
                <div style={{ display: "flex", gap: 12, marginTop: 16 }}>
                  <button
                    ...
                    onClick={() => setStep("address")}
                  >
                    {t("العودة للعنوان", "Back to address")}
                  </button>
                  <button
                    className="btn-primary"
                    style={{ flex: 1, justifyContent: "center" }}
              ...
              <div>
                      ...
                      <div style={{ flex: 1 }}>
                        <div
                          style={{
                            fontWeight: 600,
                            fontSize: 14,
                            color: payMethod === method.id ? C.white : C.gray,
                          }}
                        >
                          {method.label}
                        </div>
                      ...
                      >
                        <div
                          style={{
                            ...
                            height: 18,
                            borderRadius: 4,
                            border: `2px solid ${useRewards ? C.red : C.border}`,
                            background: useRewards ? C.red : "transparent",
                            display: "flex",
                            alignItems: "center",
                            justifyContent: "center",
                            flexShrink: 0,
                        ...
                        <span style={{ fontSize: 13, color: C.grayLight }}>
                          {t("استخدام فيتزونات الولاء", "Use FitZonas")}{" "}
                          <strong style={{ color: C.goldText }}>
                            (
                            {(summary?.rewardPoints ?? 0).toLocaleString(
                              lang === "ar" ? "ar-EG" : "en-US",
                      ...
                      >
                        <div
                          style={{
                            ...
                            height: 18,
                            borderRadius: 4,
                            border: `2px solid ${useWallet ? C.red : C.border}`,
                            background: useWallet ? C.red : "transparent",
                            display: "flex",
                            alignItems: "center",
                            justifyContent: "center",
                            flexShrink: 0,
                        ...
                        <span style={{ fontSize: 13, color: C.grayLight }}>
                          {t("استخدام رصيد المحفظة", "Use wallet balance")}{" "}
                          <strong style={{ color: C.successText }}>
                            ({formatCurrency(walletBalance)} {t("ج.م", "EGP")})
                          </strong>
                        </span>
                      </div>
                    )}
                ...
                >
                  <p style={{ color: C.gold, fontWeight: 700, fontSize: 13 }}>
                    {payMethod === "paymob"
                      ? t(
                          "الدفع الإلكتروني يتم عبر Paymob Unified Checkout.",
                          "Electronic payment is completed through Paymob Unified Checkout.",
                        )
                      : t(
                          "سيتم تحصيل المبلغ عند الاستلام.",
                          "The amount will be collected on delivery or pickup.",
                        )}
                  </p>
                  <p style={{ color: C.gray, fontSize: 12, marginTop: 6 }}>
                    {payMethod === "paymob"
                      ? t(
                          "بعد تأكيد الطلب سيتم تحويلك مباشرة إلى Paymob لاختيار وسيلة الدفع المفعلة.",
                          "After confirming the order, you will be redirected to Paymob to choose an enabled payment method.",
                        )
                      : t(
                          "سيظهر الطلب في حسابك مباشرة بدون بوابة دفع إلكترونية.",
                          "The order will appear in your account immediately without an electronic payment gateway.",
                        )}
                  </p>
                </div>
                <div style={{ display: "flex", gap: 12, marginTop: 16 }}>
                  <button
                    ...
                    onClick={() => setStep("delivery")}
                  >
                    {t("العودة للشحن", "Back to shipping")}
                  </button>
                  <button
                    className="btn-primary"
                    disabled={submitting}
                  ...
                  >
                    {submitting
                      ...
                      : total <= 0
                        ? t(
                            "تأكيد الطلب — مدفوع بالكامل ✓",
                            "Confirm order — Fully paid ✓",
                          )
          ...
          >
            ...
            {cartItems.map((item) => (
              ...
              >
                ...
                <span style={{ fontWeight: 600, color: C.white }}>
                  {formatCurrency(item.price * item.qty)}
                </span>
              </div>
            ))}
            ...
            >
              <span style={{ color: C.gray }}>
                {t("الإجمالي الفرعي", "Subtotal")}
              </span>
              <span style={{ color: C.white }}>{formatCurrency(subtotal)}</span>
            </div>
            {vatTotal > 0 && (
              <div
                style={{
              ...
              >
                <span style={{ color: "#10b981" }}>
                  {t("منها ضريبة القيمة المضافة 14%", "Incl. 14% VAT")}
                </span>
                <span style={{ color: "#10b981" }}>
            ...
            {rewardsDiscount > 0 && (
              ...
              >
                <span style={{ color: C.gray }}>
                  {t("خصم الفيتزونات", "FitZonas discount")}
                </span>
                <span style={{ color: C.goldText }}>
                  - {formatCurrency(rewardsDiscount)}
                </span>
              </div>
            )}
            {walletDiscount > 0 && (
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              ...
              <span style={{ fontWeight: 900, color: C.red, fontSize: 22 }}>
  ...
  const transactions =
    lang === "en"
      ? [
          ...
          {
            type: "debit",
            label: "Morning Yoga booking",
            amount: -120,
            date: "Jan 12",
          },
          {
            type: "debit",
            label: "Luna shoes purchase",
            amount: -850,
            date: "Jan 10",
          },
          {
      ...
      : [
          ...
          {
            type: "debit",
            label: "حجز يوجا الصباح",
            amount: -120,
            date: "١٢ يناير",
          },
          {
            type: "debit",
            label: "شراء حذاء Luna",
            amount: -850,
            date: "١٠ يناير",
          },
          {
      ...
      >
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(circle at 50% 60%, rgba(200,162,0,.1), transparent 60%)",
          }}
        />
        <div className="container" style={{ position: "relative" }}>
          <div style={{ fontSize: 52, marginBottom: 16 }}>💳</div>
          <p style={{ color: C.gray, fontSize: 15 }}>
            {t("رصيد المحفظة الحالي", "Current wallet balance")}
          </p>
          <div
            style={{
              fontSize: 72,
          ...
          >
            150{" "}
            <span style={{ fontSize: 30, color: C.gray }}>
              {lang === "en" ? "EGP" : "ج.م"}
            </span>
          </div>
          <p style={{ color: C.grayDark, fontSize: 13 }}>
            {t("صالح حتى ٣١ ديسمبر ٢٠٢٥", "Valid until Dec 31, 2025")}
          </p>
        </div>
      </section>
      ...
      <section className="section">
        <div className="container" style={{ maxWidth: 740, margin: "0 auto" }}>
          <div className="card" style={{ padding: 32, marginBottom: 28 }}>
            ...
            <p style={{ color: C.gray, fontSize: 13, marginBottom: 24 }}>
              {t("اشحني واحصلي على بونص إضافي!", "Top up and get extra bonus!")}
            </p>
            <div
              style={{
                display: "flex",
              ...
              {options.map((opt) => (
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 8,
                    background:
                      amount === opt ? "rgba(233,30,99,.12)" : C.bgCard2,
                    color: amount === opt ? C.red : C.gray,
                    fontWeight: 700,
                    cursor: "pointer",
                    fontFamily: "'Cairo', sans-serif",
                  }}
                >
                  ...
                  {opt >= 200 && (
                    ...
                    >
                      +{Math.round(opt * 0.1)} {t("بونص", "bonus")}
                    </span>
                  )}
                </button>
              ))}
            ...
            >
              ...
              >
                🎁 {t("قواعد البونص", "Bonus rules")}
              </h4>
              {[
                ["أقل من 200 ج.م", "لا بونص"],
                ["200 - 499 ج.م", "10% بونص إضافي"],
                ["500 ج.م فأكثر", "15% بونص + هدية"],
              ].map(([r, v]) => (
                <div
                  key={r}
                  style={{
                ...
                >
                  <span style={{ color: C.gray }}>{r}</span>
            ...
            >
              ...
              <div>
                <div style={{ fontWeight: 700, fontSize: 13, color: C.gold }}>
                  {t("ستحصلين على", "You will receive")}{" "}
                  {formatCurrency(
                    amount + (amount >= 200 ? Math.round(amount * 0.1) : 0),
                  )}
                </div>
                <div style={{ fontSize: 11, color: C.gray }}>
                  {t("مقابل دفع", "For only")} {formatCurrency(amount)}
                </div>
              </div>
            </div>
            <button
            ...
            >
              <I n="wallet" s={18} c="#000" /> {t("شحن", "Top up")}{" "}
              {formatCurrency(amount)} {t("الآن", "now")}
            </button>
          </div>
                ...
                <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
                  <div
                    style={{
                      ...
                      justifyContent: "center",
                      fontSize: 16,
                      color: item.type === "credit" ? C.success : "#EF4444",
                    }}
                  >
                    {item.type === "credit" ? "↑" : "↓"}
                  </div>
                  <div>
                    <div
                      style={{ fontWeight: 600, fontSize: 13, color: C.white }}
                    >
                      {item.label}
                    </div>
                    <div style={{ fontSize: 11, color: C.gray }}>
...
const RewardsPage = () => {
  ...
  const earnMethods = [
    {
      icon: "🏋️",
      label: t("حجز كلاس", "Book a class"),
      pts: t("+10 فيتزونات", "+10 FitZonas"),
    },
    {
      icon: "🛍️",
      label: t("كل 10 ج.م شراء", "Every 10 EGP purchase"),
      pts: t("+1 فيتزونة", "+1 FitZona"),
    },
    {
      icon: "👥",
      label: t("دعوة صديقة", "Invite a friend"),
      pts: t("+200 فيتزونة", "+200 FitZonas"),
    },
    {
      icon: "⭐",
      label: t("تقييم كلاس", "Review a class"),
      pts: t("+20 فيتزونة", "+20 FitZonas"),
    },
    {
      icon: "🎂",
      label: t("عيد ميلادك", "Your birthday"),
      pts: t("+100 فيتزونة", "+100 FitZonas"),
    },
    {
      icon: "📱",
      label: t("تسجيل يومي", "Daily check-in"),
      pts: t("+5 فيتزونات", "+5 FitZonas"),
    },
  ];
  ...
  return (
    <div>
      <section
        style={{
          background: `linear-gradient(135deg, #FFECF0, ${C.bg})`,
          padding: "60px 0",
          textAlign: "center",
        }}
      >
        <div className="container">
          <div
            style={{
              fontSize: viewportWidth() < 768 ? 40 : 52,
              marginBottom: 12,
            }}
          >
            ⭐
          ...
          <h1
            style={{
              fontSize: viewportWidth() < 768 ? 32 : 42,
              fontWeight: 900,
              color: C.white,
              marginBottom: 8,
            }}
          >
            {t("فيتزونات", "Reward")}{" "}
            <span style={{ color: C.gold }}>{t("المكافآت", "FitZonas")}</span>
          </h1>
          <div
            style={{
              fontSize: viewportWidth() < 768 ? 48 : 68,
              fontWeight: 900,
              color: C.gold,
              margin: "12px 0",
            }}
          ...
          <p style={{ color: C.gray }}>
            {t("فيتزونة", "1 point")} ={" "}
            <strong style={{ color: C.red }}>{formatCurrency(24)}</strong>{" "}
            {t("رصيد قابل للاستبدال", "redeemable balance")}
          </p>
        </div>
      </section>
      <section className="section">
        <div className="container">
          <h2
            ...
            style={{ textAlign: "center", marginBottom: 32 }}
          >
            {t("مستويات", "Membership")} <span>{t("العضوية", "tiers")}</span>
          </h2>
          <div
            style={{
              display: "grid",
            ...
            {tiers.map((t) => (
              ...
              >
                {t.current && (
                  ...
                  >
                    {lang === "en" ? "Your current tier" : "مستواك الحالي"}
                  </div>
                )}
                <div
                  style={{
                ...
                <p style={{ fontSize: 11, color: C.gray, marginTop: 6 }}>
                  {t.min.toLocaleString(lang === "en" ? "en-US" : "ar-EG")}+{" "}
                  {lang === "en" ? "FitZonas" : "فيتزونة"}
                </p>
              </div>
            ))}
          </div>
          ...
          >
            <div>
              <h2 className="section-title" style={{ marginBottom: 20 }}>
                {t("كيف", "How to")} <span>{t("تكسبين", "earn")}</span>{" "}
                {t("الفيتزونات", "FitZonas")}
              </h2>
              <div
                style={{
                  display: "grid",
            ...
            <div>
              <h2 className="section-title" style={{ marginBottom: 20 }}>
                {t("كيف", "How to")} <span>{t("تستبدلين", "redeem")}</span>
              </h2>
              <div className="card" style={{ padding: 20 }}>
                {[
                  [
                    t("100 فيتزونة", "100 FitZonas"),
                    t("= 1 ج.م رصيد محفظة", "= 1 EGP wallet credit"),
                  ],
                  [
                    t("500 فيتزونة", "500 FitZonas"),
                    t("= خصم 5%", "= 5% discount"),
                  ],
                  [
                    t("1000 فيتزونة", "1000 FitZonas"),
                    t("= كلاس مجاني", "= Free class"),
                  ],
                  [
                    t("3000 فيتزونة", "3000 FitZonas"),
                    t("= شهر اشتراك مجاني", "= Free membership month"),
                  ],
                  [
                    t("5000 فيتزونة", "5000 FitZonas"),
                    t("= منتج هدية", "= Gift product"),
                  ],
                ].map(([pts, val]) => (
                  <div
                    key={pts}
                  ...
                  >
                    <span
                      style={{ fontWeight: 700, color: C.gold, fontSize: 14 }}
                    >
                      {pts}
                    </span>
    ...
    <div>
      ...
      >
        <div className="container">
          <div
            style={{
              fontSize: viewportWidth() < 768 ? 44 : 60,
              marginBottom: 14,
            }}
          >
            🎁
      ...
      <section className="section">
        <div className="container" style={{ maxWidth: 680, margin: "0 auto" }}>
          ...
          >
            ...
            >
              {t("كودك الخاص", "Your referral code")}
            </h2>
            <p style={{ color: C.gray, fontSize: 13, marginBottom: 22 }}>
              {t(
                "شاركيه مع صديقاتك واكسبي المكافآت",
            ...
            >
              ...
              <button
                onClick={copy}
                style={{
                  background: copied ? C.success : C.red,
                  border: "none",
                  borderRadius: 6,
                  padding: "7px 14px",
                  color: "#fff",
              ...
              >
                {copied ? (
                  <>
                    <I n="check" s={13} c="#fff" /> {t("تم النسخ", "Copied")}
                  </>
                ) : (
                  <>
                    <I n="copy" s={13} c="#fff" /> {t("نسخ الكود", "Copy code")}
                  </>
                )}
              </button>
            </div>
          ...
          <div className="card" style={{ padding: 28 }}>
            ...
            >
              {t("إزاي بيشتغل؟", "How it works")}
            </h3>
            <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
              {[
                [
                  t("شاركي كودك", "Share your code"),
                  t(
                    "أرسلي الكود لصديقاتك على واتساب أو الإنستجرام",
                    "Send your code to friends on WhatsApp or Instagram",
                  ),
                  C.red,
                ],
                [
                  t("صديقتك تشتركي", "Your friend joins"),
                  t(
                    "لما تشتركي بالكود بتاعك كلتيكما هتاخدوا خصم 20%",
                    "When she joins using your code, you both get 20% off",
                  ),
                  C.gold,
                ],
                [
                  t("اكسبي المكافأة", "Earn the reward"),
                  t(
                    "يضافلك 200 فيتزونة فور إتمام صديقتك الاشتراك",
                    "You get 200 points once she completes the membership",
                  ),
                  C.success,
                ],
...
const AccountPage = ({ navigate }: { navigate: (p: string) => void }) => {
  ...
  const tabs = [
    ...
    {
      id: "memberships",
      label: t("اشتراكاتي", "My memberships"),
      icon: "repeat",
    },
  ...
  return (
    <div>
      <div
        style={{
          background: `linear-gradient(135deg, #FFE0EC, ${C.bgCard})`,
          borderBottom: `1px solid ${C.border}`,
          padding: "28px 0",
        }}
      >
        ...
        >
          ...
          <div>
            <h1 style={{ fontSize: 24, fontWeight: 900, color: C.white }}>
              {lang === "en" ? "Fatma Mohamed" : "فاطمة محمد"}
            </h1>
            <p style={{ color: C.gray, fontSize: 13 }}>
              {lang === "en"
                ? "fatma@example.com · Member since Jan 2024"
                : "fatma@example.com آ· عضوة منذ يناير ٢٠٢٤"}
            </p>
            <span
              className="badge"
              style={{ marginTop: 6, display: "inline-flex" }}
            >
              👑 {t("عضوة Pro", "Pro member")}
            </span>
          </div>
        </div>
      </div>
      <div
        ...
        style={{
          padding: "32px 24px",
          display: "grid",
          gridTemplateColumns: responsiveColumns("1fr", "1fr", "240px 1fr"),
          gap: 28,
        }}
      >
        <aside>
            ...
            {tabs.map((t) => (
              <button
                ...
                style={{
                  ...
                  border: "none",
                  background:
                    activeTab === t.id ? "rgba(233,30,99,.12)" : "none",
                  color: activeTab === t.id ? C.red : C.gray,
                  fontFamily: "'Cairo', sans-serif",
                  fontSize: 13,
                  fontWeight: 600,
                  cursor: "pointer",
              ...
              >
                <I n={t.icon} s={15} c={activeTab === t.id ? C.red : C.gray} />{" "}
                {t.label}
              </button>
            ))}
            <div
        ...
        <main>
            ...
            <div>
              ...
              >
                {[
                  ...
                  [
                    "📅",
                    lang === "en" ? "Jan 15" : "١٥ يناير",
                    t("الحجز القادم", "Next booking"),
                  ],
                ].map(([icon, val, lbl]) => (
              ...
              <div className="card" style={{ padding: 20 }}>
                <h3
                  style={{ fontWeight: 800, color: C.white, marginBottom: 14 }}
                >
                  {t("الحجز القادم", "Next booking")}
                </h3>
                <div
                ...
                >
                  <div>
                    <div
                      style={{ fontWeight: 700, fontSize: 15, color: C.white }}
                    >
                      {lang === "en" ? "Morning Yoga" : "يوجا الصباح"}
                    </div>
                    <div style={{ color: C.gray, fontSize: 12, marginTop: 3 }}>
                      {lang === "en"
                        ? "Sunday Jan 15 · 7:00 AM · with Heba Zarei"
                        : "الأحد ١٥ يناير آ· ٧:٠٠ ص آ· مع هبة زارع"}
                    </div>
                  </div>
              ...
              {bookings.map((b, i) => (
                ...
                >
                  <div>
                    ...
                    <div style={{ color: C.gray, fontSize: 12, marginTop: 3 }}>
                      {b.date} · {formatTime12Hour(b.time, { meridiem: "en" })}{" "}
                      · {t("مع", "with")} {b.trainer}
                    </div>
                  </div>
                  <span
            ...
            <div>
              ...
              {orders.map((o, i) => (
                ...
                >
                  ...
                  <div style={{ textAlign: "left" }}>
                    <div
                      style={{ fontWeight: 900, color: C.red, fontSize: 15 }}
                    >
                      {o.price} {lang === "en" ? "EGP" : "ج.م"}
                    </div>
                    <span
                      style={{
                        padding: "2px 10px",
                        ...
                        background:
                          o.status === "confirmed"
                            ? "rgba(34,197,94,.12)"
                            : C.bgCard2,
                        color: o.status === "confirmed" ? C.success : C.gray,
                      }}
                    >
                      {o.status}
                    </span>
          ...
          {activeTab === "profile" && (
            <div>
              ...
              >
                {t("بياناتي الشخصية", "Personal information")}
              </h2>
              <div className="card" style={{ padding: 28 }}>
                <div
                  style={{
                ...
                >
                  {[
                    ...
                    [
                      ...
                      lang === "en" ? "Mar 15, 1992" : "١٥ مارس ١٩٩٢",
                    ],
                    [
                      t("المحافظة", "City"),
                      lang === "en" ? "Beni Suef" : "بني سويف",
                    ],
                  ].map(([lbl, val]) => (
                    <div key={lbl}>
                      <label
          ...
          {["wallet", "rewards", "referrals", "memberships"].includes(
            activeTab,
          ) && (
            <div style={{ textAlign: "center", padding: 60 }}>
              ...
              <p style={{ color: C.gray, marginBottom: 20, fontSize: 14 }}>
                {t(
                  "روحي للصفحة المخصصة لكل التفاصيل",
                  "Go to the dedicated page for full details",
                )}
              </p>
              <button className="btn-primary">
                {t("عرض الصفحة الكاملة", "View full page")}
              </button>
            </div>
          )}
        </main>
...
const TrainersPage = ({
  ...
  const [pageContent, setPageContent] = useState<TrainersPageContent>({
    ...
    description:
      "تعرفي على مدربات فيت زون وخبراتهن في اللياقة، التخسيس، التأهيل، والبرامج المتخصصة، ثم اختاري المدربة الأقرب لهدفك.",
    ...
    subtitleEn:
      "Fitness coaches and sports specialists for women and kids in Beni Suef",
    descriptionEn:
      "Meet the Fit Zone trainers, explore their experience in fitness, weight loss, rehab, and specialized programs, then choose the coach that matches your goal.",
    highlightEn:
      "Clear specialties, real experience, and session availability for every trainer",
  ...
  const badge =
    lang === "en"
      ? (pageContent.badgeEn ?? pageContent.badge)
      : pageContent.badge;
  const title =
    lang === "en"
      ? (pageContent.titleEn ?? pageContent.title)
      : pageContent.title;
  const subtitle =
    lang === "en"
      ? (pageContent.subtitleEn ?? pageContent.subtitle)
      : pageContent.subtitle;
  const description =
    lang === "en"
      ? (pageContent.descriptionEn ?? pageContent.description)
      : pageContent.description;
  const highlight =
    lang === "en"
      ? (pageContent.highlightEn ?? pageContent.highlight)
      : pageContent.highlight;
  const displayedTrainers = useMemo(() => {
    const filter = coachState?.trainerFilter;
    if (!filter || (filter.ids.length === 0 && !filter.specialty))
      return trainers;
    return trainers.filter((trainer) =>
      filter.ids.length
        ? filter.ids.includes(trainer.id)
        : trainer.specialty
            .toLowerCase()
            .includes(filter.specialty?.toLowerCase() ?? ""),
    );
    ...
    <div>
      ...
      >
        <div className="container">
          ...
          <p style={{ color: C.gray, fontSize: 17, marginBottom: 8 }}>
            {subtitle}
          </p>
          <p
            style={{
        ...
        <div className="container">
          ...
          >
            {displayedTrainers.map((tr, index) => (
              <div
                key={tr.id}
                data-tour={index === 0 ? "first-trainer-card" : undefined}
                className="card card-hover"
                style={{
                  padding: 0,
                  overflow: "hidden",
                  textAlign: "center",
                  scrollMarginTop: 120,
                  outline: coachState?.highlightedItems.trainer?.includes(tr.id)
                    ? `3px solid ${C.red}`
                    : undefined,
                }}
              >
                ...
                <div
                  ...
                  onClick={() => setTrainerDetailModal(tr)}
                >
                  {tr.image ? (
                    <img
                      src={tr.image}
                ...
                <div style={{ padding: "16px 18px 20px" }}>
                  ...
                  >
                    {lang === "en" && tr.nameEn ? tr.nameEn : tr.name}
                  </h3>
                  <p
                    style={{
                      color: C.redText,
...
const PartnersPage = ({
  ...
  const formatDiscount = (p: PublicPartner) => {
    ...
    if (p.code.discountType === "fixed")
      return `${p.code.discountValue} ${t("جنيه خصم", "EGP off")}`;
  ...
  return (
    <div>
      ...
      <div
        style={{
          background: `linear-gradient(135deg, ${C.redDark} 0%, #8B0034 100%)`,
          padding: "64px 0 56px",
          textAlign: "center",
        }}
      >
      ...
      <div className="section" style={{ paddingTop: 48 }}>
        <div className="container">
              ...
              {categories.map((cat) => {
                const label =
                  cat === "all"
                    ? t("الكل", "All")
                    : ((lang === "ar"
                        ? PARTNER_CATEGORY_LABELS[cat]?.ar
                        : PARTNER_CATEGORY_LABELS[cat]?.en) ?? cat);
                return (
                  <button
                    key={cat}
          ...
          {loading ? (
            <div
              style={{ textAlign: "center", padding: "60px 0", color: C.gray }}
            >
              {t("جارٍ التحميل...", "Loading...")}
            </div>
          ) : filtered.length === 0 ? (
                      ...
                      {partner.logoUrl ? (
                        ...
                        <div
                          style={{
                            ...
                            height: 88,
                            borderRadius: 16,
                            background: `linear-gradient(135deg, ${C.redDark}, #8B0034)`,
                            display: "flex",
                            alignItems: "center",
                            justifyContent: "center",
                            fontSize: 36,
                        ...
                        (hasActiveMembership ? (
                          ...
                          >
                            ...
                            >
                              {!summary?.authenticated
                                ? t(
                                    "سجلي دخولك للحصول على الكود",
                                    "Login to get the code",
                                  )
                                : summary.membership
                                  ? t(
                                      "اشتراكك انتهى — جددي للحصول على الكود",
                                      "Subscription expired — renew to get the code",
                                    )
                                  : t(
                                      "اشتركي للحصول على الكود",
...
const BlogPage = () => {
  const t = useT();
  const { lang } = useLang();
  const [activeArticle, setActiveArticle] = useState<PublicBlogPost | null>(
    null,
  );
  const allLabel = t("الكل", "All");
  ...
  const categories =
    blog.categories.length > 0
      ? blog.categories
      : Array.from(
          new Set(blog.posts.map((post) => post.category).filter(Boolean)),
        );
  ...
  const rest = activePosts.filter(
    (post) =>
      post.id !== featured?.id && (cat === allLabel || post.category === cat),
  );
  useEffect(() => {
    setCat(allLabel);
  }, [allLabel]);
  ...
  if (activeArticle) {
    ...
    return (
      <div>
        <div style={{ height: 300, position: "relative", overflow: "hidden" }}>
          ...
          <div
            style={{
              ...
              inset: 0,
              background:
                "linear-gradient(to bottom, rgba(0,0,0,.25) 0%, rgba(0,0,0,.75) 100%)",
            }}
          />
            ...
            <div className="container">
              ...
              <h1
                style={{
                  ...
                  fontWeight: 900,
                  textShadow:
                    "0 2px 12px rgba(0,0,0,.9), 0 1px 3px rgba(0,0,0,.9)",
                  margin: 0,
                }}
              >
                {a.title}
        ...
        <div
          className="container"
          style={{ maxWidth: 740, padding: "40px 24px" }}
        >
          <div
            style={{
              display: "flex",
          ...
          <div className="card" style={{ padding: 36 }}>
            ...
            <p style={{ lineHeight: 2, fontSize: 15, color: C.grayLight }}>
              {a.content}
            </p>
          </div>
        </div>
    ...
    <div>
      ...
      >
        <div className="container">
          ...
          >
            {t("مدونة", "Blog")}{" "}
            <span style={{ color: C.red }}>{t("فيت زون", "Fit Zone")}</span>
          </h1>
          <p style={{ color: C.gray, fontSize: 15 }}>
            {t(
              "مقالات ونصائح عن اللياقة والصحة والتغذية للسيدات في بني سويف.",
              "Articles and practical tips on fitness, health, and nutrition for women in Beni Suef.",
            )}
          </p>
          ...
          {contact.whatsappChannelEnabled && contact.whatsappChannel && (
            ...
            >
              ...
              <div>
                ...
                >
                  {t(
                    "نادي البنات السري 🤫 — اضغطي للمتابعة",
                    "FitZone Secret Girls Club 🤫 — Tap to follow",
                  )}
                </div>
              </div>
              <div
...
const ContactPage = () => {
  ...
  const [contactResult, setContactResult] = useState<
    "success" | "error" | "auth" | null
  >(null);
  const [contactInfo, setContactInfo] =
    useState<PublicContact>(DEFAULT_CONTACT);
  const faqs = [
    {
      q: t("إيه ساعات العمل؟", "What are your working hours?"),
      a: t(
        "بنشتغل من الأحد للخميس من الساعة ٧ الصبح لـ ١٠ بالليل، والجمعة والسبت من ٨ الصبح لـ ٨ بالليل.",
        "We operate Sunday to Thursday from 7 AM to 10 PM, and Friday and Saturday from 8 AM to 8 PM.",
      ),
    },
    {
      q: t("هل في كلاسات للأطفال؟", "Do you offer classes for kids?"),
      a: t(
        "أيوه! عندنا برامج مخصصة للأطفال من سن ٤ سنوات. تواصلي معنا لمعرفة التفاصيل.",
        "Yes. We offer dedicated programs for children starting from age 4. Contact us for the details.",
      ),
    },
    {
      q: t("ممكن أجمد العضوية؟", "Can I freeze my membership?"),
      a: t(
        "أيوه، تقدري تجمدي العضوية مرة في الشهر لمدة مش أكتر من أسبوعين.",
        "Yes, you can freeze your membership once per month for up to two weeks.",
      ),
    },
    {
      q: t("إيه طرق الدفع المتاحة؟", "What payment methods are available?"),
      a: t(
        "كل وسائل الدفع الإلكترونية متاحة من خلال Paymob حسب الوسائل المفعلة على حسابك.",
        "All electronic payment methods are available through Paymob depending on what is enabled on your account.",
      ),
    },
    {
      q: t("هل في عروض للمجموعات؟", "Do you have group offers?"),
      a: t(
        "أيوه! في عروض خاصة للمجموعات من ٤ أشخاص فأكثر بخصومات لحد ٣٠٪.",
        "Yes. We offer special deals for groups of 4 or more with discounts up to 30%.",
      ),
    },
  ];
    ...
    <div>
      ...
      >
        <div className="container">
          ...
          >
            {t("تواصلي", "Contact")}{" "}
            <span style={{ color: C.red }}>{t("معنا", "us")}</span>
          </h1>
          <p style={{ color: C.gray, fontSize: 17 }}>
            {t(
              "إحنا موجودين عشانك في أي وقت 💪",
      ...
      <section className="section">
        <div className="container">
          ...
          >
              ...
              <div className="card" style={{ padding: 28 }}>
                {contactResult === "success" ? (
                  <div style={{ textAlign: "center", padding: "32px 0" }}>
                    ...
                    <div
                      style={{ color: C.gray, fontSize: 13, marginBottom: 20 }}
                    >
                      {t(
                  ...
                  <>
                    {contactResult === "auth" && (
                      ...
                      >
                        ...
                        {t("أولاً لإرسال رسالة.", "first to send a message.")}
                      </div>
                    )}
                    {contactResult === "error" && (
                      <div
                      ...
                      >
                        {t(
                          ...
                          "An error occurred while sending. Try again or contact us on WhatsApp.",
                        )}
                      </div>
                    )}
                    <div style={{ marginBottom: 14 }}>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        fontSize: 15,
                        opacity:
                          contactLoading || !contactMessage.trim() ? 0.6 : 1,
                      }}
                      onClick={async () => {
            ...
            <div>
              <h2 className="section-title" style={{ marginBottom: 24 }}>
                {t("معلومات", "Contact")} <span>{t("التواصل", "info")}</span>
              </h2>
              <div
                style={{
                  display: "flex",
              ...
              >
                ...
                <div style={{ display: "flex", gap: 10 }}>
                  <a
                    href={`tel:${contactInfo.phone || "01001514535"}`}
                    style={{
                      flex: 1,
                      background: C.red,
                      color: "#fff",
          ...
          <div style={{ marginTop: 64 }}>
            ...
            >
              {t(
                "هتلاقينا في قلب بني سويف — مقابل بنك القاهرة 📍",
                "Find us in the heart of Beni Suef — opposite Cairo Bank 📍",
              )}
            </p>
            <div
              style={{
                ...
                border: "1px solid rgba(233,30,99,.25)",
                boxShadow:
                  "0 0 0 1px rgba(233,30,99,.1), 0 24px 60px rgba(0,0,0,.45)",
                background: "#0d0a0c",
              }}
            >
              {/* Top accent bar */}
              <div
                style={{
                  ...
                  zIndex: 2,
                  background:
                    "linear-gradient(90deg, #e91e63, #c2185b, #e91e63)",
                }}
              />
              ...
              <div
                style={{
                  background:
                    "linear-gradient(135deg, rgba(26,12,20,.97), rgba(42,15,28,.97))",
              ...
              >
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      {t(
                        "مقبل أمام بنك القاهرة بجوار شام للسياحة فوق كازيون",
                        "Opposite Cairo Bank, next to Sham Tourism, above Cazino",
                      )}
                    </div>
                  </div>
                </div>
    ...
    >
      {items.map((item) => {
        const active =
          currentPage === item.id ||
          (item.id === "account" &&
            ["wallet", "rewards", "referral"].includes(currentPage));
        return (
          <button
            key={item.id}
            onClick={() => navigate(item.id)}
...
export default function App({
  ...
  const [coachVisualState, setCoachVisualState] = useState<CoachVisualState>(
    emptyCoachVisualState,
  );
  ...
  useEffect(() => {
    ...
    console.debug("[Hydration auth debug]", {
      ...
      role: summary?.user?.role ?? "none",
      conditionalElements: summary?.authenticated
        ? ["authenticated-nav", "account-summary", "user-widget"]
        : ["guest-nav", "user-widget"],
    });
  ...
  useEffect(() => {
    if (HYDRATION_AUTH_DEBUG && hydrationDisable)
      console.debug("[Hydration isolation]", {
        disabledSection: hydrationDisable,
      });
  }, [hydrationDisable]);
  ...
  useEffect(() => {
    const targetPage = COACH_PAGES.find(
      (item) => item.route === `/#${window.location.hash.slice(1)}`,
    );
    if (targetPage?.spaPage && targetPage.spaPage !== "home")
      setPage(targetPage.spaPage);
    if (targetPage?.sectionId)
      pendingScrollTarget.current = targetPage.sectionId;
  }, []);
  ...
  useEffect(() => {
    if (page !== "home" || localStorage.getItem(ONBOARDING_COMPLETED_KEY))
      return;
    ...
    const cleanup = () =>
      events.forEach((event) => window.removeEventListener(event, showPrompt));
    events.forEach((event) =>
      window.addEventListener(event, showPrompt, {
        once: true,
  ...
  useEffect(() => {
    if (
      !storeEnabled &&
      ["shop", "cart", "checkout", "productDetail"].includes(page)
    ) {
      setPage("home");
    }
  }, [storeEnabled, page]);
  ...
  useEffect(() => {
    ...
    // Friend-offer invite links must enter the Offers page on the initial load.
    // The invite itself is still handled by OffersPage using the existing token flow.
    if (page === "home" && url.searchParams.get("friendOffer")?.trim()) {
      setPage("offers");
      return;
    }
  ...
  useEffect(() => {
    const handle = () => {
      const p =
        new URL(window.location.href).searchParams.get("page") || "home";
      setPage(p);
      window.scrollTo({ top: 0, behavior: "smooth" });
    };
  ...
  useEffect(() => {
    const handleCoachNavigation = (event: Event) => {
      const detail = (
        event as CustomEvent<{ type?: string; page?: string; anchor?: string }>
      ).detail;
      if (detail?.type === "navigate" && detail.page === "shop") {
        navigate(
          "shop",
          detail.anchor === "shop-products" ? "shop-products" : undefined,
        );
      } else if (
  ...
  useEffect(() => {
    ...
    const emitResult = (result: CoachUiActionResult) =>
      window.dispatchEvent(
        new CustomEvent(COACH_UI_ACTION_RESULT_EVENT, { detail: result }),
      );

    const waitForSection = (sectionId: string, requestId: string) => {
      let safetyTimeout: number | null = null;
      const finish = (
        status: CoachUiActionResult["status"],
        completed: boolean,
      ) => {
        observer.disconnect();
        if (safetyTimeout !== null) window.clearTimeout(safetyTimeout);
        setCoachVisualState((current) =>
          current.pendingSectionId === sectionId
            ? { ...current, pendingSectionId: null }
            : current,
        );
      ...
      const reveal = () => {
        ...
        requestAnimationFrame(() => {
          ...
          if (!isTyping()) {
            const heading =
              target.querySelector<HTMLElement>("h1, h2, h3, [tabindex]") ??
              target;
      ...
      if (!reveal()) {
        ...
        safetyTimeout = window.setTimeout(
          () => finish("section_not_found", false),
          3_000,
        );
      }
    };
    ...
    const handleCoachActions = (event: Event) => {
      const detail = (
        event as CustomEvent<{ requestId?: string; batch?: unknown }>
      ).detail;
      ...
      setCoachVisualState((previous) => {
        let next: CoachVisualState = {
          ...previous,
          actionSource: "ai_coach",
          highlightedItems: { ...previous.highlightedItems },
        };
        for (const action of batch.actions) {
          switch (action.type) {
            ...
            case "scrollToSection":
              targetSection = action.sectionId;
              next.pendingSectionId = action.sectionId;
              break;
            case "setGoalFilter":
              next.selectedGoalId = action.goalId;
              next.activeDomain = "goals";
              break;
            case "setMembershipResults":
              next.membershipResultIds = action.membershipIds;
              next.membershipSort = action.sort ?? null;
              next.activeDomain = "memberships";
              break;
            case "setTrainerFilter":
              next.trainerFilter = {
                ids: action.trainerIds,
                specialty: action.specialty ?? null,
              };
              next.activeDomain = "trainers";
              break;
            case "setClassFilter":
              next.classFilter = {
                ids: action.classIds ?? [],
                trialOnly: action.trialOnly ?? false,
                date: action.date ?? null,
              };
              next.activeDomain = "classes";
              break;
            case "setProductFilters":
              ...
              next.activeDomain = "products";
              break;
            case "highlightItems":
              next.highlightedItems[action.itemType] = action.ids;
              break;
            case "openItemDetails":
              next.openItemId = action.itemId;
              break;
            default:
              actionFailed = true;
          }
      ...
      if (
        actionFailed ||
        (targetSection && !COACH_SECTION_IDS.includes(targetSection))
      ) {
        emitResult({
          requestId,
          status: "navigation_blocked",
    ...
    return () =>
      window.removeEventListener(COACH_UI_ACTION_EVENT, handleCoachActions);
  }, [navigate]);

  const navigateForTour = useCallback(
    (tourPage: "memberships" | "classes" | "trainers" | "shop" | null) => {
      if (!tourPage) return;
      navigating.current = true;
  ...
  const pages = {
    ...
    shop: storeEnabled ? (
      <ShopPage navigate={navigate} coachState={coachVisualState} />
    ) : (
      <HomePage
        navigate={navigate}
        summary={summary}
    ...
    cart: storeEnabled ? (
      <CartPage navigate={navigate} summary={summary} />
    ) : (
      <HomePage
        navigate={navigate}
        summary={summary}
  ...
  return (
    ...
    >
      ...
      <Header
        ...
        navigate={navigate}
        cartCount={cartCount}
        walletBalance={(summary?.walletBalance ?? 0).toLocaleString(
          lang === "ar" ? "ar-EG" : "en-US",
        )}
        summary={summary}
        storeEnabled={storeEnabled}
      ...
      />
      <main
        data-ai-coach-domain={coachVisualState.activeDomain ?? undefined}
        data-ai-coach-source={coachVisualState.actionSource ?? undefined}
      >
        ...
        {page !== "memberships" &&
          (pages[page as keyof typeof pages] || pages.home)}
      </main>
      <Footer
        navigate={navigate}
        storeEnabled={storeEnabled}
      ...
      {hydrationDisable !== "tour" && tourPromptOpen && (
        <aside
          ...
          style={{
            ...
            border: `1px solid ${C.border}`,
            borderRadius: 16,
            boxShadow: "0 14px 36px rgba(26,8,18,.16)",
            padding: "16px 18px",
          }}
        >
          <button
          ...
          >
            {lang === "en"
              ? "Take a quick tour and discover FitZone’s key features."
              : "خدي جولة سريعة وتعرفي على أهم مميزات FitZone."}
          </p>
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
            <button
              type="button"
            ...
            >
              {lang === "en" ? "Start tour" : "ابدئي الجولة"}
            </button>
            <button
              type="button"
              onClick={dismissTourPrompt}
              style={{
                border: `1px solid ${C.redText}`,
                borderRadius: 8,
                background: "#fff",
                color: C.redText,
                padding: "8px 12px",
      ...
      {hydrationDisable !== "tour" && tourOpen && (
        <FitZoneTour
          onNavigate={navigateForTour}
          onFinishNavigate={finishTourAt}
