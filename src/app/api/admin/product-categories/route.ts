...
export async function POST(req: Request) {
  ...
  try {
    ...
    console.error("[ADMIN_PRODUCT_CATEGORIES_POST]", error);
...
export async function PATCH(req: Request) {
  ...
  try {
    ...
    console.error("[ADMIN_PRODUCT_CATEGORIES_PATCH]", error);
...
export async function DELETE(req: Request) {
  ...
  try {
    ...
    console.error("[ADMIN_PRODUCT_CATEGORIES_DELETE]", error);
