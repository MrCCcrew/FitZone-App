    ...
    >
      ...
      <AdminCard>
        ...
        <div className="mt-4 grid gap-4">
          ...
          <label className="block">
            <span className="mb-1.5 block text-xs font-bold text-[#d7aabd]">رابط InstaPay (يفتح من الهاتف)</span>
            <input
              type="text"
              value={settings.instapayUrl}
              onChange={(event) => setSettings((current) => ({ ...current, instapayUrl: event.target.value }))}
              className="w-full rounded-xl border border-[rgba(255,188,219,0.18)] bg-[rgba(255,255,255,0.05)] px-3 py-2 text-sm text-[#fff4f8] outline-none transition focus:border-pink-400"
            />
          </label>
          <label className="block">
            <span className="mb-1.5 block text-xs font-bold text-[#d7aabd]">عنوان InstaPay داخل الدفع</span>
            <input
              type="text"
              value={settings.instapayLabel}
              onChange={(event) => setSettings((current) => ({ ...current, instapayLabel: event.target.value }))}
              className="w-full rounded-xl border border-[rgba(255,188,219,0.18)] bg-[rgba(255,255,255,0.05)] px-3 py-2 text-sm text-[#fff4f8] outline-none transition focus:border-pink-400"
            />
          </label>
          <label className="block">
            <span className="mb-1.5 block text-xs font-bold text-[#d7aabd]">رابط Vodafone Cash (يفتح من الهاتف)</span>
            <input
              type="text"
              value={settings.vodafoneCashUrl}
              onChange={(event) => setSettings((current) => ({ ...current, vodafoneCashUrl: event.target.value }))}
              className="w-full rounded-xl border border-[rgba(255,188,219,0.18)] bg-[rgba(255,255,255,0.05)] px-3 py-2 text-sm text-[#fff4f8] outline-none transition focus:border-pink-400"
            />
          </label>
          <label className="block">
            <span className="mb-1.5 block text-xs font-bold text-[#d7aabd]">عنوان Vodafone Cash داخل الدفع</span>
            <input
              type="text"
              value={settings.vodafoneCashLabel}
              onChange={(event) => setSettings((current) => ({ ...current, vodafoneCashLabel: event.target.value }))}
              className="w-full rounded-xl border border-[rgba(255,188,219,0.18)] bg-[rgba(255,255,255,0.05)] px-3 py-2 text-sm text-[#fff4f8] outline-none transition focus:border-pink-400"
            />
          </label>
