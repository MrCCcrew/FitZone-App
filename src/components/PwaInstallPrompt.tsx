...
export default function PwaInstallPrompt() {
  ...
  return (
    <>
      <div className="fixed left-1/2 top-1/2 z-[70] w-[calc(100%-2rem)] max-w-sm -translate-x-1/2 -translate-y-1/2 rounded-3xl border border-pink-200/40 bg-[#2a0f1f]/95 p-4 text-[#fff4f8] shadow-[0_24px_80px_rgba(30,8,18,0.35)] backdrop-blur-xl">
