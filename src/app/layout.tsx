...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "فيت زون بني سويف",
    "جيم بني سويف",
    "جيم للسيدات في بني سويف",
    "جيم للأطفال في بني سويف",
    "نادي لياقة للسيدات",
    "نادي لياقة للأطفال",
    "نادي رياضي في بني سويف",
    "كلاسات جيم بني سويف",
    "اشتراكات جيم بني سويف",
    "مدربات لياقة بني سويف",
    "عروض جيم بني سويف",
    "متجر مكملات بني سويف",
    "متجر منتجات رياضية بني سويف",
    "gym in Beni Suef",
    "fitness club in Beni Suef",
    "women gym in Beni Suef",
    "kids gym in Beni Suef",
    "fitness classes in Beni Suef",
    "gym memberships in Beni Suef",
    "personal training in Beni Suef",
    "fitness offers in Beni Suef",
    "sports nutrition store in Beni Suef",
    "workout classes for women",
    "fitness programs for women and kids",
    "women fitness club",
    "kids fitness",
    "fitness memberships",
    "gym classes",
