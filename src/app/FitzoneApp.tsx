          ...
          {contact.whatsappChannelEnabled && contact.whatsappChannel && (
            <a
              ...
              style={{
                ...
                background: "linear-gradient(135deg,#1ebe6a 0%,#128C7E 60%,#0d6b60 100%)",
                color: "#fff", borderRadius: 16, padding: "12px 20px",
                fontFamily: "'Cairo','Tajawal',sans-serif",
                textDecoration: "none",
                boxShadow: "0 6px 22px rgba(37,211,102,.38), 0 2px 8px rgba(0,0,0,.18)",
              ...
              onMouseEnter={e => {
                ...
                (e.currentTarget as HTMLAnchorElement).style.boxShadow = "0 10px 28px rgba(37,211,102,.48), 0 3px 10px rgba(0,0,0,.2)";
              }}
              onMouseLeave={e => {
                (e.currentTarget as HTMLAnchorElement).style.transform = "translateY(0)";
                (e.currentTarget as HTMLAnchorElement).style.boxShadow = "0 6px 22px rgba(37,211,102,.38), 0 2px 8px rgba(0,0,0,.18)";
              }}
            >
              ...
              <span style={{ display: "flex", flexDirection: "column", lineHeight: 1.3 }}>
                <span style={{ fontSize: 13, fontWeight: 900, letterSpacing: ".2px" }}>Fitzone🥰نادي البنات السري🤫</span>
                <span style={{ fontSize: 11, fontWeight: 600, opacity: .85, marginTop: 2 }}>{t("اضغطي للمتابعة على واتساب ✨", "Tap to follow on WhatsApp ✨")}</span>
              </span>
            </a>
          )}
        </div>
    ...
    <div>
      ...
      <section style={{ background: C.bgCard, borderTop: `1px solid ${C.border}`, padding: "56px 0" }}>
        <div className="container" style={{ display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center" }}>
          ...
          <h2 style={{ fontSize: 32, fontWeight: 900, color: C.white, marginBottom: 12 }}>{t("ادعي صحبتك", "Invite a friend")} <span style={{ color: C.red }}>{t("واكسبي مكافأة مالية!", "and earn a cash reward!")}</span></h2>
          <p style={{ color: C.gray, fontSize: 16, marginBottom: 28, maxWidth: 480 }}>{t("مكافأة تتضاف على محفظتك بمجرد اشتراك صديقتك بدعوتك.", "A reward is added to your wallet as soon as your friend subscribes through your invite.")}</p>
    ...
    <div>
      ...
      {schedulePlan && (
        <div style={{ position: "fixed", inset: 0, zIndex: 210, display: "flex", alignItems: "flex-start", justifyContent: "center", padding: "12px 8px", overflowY: "auto", background: "rgba(15,10,12,.72)", backdropFilter: "blur(6px)" }}>
          <div style={{ background: "#111", borderRadius: 18, padding: viewportWidth() < 640 ? 16 : 28, maxWidth: 1060, width: "100%", boxShadow: "0 24px 60px rgba(0,0,0,.45)", border: "1px solid rgba(255,255,255,.12)", marginTop: "auto", marginBottom: "auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: responsiveColumns("1fr", "1fr", "1fr 1fr"), gap: viewportWidth() < 768 ? 24 : 48, alignItems: "start" }}>
          ...
          <div>
            ...
            <div style={{ marginTop: 16, display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }}>
              ...
              {/* WhatsApp */}
              <a href={`https://wa.me/?text=${encodeURIComponent(product.name + " - " + (typeof window !== "undefined" ? window.location.href : ""))}`} target="_blank" rel="noopener noreferrer"
                style={{ background: "#25d366", color: "#fff", fontSize: 13, fontWeight: 800, padding: "7px 16px", borderRadius: 20, textDecoration: "none", display: "flex", alignItems: "center", gap: 7 }}>
              ...
              <a href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(typeof window !== "undefined" ? window.location.href : "")}`} target="_blank" rel="noopener noreferrer"
                style={{ background: "#1877f2", color: "#fff", fontSize: 13, fontWeight: 800, padding: "7px 16px", borderRadius: 20, textDecoration: "none", display: "flex", alignItems: "center", gap: 7 }}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
              ...
              {/* X / Twitter */}
              <a href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(product.name)}&url=${encodeURIComponent(typeof window !== "undefined" ? window.location.href : "")}`} target="_blank" rel="noopener noreferrer"
                style={{ background: "#000", color: "#fff", fontSize: 13, fontWeight: 800, padding: "7px 16px", borderRadius: 20, textDecoration: "none", display: "flex", alignItems: "center", gap: 7 }}>
    ...
    <div>
      <section style={{ background: `linear-gradient(135deg, #FFE0EC, ${C.bg})`, padding: "64px 0", textAlign: "center" }}>
        <div className="container">
          ...
          <h1 style={{ fontSize: viewportWidth() < 768 ? 32 : 44, fontWeight: 900, color: C.white, marginBottom: 12 }}>{t("ادعي صحبتك", "Invite a friend")} <span style={{ color: C.red }}>{t("واكسبي مكافأة مالية!", "and earn a cash reward!")}</span></h1>
          <p style={{ color: C.gray, fontSize: 17, maxWidth: 460, margin: "0 auto" }}>{t("مكافأة تتضاف على محفظتك بمجرد اشتراك صديقتك بدعوتك.", "A reward is added to your wallet as soon as your friend subscribes through your invite.")}</p>
        </div>
      </section>
      <section className="section">
